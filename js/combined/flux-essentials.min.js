...
"-"+a},generateStyleTag:function(a,b){return c("<style>"+b.join("\n")+"</style>").attr("id",a)},clearCss:function(a){a=g.getStyleId(a);c("#"+a).remove()},generateCss:function(a,b,d,c){var f=[];g.clearCss(a);for(var e=0,B=b.length;e<B;e++)f.push("#"+a+" ."+g.LINE_CLASS_PREFIX+e+" {"+(c[e]?" white-space: normal;":"")+(b[e]?" font-size: "+b[e]+"px;":"")+(d[e]?" word-spacing: "+d[e]+"px;":"")+"}");return g.generateStyleTag(g.getStyleId(a),f)},jQueryMethod:function(b){g.init();b=c.extend({minfontsize:g.DEFAULT_MIN_FONT_SIZE_PX,
maxfontsize:g.DEFAULT_MAX_FONT_SIZE_PX,childSelector:"",resize:!0},b||{});this.each(function(){var f=c(this).addClass("bigtext"),e=f.width(),n=f.attr("id"),p=b.childSelector?f.find(b.childSelector):f.children();n||(n="bigtext-id"+a++,f.attr("id",n));b.resize&&g.bindResize("resize.bigtext-event-"+n,function(){g.jQueryMethod.call(c("#"+n),b)});g.clearCss(n);p.addClass(function(a,b){return[b.replace(new RegExp("\\b"+g.LINE_CLASS_PREFIX+"\\d+\\b"),""),g.LINE_CLASS_PREFIX+a].join(" ")});f=g.calculateSizes(f,
p,e,b.maxfontsize,b.minfontsize);d.append(g.generateCss(n,f.fontSizes,f.wordSpacings,f.minFontSizes))});return this.trigger("bigtext:complete")},testLineDimensions:function(a,b,d,c,f,e,g){g="number"===typeof g?g:0;a.css(d,c+e);e=a.width();if(e>=b){a.css(d,"");if(e===b)return{match:"exact",size:parseFloat((parseFloat(c)-.1).toFixed(3))};a=b-g;b=e-b;return{match:"estimate",size:parseFloat((parseFloat(c)-("word-spacing"===d&&g&&b<a?0:f)).toFixed(3))}}return e},calculateSizes:function(a,b,d,f,e){a=a.clone(!0).addClass("bigtext-cloned").css({fontFamily:a.css("font-family"),
textTransform:a.css("text-transform"),wordSpacing:a.css("word-spacing"),letterSpacing:a.css("letter-spacing"),position:"absolute",left:g.DEBUG_MODE?0:-9999,top:g.DEBUG_MODE?0:-9999}).appendTo(document.body);var z=[],B=[],V=[],m=[];b.css("float","left").each(function(){var a=c(this),b=g.supports.wholeNumberFontSizeOnly?[8,4,1]:[8,4,1,.1],y,l;if(a.hasClass(g.EXEMPT_CLASS))z.push(null),m.push(null),V.push(!1);else{l=parseFloat(a.css("font-size"));l=(a.width()/l).toFixed(6);l=parseInt(d/l,10)-32;var k=
0,B=b.length;a:for(;k<B;k++){var I=1;b:for(;10>=I;I++){if(l+I*b[k]>f){l=f;break a}y=g.testLineDimensions(a,d,"font-size",l+I*b[k],b[k],"px",y);if("number"!==typeof y){l=y.size;if("exact"===y.match)break a;break b}}}m.push(d/l);l>f?(z.push(f),V.push(!1)):e&&l<e?(z.push(e),V.push(!0)):(z.push(l),V.push(!1))}}).each(function(a){var b=c(this),f=0,e;if(b.hasClass(g.EXEMPT_CLASS))B.push(null);else{b.css("font-size",z[a]+"px");for(a=1;3>a;a+=1)if(e=g.testLineDimensions(b,d,"word-spacing",a,1,"px",e),"number"!==
typeof e){f=e.size;break}b.css("font-size","");B.push(f)}}).removeAttr("style");g.DEBUG_MODE?a.css({"background-color":"rgba(255,255,255,.4)"}):a.remove();return{fontSizes:z,wordSpacings:B,ratios:m,minFontSizes:V}}};c.fn.bigtext=g.jQueryMethod;b.BigText=g})(this,jQuery);var _gsScope="undefined"!=typeof module&&module.exports&&"undefined"!=typeof global?global:this||window;
(_gsScope._gsQueue||(_gsScope._gsQueue=[])).push(function(){_gsScope._gsDefine("easing.CustomEase",["easing.Ease"],function(b){var c=/(?:(-|-=|\+=)?\d*\.?\d*(?:e[\-+]?\d+)?)[0-9]/gi,a=/[achlmqstvz]|(-?\d*\.?\d*(?:e[\-+]?\d+)?)[0-9]/gi,d=/[\+\-]?\d*\.?\d+e[\+\-]?\d+/gi,f=/[cLlsS]/g,e=function(a,b,d,c,f,m,r,g,y,h,l){var k,I=(a+d)/2,F=(b+c)/2,C=(d+f)/2,K=(c+m)/2,G=(f+r)/2,Q=(m+g)/2,J=(I+C)/2,W=(F+K)/2,C=(C+G)/2,K=(K+Q)/2,D=(J+C)/2,ea=(W+K)/2,Z=r-a,na=g-b;d=Math.abs((d-r)*na-(c-g)*Z);f=Math.abs((f-r)*
na-(m-g)*Z);return h||(h=[{x:a,y:b},{x:r,y:g}],l=1),h.splice(l||h.length-1,0,{x:D,y:ea}),(d+f)*(d+f)>y*(Z*Z+na*na)&&(k=h.length,e(a,b,I,F,J,W,D,ea,y,h,l),e(D,ea,C,K,G,Q,r,g,y,h,l+1+(h.length-k))),h},g=function(b){var c,f,e,g,m,r,q,y,h,l,k=(b+"").replace(d,function(a){a=+a;return 1E-4>a&&-1E-4<a?0:a}).match(a)||[],I=[],F=0,C=0,K=k.length,G=2;for(b=0;K>b;b++)if(y=e,isNaN(k[b])?(e=k[b].toUpperCase(),g=e!==k[b]):b--,c=+k[b+1],f=+k[b+2],g&&(c+=F,f+=C),b||(r=c,q=f),"M"===e)m&&8>m.length&&(--I.length,G=
0),F=r=c,C=q=f,m=[c,f],G=2,I.push(m),b+=2,e="L";else if("C"===e)m||(m=[0,0]),m[G++]=c,m[G++]=f,g||(F=C=0),m[G++]=F+1*k[b+3],m[G++]=C+1*k[b+4],m[G++]=F+=1*k[b+5],m[G++]=C+=1*k[b+6],b+=6;else if("S"===e)"C"===y||"S"===y?(h=F-m[G-4],l=C-m[G-3],m[G++]=F+h,m[G++]=C+l):(m[G++]=F,m[G++]=C),m[G++]=c,m[G++]=f,g||(F=C=0),m[G++]=F+=1*k[b+3],m[G++]=C+=1*k[b+4],b+=4;else{if("L"!==e&&"Z"!==e)throw"CustomEase only accepts Cubic Bezier data.";"Z"===e&&(c=r,f=q,m.closed=!0);("L"===e||.5<Math.abs(F-c)||.5<Math.abs(C-
f))&&(m[G++]=F+(c-F)/3,m[G++]=C+(f-C)/3,m[G++]=F+2*(c-F)/3,m[G++]=C+2*(f-C)/3,m[G++]=c,m[G++]=f,"L"===e&&(b+=2));F=c;C=f}return I[0]},k=function(a){var b=this.lookup[a*this.l|0]||this.lookup[this.l-1];return b.nx<a&&(b=b.n),b.y+(a-b.x)/b.cx*b.cy},l=function(a,d,c){this._calcEnd=!0;(this.id=a)&&(b.map[a]=this);this.getRatio=k;this.setData(d,c)},h=l.prototype=new b;return h.constructor=l,h.setData=function(a,b){a=a||"0,0,1,1";var d,h,V,m,r,q,y;q=a.match(c);r=1;var l=[];if(b=b||{},y=b.precision||1,this.data=
a,this.lookup=[],this.points=l,this.fast=1>=y,(f.test(a)||-1!==a.indexOf("M")&&-1===a.indexOf("C"))&&(q=g(a)),d=q.length,4===d)q.unshift(0,0),q.push(1,1),d=8;else if((d-2)%6)throw"CustomEase only accepts Cubic Bezier data.";if(0!==+q[0]||1!==+q[d-2]){m=q;var k=b.height,L=b.originY;L||0===L||(L=Math.max(+m[m.length-1],+m[1]));V=-1*+m[0];var L=-L,I=m.length,F=1/(+m[I-2]+V);if(!(k=-k))if(Math.abs(+m[I-1]-+m[1])<.01*(+m[I-2]-+m[0])){for(var C=m.length,K=999999999999,k=1;C>k;k+=6)+m[k]<K&&(K=+m[k]);k=
K+L}else k=+m[I-1]+L;C=(C=k)?1/C:-F;for(k=0;I>k;k+=2)m[k]=(+m[k]+V)*F,m[k+1]=(+m[k+1]+L)*C}this.rawBezier=q;for(m=2;d>m;m+=6)h={x:+q[m-2],y:+q[m-1]},V={x:+q[m+4],y:+q[m+5]},l.push(h,V),e(h.x,h.y,+q[m],+q[m+1],+q[m+2],+q[m+3],V.x,V.y,1/(2E5*y),l,l.length-1);d=l.length;for(m=0;d>m;m++)y=l[m],q=l[m-1]||y,y.x>q.x||q.y!==y.y&&q.x===y.x||y===q?(q.cx=y.x-q.x,q.cy=y.y-q.y,q.n=y,q.nx=y.x,this.fast&&1<m&&2<Math.abs(q.cy/q.cx-l[m-2].cy/l[m-2].cx)&&(this.fast=!1),q.cx<r&&(q.cx?r=q.cx:(q.cx=.001,m===d-1&&(q.x-=
.001,r=Math.min(r,.001),this.fast=!1)))):(l.splice(m--,1),d--);if(d=1/r+1|0,this.l=d,r=1/d,q=0,y=l[0],this.fast){for(m=0;d>m;m++)V=m*r,y.nx<V&&(y=l[++q]),h=y.y+(V-y.x)/y.cx*y.cy,this.lookup[m]={x:V,cx:r,y:h,cy:0,nx:9},m&&(this.lookup[m-1].cy=h-this.lookup[m-1].y);this.lookup[d-1].cy=l[l.length-1].y-h}else{for(m=0;d>m;m++)y.nx<m*r&&(y=l[++q]),this.lookup[m]=y;q<l.length-1&&(this.lookup[m-1]=l[l.length-2])}return this._calcEnd=1!==l[l.length-1].y||0!==l[0].y,this},h.getRatio=k,h.getSVGData=function(a){return l.getSVGData(this,
a)},l.create=function(a,b,d){return new l(a,b,d)},l.version="0.2.2",l.bezierToPoints=e,l.get=function(a){return b.map[a]},l.getSVGData=function(a,d){d=d||{};var c,f,e,m,r,g,y,l,h,k,I=d.width||100,F=d.height||100,C=d.x||0,K=(d.y||0)+F,G=d.path;if(d.invert&&(F=-F,K=0),a=a.getRatio?a:b.map[a]||console.log("No ease found: ",a),a.rawBezier){c=[];y=a.rawBezier.length;for(e=0;y>e;e+=2)c.push((1E3*(C+a.rawBezier[e]*I)|0)/1E3+","+(1E3*(K+a.rawBezier[e+1]*-F)|0)/1E3);c[0]="M"+c[0];c[1]="C"+c[1]}else for(c=
["M"+C+","+K],y=Math.max(5,200*(d.precision||1)),m=1/y,y+=2,l=5/y,h=(1E3*(C+m*I)|0)/1E3,k=(1E3*(K+a.getRatio(m)*-F)|0)/1E3,f=(k-K)/(h-C),e=2;y>e;e++)r=(1E3*(C+e*m*I)|0)/1E3,g=(1E3*(K+a.getRatio(e*m)*-F)|0)/1E3,(Math.abs((g-k)/(r-h)-f)>l||e===y-1)&&(c.push(h+","+k),f=(g-k)/(r-h)),h=r,k=g;return G&&("string"==typeof G?document.querySelector(G):G).setAttribute("d",c.join(" ")),c.join(" ")},l},!0)});_gsScope._gsDefine&&_gsScope._gsQueue.pop()();
...
!function(b){var c,a,d=b.event;c=d.special.debouncedresize={setup:function(){b(this).on("resize",c.handler)},teardown:function(){b(this).off("resize",c.handler)},handler:function(b,e){var g=this,k=arguments,l=function(){b.type="debouncedresize";d.dispatch.apply(g,k)};a&&clearTimeout(a);e?l():a=setTimeout(l,c.threshold)},threshold:150}}(jQuery);Number.prototype.roundTo=function(b){var c=this%b;return c<=b/2?this-c:this+b-c};
(function(){!function(b,c){return"function"==typeof define&&define.amd?define(function(){return c()}):"object"==typeof exports?module.exports=c():b.ifvisible=c()}(this,function(){var b,c,a,d,f,e,g,k,l,h,n,p,z;return k={},a=document,h=!1,n="active",e=6E4,f=!1,c=function(){var a,b,d,c;return d={},a=function(a,b,c){return a.__ceGUID=void 0,a.__ceGUID||(a.__ceGUID="ifvisible.object.event.identifier"),d[a.__ceGUID]||(d[a.__ceGUID]={}),d[a.__ceGUID][b]||(d[a.__ceGUID][b]=[]),d[a.__ceGUID][b].push(c)},b=
function(a,b,c){var f,e,r;if(a.__ceGUID&&d[a.__ceGUID]&&d[a.__ceGUID][b]){e=d[a.__ceGUID][b];r=[];b=0;for(f=e.length;b<f;b++)a=e[b],r.push(a(c||{}));return r}},c=function(a,b,c){var f,e,r,g,h;if(c){if(a.__ceGUID&&d[a.__ceGUID]&&d[a.__ceGUID][b])for(h=d[a.__ceGUID][b],e=r=0,g=h.length;r<g;e=++r)if(f=h[e],f===c)return d[a.__ceGUID][b].splice(e,1),f}else if(a.__ceGUID&&d[a.__ceGUID]&&d[a.__ceGUID][b])return delete d[a.__ceGUID][b]},{add:a,remove:c,fire:b}}(),b=function(){var a;return a=!1,function(b,
d,c){return a||(a=b.addEventListener?function(a,b,d){return a.addEventListener(b,d,!1)}:b.attachEvent?function(a,b,d){return a.attachEvent("on"+b,d,!1)}:function(a,b,d){return a["on"+b]=d}),a(b,d,c)}}(),g=function(){var b,d,c,f;f=3;c=a.createElement("div");b=c.getElementsByTagName("i");for(d=function(){return c.innerHTML="\x3c!--[if gt IE "+ ++f+"]><i></i><![endif]--\x3e",b[0]};d(););return 4<f?f:void 0}(),d=!1,z=void 0,"undefined"!=typeof a.hidden?(d="hidden",z="visibilitychange"):"undefined"!=typeof a.mozHidden?
(d="mozHidden",z="mozvisibilitychange"):"undefined"!=typeof a.msHidden?(d="msHidden",z="msvisibilitychange"):"undefined"!=typeof a.webkitHidden&&(d="webkitHidden",z="webkitvisibilitychange"),p=function(){var d,c;return d=[],c=function(){return d.map(clearTimeout),"active"!==n&&k.wakeup(),f=+new Date,d.push(setTimeout(function(){if("active"===n)return k.idle()},e))},c(),b(a,"mousemove",c),b(a,"keyup",c),b(a,"touchstart",c),b(window,"scroll",c),k.focus(c),k.wakeup(c)},l=function(){var c;return!!h||
(!1===d?(c="blur",9>g&&(c="focusout"),b(window,c,function(){return k.blur()}),b(window,"focus",function(){return k.focus()})):b(a,z,function(){return a[d]?k.blur():k.focus()},!1),h=!0,p())},k={setIdleDuration:function(a){return e=1E3*a},getIdleDuration:function(){return e},getIdleInfo:function(){var a,b;return a=+new Date,b={},"idle"===n?(b.isIdle=!0,b.idleFor=a-f,b.timeLeft=0,b.timeLeftPer=100):(b.isIdle=!1,b.idleFor=a-f,b.timeLeft=f+e-a,b.timeLeftPer=(100-100*b.timeLeft/e).toFixed(2)),b},focus:function(a){return"function"==
...
c.fire(this,"wakeup"),c.fire(this,"statusChanged",{status:n})),this},on:function(a,b){return l(),c.add(this,a,b),this},off:function(a,b){return l(),c.remove(this,a,b),this},onEvery:function(a,b){var d,c;return l(),d=!1,b&&(c=setInterval(function(){if("active"===n&&!1===d)return b()},1E3*a)),{stop:function(){return clearInterval(c)},pause:function(){return d=!0},resume:function(){return d=!1},code:c,callback:b}},now:function(a){return l(),n===(a||"active")}}})}).call(this);
!function(b){var c=/iPhone/i,a=/iPod/i,d=/iPad/i,f=/(?=.*\bAndroid\b)(?=.*\bMobile\b)/i,e=/Android/i,g=/(?=.*\bAndroid\b)(?=.*\bSD4930UR\b)/i,k=/(?=.*\bAndroid\b)(?=.*\b(?:KFOT|KFTT|KFJWI|KFJWA|KFSOWI|KFTHWI|KFTHWA|KFAPWI|KFAPWA|KFARWI|KFASWI|KFSAWI|KFSAWA)\b)/i,l=/Windows Phone/i,h=/(?=.*\bWindows\b)(?=.*\bARM\b)/i,n=/BlackBerry/i,p=/BB10/i,z=/Opera Mini/i,B=/(CriOS|Chrome)(?=.*\bMobile\b)/i,V=/(?=.*\bFirefox\b)(?=.*\bMobile\b)/i,m=/(?:Nexus 7|BNTV250|Kindle Fire|Silk|GT-P1000)/i,r=function(b){b=
b||navigator.userAgent||"";var r=b.split("[FBAN");if("undefined"!=typeof r[1]&&(b=r[0]),r=b.split("Twitter"),"undefined"!=typeof r[1]&&(b=r[0]),this.apple={phone:c.test(b),ipod:a.test(b),tablet:!c.test(b)&&d.test(b),device:c.test(b)||a.test(b)||d.test(b)},this.amazon={phone:g.test(b),tablet:!g.test(b)&&k.test(b),device:g.test(b)||k.test(b)},this.android={phone:g.test(b)||f.test(b),tablet:!g.test(b)&&!f.test(b)&&(k.test(b)||e.test(b)),device:g.test(b)||k.test(b)||f.test(b)||e.test(b)},this.windows=
{phone:l.test(b),tablet:h.test(b),device:l.test(b)||h.test(b)},this.other={blackberry:n.test(b),blackberry10:p.test(b),opera:z.test(b),firefox:V.test(b),chrome:B.test(b),device:n.test(b)||p.test(b)||z.test(b)||V.test(b)||B.test(b)},this.seven_inch=m.test(b),this.any=this.apple.device||this.android.device||this.windows.device||this.other.device||this.seven_inch,this.phone=this.apple.phone||this.android.phone||this.windows.phone,this.tablet=this.apple.tablet||this.android.tablet||this.windows.tablet,
"undefined"==typeof window)return this},q=function(){var a=new r;return a.Class=r,a};"undefined"!=typeof module&&module.exports&&"undefined"==typeof window?module.exports=r:"undefined"!=typeof module&&module.exports&&"undefined"!=typeof window?module.exports=q():"function"==typeof define&&define.amd?define("isMobile",[],b.isMobile=q()):b.isMobile=q()}(this);function onYouTubeIframeAPIReady(){ytp.YTAPIReady||(ytp.YTAPIReady=!0,jQuery(document).trigger("YTAPIReady"))}
function uncamel(b){return b.replace(/([A-Z])/g,function(b){return"-"+b.toLowerCase()})}function setUnit(b,c){return"string"!=typeof b||b.match(/^[\-0-9\.]+jQuery/)?""+b+c:b}function setFilter(b,c,a){var d=uncamel(c),f=jQuery.browser.mozilla?"":jQuery.CSS.sfx;b[f+"filter"]=b[f+"filter"]||"";a=setUnit(a>jQuery.CSS.filters[c].max?jQuery.CSS.filters[c].max:a,jQuery.CSS.filters[c].unit);b[f+"filter"]+=d+"("+a+") ";delete b[c]}
function isTouchSupported(){var b=nAgt.msMaxTouchPoints,c="ontouchstart"in document.createElement("div");return!(!b&&!c)}function isTouchSupported(){var b=nAgt.msMaxTouchPoints,c="ontouchstart"in document.createElement("div");return!(!b&&!c)}
var ytp=ytp||{},getYTPVideoID=function(b){var c,a;return 0<b.indexOf("youtu.be")?(c=b.substr(b.lastIndexOf("/")+1,b.length),a=0<c.indexOf("?list=")?c.substr(c.lastIndexOf("="),c.length):null,c=a?c.substr(0,c.lastIndexOf("?")):c):-1<b.indexOf("http")?(c=b.match(/[\\?&]v=([^&#]*)/)[1],a=0<b.indexOf("list=")?b.match(/[\\?&]list=([^&#]*)/)[1]:null):(c=15<b.length?null:b,a=c?null:b),{videoID:c,playlistID:a}};
!function(b,c){b.mbYTPlayer={name:"jquery.mb.YTPlayer",version:"3.2.4",build:"7235",author:"Matteo Bicocchi (pupunzi)",apiKey:"",defaults:{videoURL:null,containment:"body",ratio:"auto",fadeOnStartTime:1500,startAt:0,stopAt:0,autoPlay:!0,coverImage:!1,loop:!0,addRaster:!1,mask:!1,opacity:1,quality:"default",vol:50,mute:!1,showControls:!0,anchor:"center,center",showAnnotations:!1,cc_load_policy:!1,showYTLogo:!0,useOnMobile:!0,mobileFallbackImage:null,playOnlyIfVisible:!1,onScreenPercentage:30,stopMovieOnBlur:!0,
...
f.opt.backgroundImage;b.mbBrowser.msie&&9>b.mbBrowser.version&&(f.opt.opacity=1);f.opt.containment="self"===f.opt.containment?g:b(f.opt.containment);f.isRetina=window.retina||1<window.devicePixelRatio;f.opt.ratio="auto"===f.opt.ratio?16/9:f.opt.ratio;f.opt.ratio=eval(f.opt.ratio);g.attr("id")||g.attr("id","ytp_"+(new Date).getTime());f.playerID="iframe_"+f.id;f.isAlone=!1;f.hasFocus=!0;f.videoID=f.opt.videoURL?getYTPVideoID(f.opt.videoURL).videoID:g.attr("href")?getYTPVideoID(g.attr("href")).videoID:
!1;f.playlistID=f.opt.videoURL?getYTPVideoID(f.opt.videoURL).playlistID:g.attr("href")?getYTPVideoID(g.attr("href")).playlistID:!1;k=0;if(b.mbCookie.get("YTPlayer_start_from"+f.videoID)&&(k=parseFloat(b.mbCookie.get("YTPlayer_start_from"+f.videoID))),f.opt.remember_last_time&&k&&(f.start_from_last=k,b.mbCookie.remove("YTPlayer_start_from"+f.videoID)),f.isPlayer=g.is(f.opt.containment),f.isBackground=f.opt.containment.is("body"),!f.isBackground||!c.backgroundIsInited){f.isPlayer&&g.show();f.overlay=
b("<div/>").css({position:"absolute",top:0,left:0,width:"100%",height:"100%"}).addClass("YTPOverlay");f.wrapper=b("<div/>").attr("id","wrapper_"+f.id).css({position:"absolute",zIndex:0,minWidth:"100%",minHeight:"100%",left:0,top:0,overflow:"hidden",opacity:0}).addClass("mbYTP_wrapper");f.isPlayer&&(f.inlinePlayButton=b("<div/>").addClass("inlinePlayButton").html(b.mbYTPlayer.controls.play),g.append(f.inlinePlayButton),f.inlinePlayButton.on("click",function(a){g.YTPPlay();a.stopPropagation()}),f.opt.autoPlay&&
f.inlinePlayButton.hide(),f.overlay.on("click",function(){g.YTPTogglePlay()}).css({cursor:"pointer"}));k=b("<div/>").attr("id",f.playerID).addClass("playerBox");if(k.css({position:"absolute",zIndex:0,width:"100%",height:"100%",top:0,left:0,overflow:"hidden",opacity:1}),f.wrapper.append(k),k.after(f.overlay),f.isPlayer&&(f.inlineWrapper=b("<div/>").addClass("inline-YTPlayer"),f.inlineWrapper.css({position:"relative",maxWidth:f.opt.containment.css("width")}),f.opt.containment.css({position:"relative",
paddingBottom:"56.25%",overflow:"hidden",height:0}),f.opt.containment.wrap(f.inlineWrapper)),f.opt.containment.children().not("script, style").each(function(){"static"==b(this).css("position")&&b(this).css("position","relative")}),f.isBackground?(b("body").css({boxSizing:"border-box"}),f.wrapper.css({position:"fixed",top:0,left:0,zIndex:0})):"static"==f.opt.containment.css("position")&&(f.opt.containment.css({position:"relative"}),g.show()),f.opt.containment.prepend(f.wrapper),f.isBackground||f.overlay.on("mouseenter",
function(){f.controlBar&&f.controlBar.length&&f.controlBar.addClass("visible")}).on("mouseleave",function(){f.controlBar&&f.controlBar.length&&f.controlBar.removeClass("visible")}),b.mbBrowser.mobile&&!f.opt.useOnMobile)return f.opt.mobileFallbackImage&&(f.wrapper.css({backgroundImage:"url("+f.opt.mobileFallbackImage+")",backgroundPosition:"center center",backgroundSize:"cover",backgroundRepeat:"no-repeat",opacity:1}),f.wrapper.css({opacity:1})),g;b.mbBrowser.mobile&&f.opt.autoPlay&&f.opt.useOnMobile&&
b("body").one("touchstart",function(){f.player.playVideo()});b(document).one("YTAPIReady",function(){g.trigger("YTAPIReady_"+f.id);c.YTAPIReady=!0});f.isOnScreen=b.mbYTPlayer.isOnScreen(f,f.opt.onScreenPercentage);g.one("YTAPIReady_"+f.id,function(){var a=this,d=b(a);a.isBackground&&c.backgroundIsInited||a.isInit||(a.isBackground&&(c.backgroundIsInited=!0),a.opt.autoPlay="undefined"==typeof a.opt.autoPlay?!!a.isBackground:a.opt.autoPlay,a.opt.vol=a.opt.vol?a.opt.vol:100,b.mbYTPlayer.getDataFromAPI(a),
b(a).on("YTPChanged",function(c){a.isInit||(a.isInit=!0,c={modestbranding:1,autoplay:0,controls:0,showinfo:0,rel:0,enablejsapi:1,version:3,playerapiid:a.playerID,origin:"*",allowfullscreen:!0,wmode:"transparent",iv_load_policy:a.opt.showAnnotations,cc_load_policy:a.opt.cc_load_policy,playsinline:b.mbBrowser.mobile?1:0,html5:document.createElement("video").canPlayType?1:0},new YT.Player(a.playerID,{playerVars:c,events:{onReady:function(b){a.player=b.target;a.player.loadVideoById({videoId:a.videoID.toString(),
suggestedQuality:a.opt.quality});d.trigger("YTPlayerIsReady_"+a.id)},onStateChange:function(d){if("function"==typeof d.target.getPlayerState){d=d.target.getPlayerState();if(a.preventTrigger||a.isStarting)return void(a.preventTrigger=!1);a.state=d;var c;switch(d){case -1:c="YTPUnstarted";break;case 0:c="YTPRealEnd";break;case 1:c="YTPPlay";a.controlBar.length&&a.controlBar.find(".mb_YTPPlayPause").html(b.mbYTPlayer.controls.pause);a.isPlayer&&a.inlinePlayButton.hide();b(document).off("mousedown.YTPstart");
break;case 2:c="YTPPause";a.controlBar.length&&a.controlBar.find(".mb_YTPPlayPause").html(b.mbYTPlayer.controls.play);a.isPlayer&&a.inlinePlayButton.show();break;case 3:a.player.setPlaybackQuality(a.opt.quality);c="YTPBuffering";a.controlBar.length&&a.controlBar.find(".mb_YTPPlayPause").html(b.mbYTPlayer.controls.play);break;case 5:c="YTPCued"}c=b.Event(c);c.time=a.currentTime;b(a).trigger(c)}},onPlaybackQualityChange:function(d){d=d.target.getPlaybackQuality();var c=b.Event("YTPQualityChange");c.quality=
d;b(a).trigger(c)},onError:function(c){switch("function"==typeof a.opt.onError&&a.opt.onError(d,c),c.data){case 2:console.error("video ID:: "+a.videoID+": The request contains an invalid parameter value. For example, this error occurs if you specify a video ID that does not have 11 characters, or if the video ID contains invalid characters, such as exclamation points or asterisks.");break;case 5:console.error("video ID:: "+a.videoID+": The requested content cannot be played in an HTML5 player or another error related to the HTML5 player has occurred.");
...
b(window).off("resize.YTP_"+a.id).on("resize.YTP_"+a.id,function(){d.optimizeDisplay()}),a.opt.remember_last_time&&b(window).on("unload.YTP_"+a.id,function(){var d=a.player.getCurrentTime();b.mbCookie.set("YTPlayer_start_from"+a.videoID,d,0)}),void d.YTPCheckForState())}))}))});g.off("YTPTime.mask");b.mbYTPlayer.applyMask(f)}})},isOnScreen:function(a,d){d=d||10;var c=a.wrapper,e=b(window).scrollTop(),g=e+b(window).height(),k=c.height()*d/100,l=c.offset().top+k,c=c.offset().top+(c.height()-k);return g>=
c&&l>=e},getDataFromAPI:function(a){if(a.videoData=b.mbStorage.get("YTPlayer_data_"+a.videoID),b(a).off("YTPData.YTPlayer").on("YTPData.YTPlayer",function(){a.hasData&&a.isPlayer&&!a.opt.autoPlay&&a.opt.containment.css({background:"rgba(0,0,0,0.5) url("+("false"!=a.opt.coverImage?a.opt.coverImage:a.videoData.thumb_max||a.videoData.thumb_high||a.videoData.thumb_medium)+") center center",backgroundSize:"cover"})}),a.videoData)setTimeout(function(){a.dataReceived=!0;var d=b.Event("YTPChanged");d.time=
a.currentTime;d.videoId=a.videoID;d.opt=a.opt;b(a).trigger(d);d=b.Event("YTPData");d.prop={};for(var c in a.videoData)d.prop[c]=a.videoData[c];b(a).trigger(d)},a.opt.fadeOnStartTime),a.hasData=!0;else if(b.mbYTPlayer.apiKey)b.getJSON(b.mbYTPlayer.locationProtocol+"//www.googleapis.com/youtube/v3/videos?id="+a.videoID+"&key="+b.mbYTPlayer.apiKey+"&part=snippet",function(d){a.dataReceived=!0;var c=b.Event("YTPChanged");c.time=a.currentTime;c.videoId=a.videoID;b(a).trigger(c);d.items[0]?(d=d.items[0].snippet,
a.videoData={},a.videoData.id=a.videoID,a.videoData.channelTitle=d.channelTitle,a.videoData.title=d.title,a.videoData.description=400>d.description.length?d.description:d.description.substring(0,400)+" ...",a.videoData.thumb_max=d.thumbnails.maxres?d.thumbnails.maxres.url:null,a.videoData.thumb_high=d.thumbnails.high?d.thumbnails.high.url:null,a.videoData.thumb_medium=d.thumbnails.medium?d.thumbnails.medium.url:null,b.mbStorage.set("YTPlayer_data_"+a.videoID,a.videoData),a.hasData=!0):(a.videoData=
{},a.hasData=!1);d=b.Event("YTPData");d.prop={};for(var g in a.videoData)d.prop[g]=a.videoData[g];b(a).trigger(d)});else{if(setTimeout(function(){var d=b.Event("YTPChanged");d.time=a.currentTime;d.videoId=a.videoID;b(a).trigger(d)},50),!a.opt.autoPlay){var d="false"!=a.opt.coverImage?a.opt.coverImage:b.mbYTPlayer.locationProtocol+"//i.ytimg.com/vi/"+a.videoID+"/maxresdefault.jpg";d&&a.opt.containment.css({background:"rgba(0,0,0,0.5) url("+d+") center center",backgroundSize:"cover"})}a.videoData=null}a.opt.ratio=
"auto"==a.opt.ratio?"16/9":a.opt.ratio;a.isPlayer&&!a.opt.autoPlay&&(a.loading=b("<div/>").addClass("loading").html("Loading").hide(),b(a).append(a.loading),a.loading.fadeIn())},removeStoredData:function(){b.mbStorage.remove()},getVideoData:function(){return this.get(0).videoData},getVideoID:function(){return this.get(0).videoID||!1},getPlaylistID:function(){return this.get(0).playlistID||!1},setVideoQuality:function(a){return this.get(0).player.setPlaybackQuality(a),this},playlist:function(a,d,c){function e(l,
h){h=h||"";b.getJSON("https://www.googleapis.com/youtube/v3/playlistItems",{part:"snippet,contentDetails",playlistId:l,maxResults:50,pageToken:h,key:b.mbYTPlayer.apiKey}).done(function(b){for(var l=b.items.length,z=0;l>z;z++)k.videos.push({videoURL:b.items[z].contentDetails.videoId});b.nextPageToken?(h=b.nextPageToken,e(plID,h,a)):g.YTPlaylist(k.videos,d,c)})}var g=this,k=g.get(0);return"String"==typeof a&&""!=b.mbYTPlayer.apiKey?(e(a),this):(k.isList=!0,d&&(a=b.shuffle(a)),k.videoID||(k.videos=a,
k.videoCounter=1,k.videoLength=a.length,b(k).data("property",a[0]),b(k).YTPlayer()),"function"==typeof c&&b(k).one("YTPChanged",function(){c(k)}),b(k).on("YTPEnd",function(){b(k).YTPPlayNext()}),this)},playNext:function(){var a=this.get(0);return a.videoCounter++,a.videoCounter>a.videoLength&&(a.videoCounter=1),b(a).YTPPlayIndex(a.videoCounter),this},playPrev:function(){var a=this.get(0);return a.videoCounter--,0>=a.videoCounter&&(a.videoCounter=a.videoLength),b(a).YTPPlayIndex(a.videoCounter),this},
playIndex:function(a){var d=this.get(0);d.checkForStartAt&&(clearInterval(d.checkForStartAt),clearInterval(d.getState));d.videoCounter=a;d.videoCounter>=d.videoLength&&(d.videoCounter=d.videoLength);a=d.videos[d.videoCounter-1];return b(d).YTPChangeVideo(a),this},changeVideo:function(a){var d=this,c=d.get(0);c.opt.startAt=0;c.opt.stopAt=0;c.opt.mask=!1;c.opt.mute=!0;c.opt.autoPlay=!0;c.opt.addFilters=!1;c.opt.coverImage=!1;c.hasData=!1;c.hasChanged=!0;c.player.loopTime=void 0;a&&b.extend(c.opt,a);
c.videoID=getYTPVideoID(c.opt.videoURL).videoID;c.opt.loop&&"boolean"==typeof c.opt.loop&&(c.opt.loop=9999);c.wrapper.css({background:"none"});b(c.playerEl).CSSAnimate({opacity:0},c.opt.fadeOnStartTime,function(){b.mbYTPlayer.getDataFromAPI(c);d.YTPGetPlayer().loadVideoById({videoId:c.videoID,suggestedQuality:c.opt.quality});d.YTPPause();d.optimizeDisplay();d.YTPCheckForState()});a=b.Event("YTPChangeVideo");return a.time=c.currentTime,b(c).trigger(a),b.mbYTPlayer.applyMask(c),this},getPlayer:function(){return b(this).get(0).player},
playerDestroy:function(){var a=this.get(0);return c.YTAPIReady=!0,c.backgroundIsInited=!1,a.isInit=!1,a.videoID=null,a.isReady=!1,a.wrapper.remove(),b("#controlBar_"+a.id).remove(),clearInterval(a.checkForStartAt),clearInterval(a.getState),this},fullscreen:function(a){function d(){g.overlay.css({cursor:"none"})}function c(a,b){for(var d,f,e=["webkit","moz","ms","o",""],r=0;r<e.length&&!a[d];){if(d=b,""==e[r]&&(d=d.substr(0,1).toLowerCase()+d.substr(1)),d=e[r]+d,f=typeof a[d],"undefined"!=f)return"function"==
f?a[d]():a[d];r++}}function e(a){c(a,"RequestFullScreen")}var g=this.get(0);"undefined"==typeof a&&(a=eval(g.opt.realfullscreen));var k=b("#controlBar_"+g.id),l=k.find(".mb_OnlyYT"),h=g.isPlayer?g.opt.containment:g.wrapper;if(a){var n=b.mbBrowser.mozilla?"mozfullscreenchange":b.mbBrowser.webkit?"webkitfullscreenchange":"fullscreenchange";b(document).off(n).on(n,function(){c(document,"IsFullScreen")||c(document,"FullScreen")?(b(g).YTPSetVideoQuality("default"),b(g).trigger("YTPFullScreenStart")):(g.isAlone=
!1,l.html(b.mbYTPlayer.controls.onlyYT),b(g).YTPSetVideoQuality(g.opt.quality),h.removeClass("YTPFullscreen"),h.CSSAnimate({opacity:g.opt.opacity},g.opt.fadeOnStartTime),h.css({zIndex:0}),g.isBackground?b("body").after(k):g.wrapper.before(k),b(window).resize(),b(g).trigger("YTPFullScreenEnd"))})}g.isAlone?(b(document).off("mousemove.YTPlayer"),clearTimeout(g.hideCursor),g.overlay.css({cursor:"auto"}),a?(c(document,"FullScreen")||c(document,"IsFullScreen"))&&c(document,"CancelFullScreen"):(h.CSSAnimate({opacity:g.opt.opacity},
g.opt.fadeOnStartTime),h.css({zIndex:0})),l.html(b.mbYTPlayer.controls.onlyYT),g.isAlone=!1):(b(document).on("mousemove.YTPlayer",function(a){g.overlay.css({cursor:"auto"});clearTimeout(g.hideCursor);b(a.target).parents().is(".mb_YTPBar")||(g.hideCursor=setTimeout(d,3E3))}),d(),a?(h.css({opacity:0}),h.addClass("YTPFullscreen"),e(h.get(0)),setTimeout(function(){h.CSSAnimate({opacity:1},2*g.opt.fadeOnStartTime);h.append(k);b(g).optimizeDisplay();g.player.seekTo(g.player.getCurrentTime()+.1,!0)},g.opt.fadeOnStartTime)):
h.css({zIndex:1E4}).CSSAnimate({opacity:1},2*g.opt.fadeOnStartTime),l.html(b.mbYTPlayer.controls.showSite),g.isAlone=!0);return this},toggleLoops:function(){var a=this.get(0),b=a.opt;return 1==b.loop?b.loop=0:(b.startAt?a.player.seekTo(b.startAt):a.player.playVideo(),b.loop=1),this},play:function(){var a=this.get(0);if(!a.isReady)return this;a.player.playVideo();b(a.playerEl).css({opacity:1});a.wrapper.css({backgroundImage:"none"});a.wrapper.CSSAnimate({opacity:a.isAlone?1:a.opt.opacity},a.opt.fadeOnStartTime);
return b("#controlBar_"+a.id).find(".mb_YTPPlayPause").html(b.mbYTPlayer.controls.pause),a.state=1,a.orig_background=b(a).css("background-image"),this},togglePlay:function(a){var b=this.get(0);return 1==b.state?this.YTPPause():this.YTPPlay(),"function"==typeof a&&a(b.state),this},stop:function(){var a=this.get(0);return b("#controlBar_"+a.id).find(".mb_YTPPlayPause").html(b.mbYTPlayer.controls.play),a.player.stopVideo(),this},pause:function(){var a=this.get(0);return a.player.pauseVideo(),a.state=
2,this},seekTo:function(a){return this.get(0).player.seekTo(a,!0),this},setVolume:function(a){var b=this.get(0);return b.opt.vol=a,b.player.setVolume(b.opt.vol),b.volumeBar&&b.volumeBar.length&&b.volumeBar.updateSliderVal(a),this},getVolume:function(){return this.get(0).player.getVolume()},toggleVolume:function(){var a=this.get(0);return a?(a.isMute?(b.mbBrowser.mobile||this.YTPSetVolume(a.opt.vol),this.YTPUnmute()):this.YTPMute(),this):this},mute:function(){var a=this.get(0);if(a.isMute)return this;
a.player.mute();a.isMute=!0;a.player.setVolume(0);a.volumeBar&&a.volumeBar.length&&10<a.volumeBar.width()&&a.volumeBar.updateSliderVal(0);b("#controlBar_"+a.id).find(".mb_YTPMuteUnmute").html(b.mbYTPlayer.controls.unmute);b(a).addClass("isMuted");a.volumeBar&&a.volumeBar.length&&a.volumeBar.addClass("muted");var d=b.Event("YTPMuted");return d.time=a.currentTime,a.preventTrigger||b(a).trigger(d),this},unmute:function(){var a=this.get(0);if(!a.isMute)return this;a.player.unMute();a.isMute=!1;b(a).YTPSetVolume(a.opt.vol);
a.volumeBar&&a.volumeBar.length&&a.volumeBar.updateSliderVal(10<a.opt.vol?a.opt.vol:10);b("#controlBar_"+a.id).find(".mb_YTPMuteUnmute").html(b.mbYTPlayer.controls.mute);b(a).removeClass("isMuted");a.volumeBar&&a.volumeBar.length&&a.volumeBar.removeClass("muted");var d=b.Event("YTPUnmuted");return d.time=a.currentTime,a.preventTrigger||b(a).trigger(d),this},applyFilter:function(a,b){var c=this.get(0);c.filters[a].value=b;c.filtersEnabled&&this.YTPEnableFilters()},applyFilters:function(a){var d=this,
c=d.get(0);if(!c.isReady)return b(c).on("YTPReady",function(){d.YTPApplyFilters(a)}),this;for(var e in a)d.YTPApplyFilter(e,a[e]);d.trigger("YTPFiltersApplied")},toggleFilter:function(a,d){var c=this.get(0);return c.filters[a].value?c.filters[a].value=0:c.filters[a].value=d,c.filtersEnabled&&b(c).YTPEnableFilters(),this},toggleFilters:function(a){var d=this.get(0);return d.filtersEnabled?(b(d).trigger("YTPDisableFilters"),b(d).YTPDisableFilters()):(b(d).YTPEnableFilters(),b(d).trigger("YTPEnableFilters")),
"function"==typeof a&&a(d.filtersEnabled),this},disableFilters:function(){var a=this.get(0),d=b(a.playerEl);return d.css("-webkit-filter",""),d.css("filter",""),a.filtersEnabled=!1,this},enableFilters:function(){var a=this.get(0),d=b(a.playerEl),c="",e;for(e in a.filters)a.filters[e].value&&(c+=e.replace("_","-")+"("+a.filters[e].value+a.filters[e].unit+") ");return d.css("-webkit-filter",c),d.css("filter",c),a.filtersEnabled=!0,this},removeFilter:function(a,d){var c=this.get(0);if("function"==typeof a&&
(d=a,a=null),a)this.YTPApplyFilter(a,0),"function"==typeof d&&d(a);else{for(var e in c.filters)this.YTPApplyFilter(e,0);"function"==typeof d&&d(e);c.filters=b.extend(!0,{},b.mbYTPlayer.defaultFilters)}c=b.Event("YTPFiltersApplied");return this.trigger(c),this},getFilters:function(){return this.get(0).filters},addMask:function(a){var d=this.get(0);a||(a=d.actualMask);var c=b("<img/>").attr("src",a).on("load",function(){d.overlay.CSSAnimate({opacity:0},d.opt.fadeOnStartTime,function(){d.hasMask=!0;
c.remove();d.overlay.css({backgroundImage:"url("+a+")",backgroundRepeat:"no-repeat",backgroundPosition:"center center",backgroundSize:"cover"});d.overlay.CSSAnimate({opacity:1},d.opt.fadeOnStartTime)})});return this},removeMask:function(){var a=this.get(0);return a.overlay.CSSAnimate({opacity:0},a.opt.fadeOnStartTime,function(){a.hasMask=!1;a.overlay.css({backgroundImage:"",backgroundRepeat:"",backgroundPosition:"",backgroundSize:""});a.overlay.CSSAnimate({opacity:1},a.opt.fadeOnStartTime)}),this},
applyMask:function(a){var d=b(a);if(d.off("YTPTime.mask"),a.opt.mask)if("string"==typeof a.opt.mask)d.YTPAddMask(a.opt.mask),a.actualMask=a.opt.mask;else if("object"==typeof a.opt.mask){for(var c in a.opt.mask)a.opt.mask[c]&&b("<img/>").attr("src",a.opt.mask[c]);a.opt.mask[0]&&d.YTPAddMask(a.opt.mask[0]);d.on("YTPTime.mask",function(b){for(var c in a.opt.mask)b.time==c&&(a.opt.mask[c]?(d.YTPAddMask(a.opt.mask[c]),a.actualMask=a.opt.mask[c]):d.YTPRemoveMask())})}},toggleMask:function(){var a=this.get(0),
d=b(a);return a.hasMask?d.YTPRemoveMask():d.YTPAddMask(),this},manageProgress:function(){var a=this.get(0),d=b("#controlBar_"+a.id),c=d.find(".mb_YTPProgress"),e=d.find(".mb_YTPLoaded"),d=d.find(".mb_YTPseekbar"),g=c.outerWidth(),c=Math.floor(a.player.getCurrentTime()),k=Math.floor(a.player.getDuration()),g=c*g/k,a=100*a.player.getVideoLoadedFraction();return e.css({left:0,width:a+"%"}),d.css({left:0,width:g}),{totalTime:k,currentTime:c}},buildControls:function(a){if(b("#controlBar_"+a.id).remove(),
!a.opt.showControls)return void(a.controlBar=!1);if(a.opt.showYTLogo=a.opt.showYTLogo||a.opt.printUrl,!b("#controlBar_"+a.id).length){a.controlBar=b("<span/>").attr("id","controlBar_"+a.id).addClass("mb_YTPBar").css({whiteSpace:"noWrap",position:a.isBackground?"fixed":"absolute",zIndex:a.isBackground?1E4:1E3}).hide().on("click",function(a){a.stopPropagation()});var d=b("<div/>").addClass("buttonBar"),c=b("<span>"+b.mbYTPlayer.controls.play+"</span>").addClass("mb_YTPPlayPause ytpicon").on("click",
function(d){d.stopPropagation();b(a).YTPTogglePlay()}),e=b("<span>"+b.mbYTPlayer.controls.mute+"</span>").addClass("mb_YTPMuteUnmute ytpicon").on("click",function(d){d.stopPropagation();b(a).YTPToggleVolume()}),g=b("<div/>").addClass("mb_YTPVolumeBar").css({display:"inline-block"});a.volumeBar=g;var k=b("<span/>").addClass("mb_YTPTime"),l=a.opt.videoURL?a.opt.videoURL:"";0>l.indexOf("http")&&(l=b.mbYTPlayer.locationProtocol+"//www.youtube.com/watch?v="+a.opt.videoURL);var h=b("<span/>").html(b.mbYTPlayer.controls.ytLogo).addClass("mb_YTPUrl ytpicon").attr("title",
"view on YouTube").on("click",function(){window.open(l,"viewOnYT")}),n=b("<span/>").html(b.mbYTPlayer.controls.onlyYT).addClass("mb_OnlyYT ytpicon").on("click",function(d){d.stopPropagation();b(a).YTPFullscreen(a.opt.realfullscreen)}),p=b("<div/>").addClass("mb_YTPProgress").css("position","absolute").on("click",function(b){b.stopPropagation();B.css({width:b.clientX-B.offset().left});a.timeW=b.clientX-B.offset().left;a.controlBar.find(".mb_YTPLoaded").css({width:0});b=Math.floor(a.player.getDuration());
a["goto"]=B.outerWidth()*b/p.outerWidth();a.player.seekTo(parseFloat(a["goto"]),!0);a.controlBar.find(".mb_YTPLoaded").css({width:0})}),z=b("<div/>").addClass("mb_YTPLoaded").css("position","absolute"),B=b("<div/>").addClass("mb_YTPseekbar").css("position","absolute");p.append(z).append(B);d.append(c).append(e).append(g).append(k);a.opt.showYTLogo&&d.append(h);(a.isBackground||eval(a.opt.realfullscreen)&&!a.isBackground)&&d.append(n);a.controlBar.append(d).append(p);a.isBackground?b("body").after(a.controlBar):
...
eval(a.opt.stopMovieOnBlur)&&(document.hasFocus()?document.hasFocus()&&!a.hasFocus&&-1!=a.state&&0!=a.state&&(a.hasFocus=!0,a.preventTrigger=!0,a.player.playVideo()):1==a.state&&(a.hasFocus=!1,a.preventTrigger=!0,d.YTPPause())),a.opt.playOnlyIfVisible)(c=b.mbYTPlayer.isOnScreen(a,a.opt.onScreenPercentage))||1!=a.state?c&&!a.isOnScreen&&(a.isOnScreen=!0,a.player.playVideo()):(a.isOnScreen=!1,d.YTPPause());if((a.controlBar.length&&400>=a.controlBar.outerWidth()&&!a.isCompact?(a.controlBar.addClass("compact"),
...
a.player.loopTime===a.opt.loop-1)return a.player.loopTime=void 0,clearInterval(a.getState),d=b.Event("YTPEnd"),d.time=a.currentTime,void b(a).trigger(d)}else if(!a.opt.loop||0<a.opt.loop&&a.player.loopTime===a.opt.loop-1)return a.player.loopTime=void 0,a.state=2,a.opt.containment.css({background:"rgba(0,0,0,0.5) url("+("false"!=a.opt.coverImage?a.opt.coverImage:a.videoData.thumb_max||a.videoData.thumb_high||a.videoData.thumb_medium)+") center center",backgroundSize:"cover"}),b(a).YTPPause(),void a.wrapper.CSSAnimate({opacity:0},
a.opt.fadeOnStartTime,function(){a.controlBar.length&&a.controlBar.find(".mb_YTPPlayPause").html(b.mbYTPlayer.controls.play);var d=b.Event("YTPEnd");d.time=a.currentTime;b(a).trigger(d);a.player.seekTo(a.opt.startAt,!0);a.isBackground?a.orig_background&&b(a).css("background-image",a.orig_background):a.opt.coverImage&&a.isPlayer&&(a.opt.coverImage=a.opt.coverImage||a.orig_background,a.opt.containment.css({background:"url("+a.opt.coverImage+") center center",backgroundSize:"cover"}))});a.player.loopTime=
a.player.loopTime?++a.player.loopTime:1;a.opt.startAt=a.opt.startAt||1;a.preventTrigger=!0;a.state=2;a.player.pauseVideo();a.player.seekTo(a.opt.startAt,!0);a.player.playVideo()}}},100))):(d.YTPPlayerDestroy(),clearInterval(a.getState),void clearInterval(a.checkForStartAt))},checkForStart:function(a){var d=b(a);if(!b.contains(document,a))return void d.YTPPlayerDestroy();if(b.mbYTPlayer.buildControls(a),a.overlay)if(a.opt.addRaster){var c="dot"==a.opt.addRaster?"raster-dot":"raster";a.overlay.addClass(a.isRetina?
c+" retina":c)}else a.overlay.removeClass(function(a,d){var c=d.split(" "),f=[];return b.each(c,function(a,b){/raster.*/.test(b)&&f.push(b)}),f.push("retina"),f.join(" ")});a.preventTrigger=!0;a.state=2;d.YTPPause();d.YTPMute();var e=a.start_from_last?a.start_from_last:a.opt.startAt?a.opt.startAt:1;return a.preventTrigger=!0,a.player.playVideo(),d.YTPMute(),a.player.seekTo(e,!0),a.isStarting=!0,a.checkForStartAt=setInterval(function(){var c=a.player.getVideoLoadedFraction()>=e/a.player.getDuration();
0<a.player.getDuration()&&a.player.getCurrentTime()>=e&&c?(a.start_from_last=null,clearInterval(a.checkForStartAt),"function"==typeof a.opt.onReady&&a.opt.onReady(a),a.isReady=!0,d.YTPRemoveFilter(),a.opt.addFilters?d.YTPApplyFilters(a.opt.addFilters):d.YTPApplyFilters({}),d.YTPEnableFilters(),c=b.Event("YTPReady"),(c.time=a.currentTime,b(a).trigger(c),a.state=2,b(a).YTPPause(),a.opt.mute||b(a).YTPUnmute(),"undefined"!=typeof _gaq&&eval(a.opt.gaTrack)?_gaq.push(["_trackEvent","YTPlayer","Play",a.hasData?
a.videoData.title:a.videoID.toString()]):"undefined"!=typeof ga&&eval(a.opt.gaTrack)&&ga("send","event","YTPlayer","play",a.hasData?a.videoData.title:a.videoID.toString()),a.opt.autoPlay)?(c=b.Event("YTPStart"),c.time=a.currentTime,b(a).trigger(c),a.isStarting=!1,"mac"==b.mbBrowser.os.name&&b.mbBrowser.safari?setTimeout(function(){d.YTPPlay()},10):d.YTPPlay()):(a.player.pauseVideo(),setTimeout(function(){a.start_from_last&&a.player.seekTo(e,!0);a.isPlayer||(a.opt.coverImage?(a.wrapper.css({opacity:0}),
setTimeout(function(){a.wrapper.css({background:"rgba(0,0,0,0.5) url("+a.opt.coverImage+") center center",backgroundSize:"cover",backgroundRepeat:"no-repeat"})},a.opt.fadeOnStartTime)):(b(a.playerEl).CSSAnimate({opacity:1},a.opt.fadeOnStartTime),a.wrapper.CSSAnimate({opacity:a.isAlone?1:a.opt.opacity},a.opt.fadeOnStartTime)));a.isStarting=!1},150),a.controlBar.length&&a.controlBar.find(".mb_YTPPlayPause").html(b.mbYTPlayer.controls.play)),a.isPlayer&&!a.opt.autoPlay&&a.loading&&a.loading.length&&
(a.loading.html("Ready"),setTimeout(function(){a.loading.fadeOut()},100)),a.controlBar&&a.controlBar.length&&a.controlBar.slideDown(1E3)):"mac"==b.mbBrowser.os.name&&b.mbBrowser.safari&&(a.player.playVideo(),0<=e&&a.player.seekTo(e,!0))},500),d},getTime:function(){var a=this.get(0);return b.mbYTPlayer.formatTime(a.currentTime)},getTotalTime:function(a){a=this.get(0);return b.mbYTPlayer.formatTime(a.totalTime)},formatTime:function(a){var b=Math.floor(a/60);a=Math.floor(a-60*b);return(9>=b?"0"+b:b)+
" : "+(9>=a?"0"+a:a)},setAnchor:function(a){this.optimizeDisplay(a)},getAnchor:function(){return this.get(0).opt.anchor}};b.fn.optimizeDisplay=function(a){var d=this.get(0),c,e,g,k;d.opt.anchor=a||d.opt.anchor;d.opt.anchor="undefined "!=typeof d.opt.anchor?d.opt.anchor:"center,center";a=d.opt.anchor.split(",");c=d.wrapper;var l=b(d.playerEl);if(d.opt.optimizeDisplay){e=l.height()*d.opt.abundance;var h,n;h=c.outerWidth();n=c.outerHeight()+e;d.opt.ratio="auto"===d.opt.ratio?16/9:d.opt.ratio;d.opt.ratio=
eval(d.opt.ratio);c=h;e=Math.ceil(c/d.opt.ratio);g=Math.ceil(-((e-n)/2));k=0;var p=e<n;p&&(e=n,c=Math.ceil(e*d.opt.ratio),g=0,k=Math.ceil(-((c-h)/2)));for(var z in a)if(a.hasOwnProperty(z))switch(a[z].replace(/ /g,"")){case "top":g=p?-((e-n)/2):0;break;case "bottom":g=p?0:-(e-n);break;case "left":k=0;break;case "right":k=p?-(c-h):0;break;default:c>h&&(k=-((c-h)/2))}}else e=c="100%",k=g=0;l.css({width:c,height:e,marginTop:g,marginLeft:k,maxWidth:"initial"})};b.shuffle=function(a){a=a.slice();for(var b=
a.length,c=b;c--;){var e=parseInt(Math.random()*b),g=a[c];a[c]=a[e];a[e]=g}return a};b.fn.unselectable=function(){return this.each(function(){b(this).css({"-moz-user-select":"none","-webkit-user-select":"none","user-select":"none"}).attr("unselectable","on")})};b.fn.YTPlayer=b.mbYTPlayer.buildPlayer;b.fn.mb_YTPlayer=b.mbYTPlayer.buildPlayer;b.fn.YTPCheckForState=b.mbYTPlayer.checkForState;b.fn.YTPGetPlayer=b.mbYTPlayer.getPlayer;b.fn.YTPGetVideoID=b.mbYTPlayer.getVideoID;b.fn.YTPGetPlaylistID=b.mbYTPlayer.getPlaylistID;
b.fn.YTPChangeVideo=b.fn.YTPChangeMovie=b.mbYTPlayer.changeVideo;b.fn.YTPPlayerDestroy=b.mbYTPlayer.playerDestroy;b.fn.YTPPlay=b.mbYTPlayer.play;b.fn.YTPTogglePlay=b.mbYTPlayer.togglePlay;b.fn.YTPStop=b.mbYTPlayer.stop;b.fn.YTPPause=b.mbYTPlayer.pause;b.fn.YTPSeekTo=b.mbYTPlayer.seekTo;b.fn.YTPlaylist=b.mbYTPlayer.playlist;b.fn.YTPPlayNext=b.mbYTPlayer.playNext;b.fn.YTPPlayPrev=b.mbYTPlayer.playPrev;b.fn.YTPPlayIndex=b.mbYTPlayer.playIndex;b.fn.YTPMute=b.mbYTPlayer.mute;b.fn.YTPUnmute=b.mbYTPlayer.unmute;
b.fn.YTPToggleVolume=b.mbYTPlayer.toggleVolume;b.fn.YTPSetVolume=b.mbYTPlayer.setVolume;b.fn.YTPGetVolume=b.mbYTPlayer.getVolume;b.fn.YTPGetVideoData=b.mbYTPlayer.getVideoData;b.fn.YTPFullscreen=b.mbYTPlayer.fullscreen;b.fn.YTPToggleLoops=b.mbYTPlayer.toggleLoops;b.fn.YTPSetVideoQuality=b.mbYTPlayer.setVideoQuality;b.fn.YTPManageProgress=b.mbYTPlayer.manageProgress;b.fn.YTPApplyFilter=b.mbYTPlayer.applyFilter;b.fn.YTPApplyFilters=b.mbYTPlayer.applyFilters;b.fn.YTPToggleFilter=b.mbYTPlayer.toggleFilter;
b.fn.YTPToggleFilters=b.mbYTPlayer.toggleFilters;b.fn.YTPRemoveFilter=b.mbYTPlayer.removeFilter;b.fn.YTPDisableFilters=b.mbYTPlayer.disableFilters;b.fn.YTPEnableFilters=b.mbYTPlayer.enableFilters;b.fn.YTPGetFilters=b.mbYTPlayer.getFilters;b.fn.YTPGetTime=b.mbYTPlayer.getTime;b.fn.YTPGetTotalTime=b.mbYTPlayer.getTotalTime;b.fn.YTPAddMask=b.mbYTPlayer.addMask;b.fn.YTPRemoveMask=b.mbYTPlayer.removeMask;b.fn.YTPToggleMask=b.mbYTPlayer.toggleMask;b.fn.YTPSetAnchor=b.mbYTPlayer.setAnchor;b.fn.YTPGetAnchor=
b.mbYTPlayer.getAnchor}(jQuery,ytp);jQuery.support.CSStransition=function(){var b=(document.body||document.documentElement).style;return void 0!==b.transition||void 0!==b.WebkitTransition||void 0!==b.MozTransition||void 0!==b.MsTransition||void 0!==b.OTransition}();
...
!0;g.CSSAIsRunning=!1;k.off(jQuery.CSS.transitionEnd+"."+g.id);clearTimeout(g.timeout);k.css(jQuery.CSS.sfx+"transition","");"function"==typeof f&&f.apply(g);"function"==typeof g.CSSqueue&&(g.CSSqueue(),g.CSSqueue=null)}var g=this,k=jQuery(this);g.id=g.id||"CSSA_"+(new Date).getTime();var l=l||{type:"noEvent"};if(g.CSSAIsRunning&&g.eventType==l.type&&!jQuery.browser.msie&&9>=jQuery.browser.version)g.CSSqueue=function(){k.CSSAnimate(b,c,a,d,f)};else if(g.CSSqueue=null,g.eventType=l.type,0!==k.length&&
b){if(b=jQuery.normalizeCss(b),g.CSSAIsRunning=!0,"function"==typeof c&&(f=c,c=jQuery.fx.speeds._default),"function"==typeof a&&(d=a,a=0),"string"==typeof a&&(f=a,a=0),"function"==typeof d&&(f=d,d="cubic-bezier(0.65,0.03,0.36,0.72)"),"string"==typeof c)for(var h in jQuery.fx.speeds){if(c==h){c=jQuery.fx.speeds[h];break}c=jQuery.fx.speeds._default}if(c||(c=jQuery.fx.speeds._default),"string"==typeof f&&(d=f,f=null),jQuery.support.CSStransition){var n={"default":"ease","in":"ease-in",out:"ease-out",
...
n[d]&&(d=n[d]);k.off(jQuery.CSS.transitionEnd+"."+g.id);var n=jQuery.CSS.getProp(b),p={};jQuery.extend(p,b);p[jQuery.CSS.sfx+"transition-property"]=n;p[jQuery.CSS.sfx+"transition-duration"]=c+"ms";p[jQuery.CSS.sfx+"transition-delay"]=a+"ms";p[jQuery.CSS.sfx+"transition-timing-function"]=d;setTimeout(function(){k.one(jQuery.CSS.transitionEnd+"."+g.id,e);k.css(p)},1);g.timeout=setTimeout(function(){g.called||!f?(g.called=!1,g.CSSAIsRunning=!1):(k.css(jQuery.CSS.sfx+"transition",""),f.apply(g),g.CSSAIsRunning=
...
null),n=h.getPropertyValue("position"),p=h.getPropertyValue("overflow"),h=h.getPropertyValue("display");n&&"static"!==n||(f.style.position="relative");"hidden"!==p&&(f.style.overflow="hidden");h&&"inline"!==h||(f.style.display="block");0===f.clientHeight&&(f.style.height="100%");-1===f.className.indexOf("object-fit-polyfill")&&(f.className+=" object-fit-polyfill");var n=window.getComputedStyle(b,null),p={"max-width":"none","max-height":"none","min-width":"0px","min-height":"0px",top:"auto",right:"auto",
bottom:"auto",left:"auto","margin-top":"0px","margin-right":"0px","margin-bottom":"0px","margin-left":"0px"},z;for(z in p)n.getPropertyValue(z)!==p[z]&&(b.style[z]=p[z]);b.style.position="absolute";b.style.height="100%";b.style.width="auto";"scale-down"===d&&(b.style.height="auto",b.clientWidth<f.clientWidth&&b.clientHeight<f.clientHeight?(a("x",b,c),a("y",b,c)):(d="contain",b.style.height="100%"));"none"===d?(b.style.width="auto",b.style.height="auto",a("x",b,c),a("y",b,c)):"cover"===d&&b.clientWidth>
...
this}catch(k){}try{a.eventPhase=0|b}catch(k){}a.removed=!1;e=e.slice();for(g=0;c>g&&!a.immediatePropagationStopped;g++){var l=e[g];l.handleEvent?l.handleEvent(a):l(a);a.removed&&(this.off(a.type,l,1==b),a.removed=!1)}}2===b&&this._dispatchEvent(a,2.1)};createjs.EventDispatcher=b})();this.createjs=this.createjs||{};
...
(function(){function b(d,c){function e(a){if(e[a]!==F)return e[a];var b;if("bug-string-char-index"==a)b="a"!="a"[0];else if("json"==a)b=e("json-stringify")&&e("json-parse");else{var d;if("json-stringify"==a){b=c.stringify;var f="function"==typeof b&&K;if(f){(d=function(){return 1}).toJSON=d;try{f="0"===b(0)&&"0"===b(new g)&&'""'==b(new h)&&b(C)===F&&b(F)===F&&b()===F&&"1"===b(d)&&"[1]"==b([d])&&"[null]"==b([F])&&"null"==b(null)&&"[null,null,null]"==b([F,C,null])&&'{"a":[1,true,false,null,"\\u0000\\b\\n\\f\\r\\t"]}'==
b({a:[d,!0,!1,null,"\x00\b\n\f\r\t"]})&&"1"===b(null,d)&&"[\n 1,\n 2\n]"==b([1,2],null,1)&&'"-271821-04-20T00:00:00.000Z"'==b(new r(-864E13))&&'"+275760-09-13T00:00:00.000Z"'==b(new r(864E13))&&'"-000001-01-01T00:00:00.000Z"'==b(new r(-621987552E5))&&'"1969-12-31T23:59:59.999Z"'==b(new r(-1))}catch(m){f=!1}}b=f}if("json-parse"==a){b=c.parse;if("function"==typeof b)try{if(0===b("0")&&!b(!1)){d=b('{"a":[1,true,false,null,"\\u0000\\b\\n\\f\\r\\t"]}');var q=5==d.a.length&&1===d.a[0];if(q){try{q=!b('"\t"')}catch(m){}if(q)try{q=
1!==b("01")}catch(m){}if(q)try{q=1!==b("1.")}catch(m){}}}}catch(m){q=!1}b=q}}return e[a]=!!b}d||(d=f.Object());c||(c=f.Object());var g=d.Number||f.Number,h=d.String||f.String,m=d.Object||f.Object,r=d.Date||f.Date,q=d.SyntaxError||f.SyntaxError,y=d.TypeError||f.TypeError,k=d.Math||f.Math,l=d.JSON||f.JSON;"object"==typeof l&&l&&(c.stringify=l.stringify,c.parse=l.parse);var L,I,F,m=m.prototype,C=m.toString,K=new r(-0xc782b5b800cec);try{K=-109252==K.getUTCFullYear()&&0===K.getUTCMonth()&&1===K.getUTCDate()&&
10==K.getUTCHours()&&37==K.getUTCMinutes()&&6==K.getUTCSeconds()&&708==K.getUTCMilliseconds()}catch(G){}if(!e("json")){var Q=e("bug-string-char-index");if(!K)var J=k.floor,W=[0,31,59,90,120,151,181,212,243,273,304,334],D=function(a,b){return W[b]+365*(a-1970)+J((a-1969+(b=+(1<b)))/4)-J((a-1901+b)/100)+J((a-1601+b)/400)};if((L=m.hasOwnProperty)||(L=function(a){var b,d={};return(d.__proto__=null,d.__proto__={toString:1},d).toString!=C?L=function(a){var b=this.__proto__;a=a in(this.__proto__=null,this);
return this.__proto__=b,a}:(b=d.constructor,L=function(a){var d=(this.constructor||b).prototype;return a in this&&!(a in d&&this[a]===d[a])}),d=null,L.call(this,a)}),I=function(b,d){var c,f,e,r=0;(c=function(){this.valueOf=0}).prototype.valueOf=0;f=new c;for(e in f)L.call(f,e)&&r++;return c=f=null,r?I=2==r?function(a,b){var d,c={},f="[object Function]"==C.call(a);for(d in a)f&&"prototype"==d||L.call(c,d)||!(c[d]=1)||!L.call(a,d)||b(d)}:function(a,b){var d,c,f="[object Function]"==C.call(a);for(d in a)f&&
"prototype"==d||!L.call(a,d)||(c="constructor"===d)||b(d);(c||L.call(a,d="constructor"))&&b(d)}:(f="valueOf toString toLocaleString propertyIsEnumerable isPrototypeOf hasOwnProperty constructor".split(" "),I=function(b,d){var c,e;e="[object Function]"==C.call(b);var r=!e&&"function"!=typeof b.constructor&&a[typeof b.hasOwnProperty]&&b.hasOwnProperty||L;for(c in b)e&&"prototype"==c||!r.call(b,c)||d(c);for(e=f.length;c=f[--e];r.call(b,c)&&d(c));}),I(b,d)},!e("json-stringify")){var ea={92:"\\\\",34:'\\"',
8:"\\b",12:"\\f",10:"\\n",13:"\\r",9:"\\t"},Z=function(a,b){return("000000"+(b||0)).slice(-a)},na=function(a){for(var b='"',d=0,c=a.length,f=!Q||10<c,e=f&&(Q?a.split(""):a);c>d;d++){var r=a.charCodeAt(d);switch(r){case 8:case 9:case 10:case 12:case 13:case 34:case 92:b+=ea[r];break;default:if(32>r){b+="\\u00"+Z(2,r.toString(16));break}b+=f?e[d]:a.charAt(d)}}return b+'"'},ha=function(a,b,d,c,f,e,r){var m,g,t,q,h,k,V,l,X,z;try{m=b[a]}catch(p){}if("object"==typeof m&&m)if(g=C.call(m),"[object Date]"!=
g||L.call(m,"toJSON"))"function"==typeof m.toJSON&&("[object Number]"!=g&&"[object String]"!=g&&"[object Array]"!=g||L.call(m,"toJSON"))&&(m=m.toJSON(a));else if(m>-1/0&&1/0>m){if(D){h=J(m/864E5);for(t=J(h/365.2425)+1970-1;D(t+1,0)<=h;t++);for(q=J((h-D(t,0))/30.42);D(t,q+1)<=h;q++);h=1+h-D(t,q);k=(m%864E5+864E5)%864E5;V=J(k/36E5)%24;l=J(k/6E4)%60;X=J(k/1E3)%60;k%=1E3}else t=m.getUTCFullYear(),q=m.getUTCMonth(),h=m.getUTCDate(),V=m.getUTCHours(),l=m.getUTCMinutes(),X=m.getUTCSeconds(),k=m.getUTCMilliseconds();
m=(0>=t||1E4<=t?(0>t?"-":"+")+Z(6,0>t?-t:t):Z(4,t))+"-"+Z(2,q+1)+"-"+Z(2,h)+"T"+Z(2,V)+":"+Z(2,l)+":"+Z(2,X)+"."+Z(3,k)+"Z"}else m=null;if(d&&(m=d.call(b,a,m)),null===m)return"null";if(g=C.call(m),"[object Boolean]"==g)return""+m;if("[object Number]"==g)return m>-1/0&&1/0>m?""+m:"null";if("[object String]"==g)return na(""+m);if("object"==typeof m){for(a=r.length;a--;)if(r[a]===m)throw y();if(r.push(m),z=[],b=e,e+=f,"[object Array]"==g){t=0;for(a=m.length;a>t;t++)g=ha(t,m,d,c,f,e,r),z.push(g===F?"null":
g);g=z.length?f?"[\n"+e+z.join(",\n"+e)+"\n"+b+"]":"["+z.join(",")+"]":"[]"}else I(c||m,function(a){var b=ha(a,m,d,c,f,e,r);b!==F&&z.push(na(a)+":"+(f?" ":"")+b)}),g=z.length?f?"{\n"+e+z.join(",\n"+e)+"\n"+b+"}":"{"+z.join(",")+"}":"{}";return r.pop(),g}};c.stringify=function(b,d,c){var f,e,r,m;if(a[typeof d]&&d)if("[object Function]"==(m=C.call(d)))e=d;else if("[object Array]"==m){r={};for(var g,q=0,t=d.length;t>q;g=d[q++],m=C.call(g),("[object String]"==m||"[object Number]"==m)&&(r[g]=1));}if(c)if("[object Number]"==
(m=C.call(c))){if(0<(c-=c%1))for(f="",10<c&&(c=10);f.length<c;f+=" ");}else"[object String]"==m&&(f=10>=c.length?c:c.slice(0,10));return ha("",(g={},g[""]=b,g),e,r,f,"",[])}}if(!e("json-parse")){var H,x,la=h.fromCharCode,ma={92:"\\",34:'"',47:"/",98:"\b",116:"\t",110:"\n",102:"\f",114:"\r"},Y=function(){throw H=x=null,q();},ca=function(){for(var a,b,d,c,f,e=x,r=e.length;r>H;)switch(f=e.charCodeAt(H)){case 9:case 10:case 13:case 32:H++;break;case 123:case 125:case 91:case 93:case 58:case 44:return a=
Q?e.charAt(H):e[H],H++,a;case 34:a="@";for(H++;r>H;)if(f=e.charCodeAt(H),32>f)Y();else if(92==f)switch(f=e.charCodeAt(++H)){case 92:case 34:case 47:case 98:case 116:case 110:case 102:case 114:a+=ma[f];H++;break;case 117:b=++H;for(d=H+4;d>H;H++)f=e.charCodeAt(H),48<=f&&57>=f||97<=f&&102>=f||65<=f&&70>=f||Y();a+=la("0x"+e.slice(b,H));break;default:Y()}else{if(34==f)break;f=e.charCodeAt(H);for(b=H;32<=f&&92!=f&&34!=f;)f=e.charCodeAt(++H);a+=e.slice(b,H)}if(34==e.charCodeAt(H))return H++,a;Y();default:if(b=
H,45==f&&(c=!0,f=e.charCodeAt(++H)),48<=f&&57>=f){for(48==f&&(f=e.charCodeAt(H+1),48<=f&&57>=f)&&Y();r>H&&(f=e.charCodeAt(H),48<=f&&57>=f);H++);if(46==e.charCodeAt(H)){for(d=++H;r>d&&(f=e.charCodeAt(d),48<=f&&57>=f);d++);d==H&&Y();H=d}if(f=e.charCodeAt(H),101==f||69==f){f=e.charCodeAt(++H);43!=f&&45!=f||H++;for(d=H;r>d&&(f=e.charCodeAt(d),48<=f&&57>=f);d++);d==H&&Y();H=d}return+e.slice(b,H)}if(c&&Y(),"true"==e.slice(H,H+4))return H+=4,!0;if("false"==e.slice(H,H+5))return H+=5,!1;if("null"==e.slice(H,
H+4))return H+=4,null;Y()}return"$"},ia=function(a){var b,d;if("$"==a&&Y(),"string"==typeof a){if("@"==(Q?a.charAt(0):a[0]))return a.slice(1);if("["==a){for(b=[];a=ca(),"]"!=a;d||(d=!0))d&&(","==a?(a=ca(),"]"==a&&Y()):Y()),","==a&&Y(),b.push(ia(a));return b}if("{"==a){for(b={};a=ca(),"}"!=a;d||(d=!0))d&&(","==a?(a=ca(),"}"==a&&Y()):Y()),","!=a&&"string"==typeof a&&"@"==(Q?a.charAt(0):a[0])&&":"==ca()||Y(),b[a.slice(1)]=ia(ca());return b}Y()}return a},qa=function(a,b,d){d=pa(a,b,d);d===F?delete a[b]:
a[b]=d},pa=function(a,b,d){var c,f=a[b];if("object"==typeof f&&f)if("[object Array]"==C.call(f))for(c=f.length;c--;)qa(f,c,d);else I(f,function(a){qa(f,a,d)});return d.call(a,b,f)};c.parse=function(a,b){var d,c;return H=0,x=""+a,d=ia(ca()),"$"!=ca()&&Y(),H=x=null,b&&"[object Function]"==C.call(b)?pa((c={},c[""]=d,c),"",b):d}}}return c.runInContext=b,c}var c="function"==typeof define&&define.amd,a={"function":!0,object:!0},d=a[typeof exports]&&exports&&!exports.nodeType&&exports,f=a[typeof window]&&
window||this,e=d&&a[typeof module]&&module&&!module.nodeType&&"object"==typeof global&&global;if(!e||e.global!==e&&e.window!==e&&e.self!==e||(f=e),d&&!c)b(f,d);else{var g=f.JSON,k=f.JSON3,l=!1,h=b(f,f.JSON3={noConflict:function(){return l||(l=!0,f.JSON=g,f.JSON3=k,g=k=null),h}});f.JSON={parse:h.parse,stringify:h.stringify}}c&&define(function(){return h})}).call(this);
...
1)[0].cancel();break}for(l=this._loadQueueBackup.length-1;0<=l;l--)if(h=this._loadQueueBackup[l].getItem(),h.id==g||h.src==g){this._loadQueueBackup.splice(l,1)[0].cancel();break}if(k)this._disposeItem(this.getItem(g));else for(l=this._currentLoads.length-1;0<=l;l--){var h=this._currentLoads[l].getItem();if(h.id==g||h.src==g){this._currentLoads.splice(l,1)[0].cancel();c=!0;break}}}c&&this._loadNext()}else{this.close();for(g in this._loadItemsById)this._disposeItem(this._loadItemsById[g]);this.init(this.preferXHR,
...
g=a}else if("string"==typeof a)g=[{src:a,type:b.MANIFEST}];else{if("object"!=typeof a)return g=new createjs.ErrorEvent("PRELOAD_MANIFEST_NULL"),void this._sendError(g);void 0!==a.src?(null==a.type?a.type=b.MANIFEST:a.type!=b.MANIFEST&&(g=new createjs.ErrorEvent("PRELOAD_MANIFEST_TYPE"),this._sendError(g)),g=[a]):void 0!==a.manifest&&(g=a.manifest,k=a.path)}a=0;for(var l=g.length;l>a;a++)this._addItem(g[a],k,e);this.setPaused(!1!==c?!1:!0)};c.load=function(){this.setPaused(!1)};c.getItem=function(a){return this._loadItemsById[a]||
...
g.refs,l=k.length-1;0<=l;l--)if(this._getTextWidth(g.family+","+c[l],g.weight,g.style)!=k[l]){k=new createjs.Event("fileload");g.type="font-family";k.item=g;this.dispatchEvent(k);a.splice(e,1);break}f!==a.length&&(k=new createjs.ProgressEvent(this._count-a.length,this._count),this.dispatchEvent(k));0===f&&(this._stopWatching(),this._sendComplete())};c._calculateReferenceSizes=function(a){for(var c=b._referenceFonts,f=a.refs=[],e=0;e<c.length;e++)f[e]=this._getTextWidth(c[e],a.weight,a.style)};c._defFromSrc=
function(a){var c,f=/[- ._]+/g,e=a,g=null;c=e.search(/[?#]/);-1!==c&&(e=e.substr(0,c));c=e.lastIndexOf(".");-1!==c&&(g=e.substr(c+1),e=e.substr(0,c));c=e.lastIndexOf("/");-1!==c&&(e=e.substr(c+1));c=e;var k=c.match(b.WEIGHT_REGEX);k&&(k=k[0],c=c.replace(k,""),k=k.replace(f,"").toLowerCase());var l=e.match(b.STYLE_REGEX);l&&(c=c.replace(l[0],""),l="italic");c=c.replace(f,"");a="local('"+e.replace(f," ")+"'), url('"+a+"')";g=b.FONT_FORMAT[g];return g&&(a+=" format('"+g+"')"),this._defFromObj({family:c,
...
a=b._getSrcById(a);var k=b._parsePath(a.src),l=null;return null!=k&&null!=k.src?(c.create(k.src),null==f&&(f=a.startTime),l=b.activePlugin.create(k.src,f,e||a.duration),g=g||b._defaultPlayPropsHash[k.src],g&&l.applyPlayProps(g)):l=new createjs.DefaultSoundInstance(a,f,e),l.uniqueId=b._lastID++,l};b.stop=function(){for(var a=this._instances,b=a.length;b--;)a[b].stop()};b.setDefaultPlayProps=function(a,c){a=b._getSrcById(a);b._defaultPlayPropsHash[b._parsePath(a.src).src]=createjs.PlayPropsConfig.create(c)};
...
e=createjs.Sound.EXTENSION_MAP,g=0,k=c.length;k>g;g++){var l=c[g],h=e[l]||l;a._capabilities[l]="no"!=b.canPlayType("audio/"+l)&&""!=b.canPlayType("audio/"+l)||"no"!=b.canPlayType("audio/"+h)&&""!=b.canPlayType("audio/"+h)}2>a.context.destination.numberOfChannels&&(a._capabilities.panning=!1)}};a._createAudioContext=function(){var b=window.AudioContext||window.webkitAudioContext;if(null==b)return null;var c=new b;if(/(iPhone|iPad)/i.test(navigator.userAgent)&&c.sampleRate!==a.DEFAULT_SAMPLE_RATE){var e=
...
function(){if(null==a._capabilities){var b=document.createElement("audio");if(null==b.canPlayType)return null;a._capabilities={panning:!1,volume:!0,tracks:-1};for(var c=createjs.Sound.SUPPORTED_EXTENSIONS,e=createjs.Sound.EXTENSION_MAP,g=0,k=c.length;k>g;g++){var l=c[g],h=e[l]||l;a._capabilities[l]="no"!=b.canPlayType("audio/"+l)&&""!=b.canPlayType("audio/"+l)||"no"!=b.canPlayType("audio/"+h)&&""!=b.canPlayType("audio/"+h)}}};c.register=function(a){var b=createjs.HTMLAudioTagPool.get(a.src);a=this.AbstractPlugin_register(a);
...
c.getPropertyValue(b.replace(g,"-$1").toLowerCase()),f=a||c.length?a:c[b]):a.currentStyle&&(c=a.currentStyle,f=c[b]),d?f:parseInt(f,10)||0},l=function(a){return a.length&&a[0]&&(a[0].nodeType&&a[0].style&&!a.nodeType||a[0].length&&a[0][0])?!0:!1},h=function(a,b){for(var c,d=b.length;-1<--d;)if(c=b[d],a.substr(0,c.length)===c)return c.length},n=/(?:\r|\n|\t\t)/g,p=/(?:\s\s+)/g,z=function(a){return(a.charCodeAt(0)-55296<<10)+(a.charCodeAt(1)-56320)+65536},B=" style='position:relative;display:inline-block;"+
(f.all&&!f.addEventListener?"*display:inline;*zoom:1;'":"'"),V=function(a,b){a=a||"";var c=-1!==a.indexOf("++"),d=1;return c&&(a=a.split("++").join("")),function(){return"<"+b+B+(a?" class='"+a+(c?d++:"")+"'>":">")}},m=a.SplitText=c.SplitText=function(a,b){if("string"==typeof a&&(a=m.selector(a)),!a)throw"cannot split a null element.";var c;if(l(a)){c=a;var d,e,f,r=[],g=c.length;for(d=0;g>d;d++)if(e=c[d],l(e))for(f=0;f<e.length;f++)r.push(e[f]);else r.push(e);c=r}else c=[a];this.elements=c;this.chars=
[];this.words=[];this.lines=[];this._originals=[];this.vars=b||{};this.split(b)},r=function(a,b,c){var d=a.nodeType;if(1===d||9===d||11===d)for(a=a.firstChild;a;a=a.nextSibling)r(a,b,c);else 3!==d&&4!==d||(a.nodeValue=a.nodeValue.split(b).join(c))},q=function(a,b){for(var c=b.length;-1<--c;)a.push(b[c])},y=function(a){var b,c=[],d=a.length;for(b=0;b!==d;c.push(a[b++]));return c},X=function(a,b,c){for(var d;a&&a!==b;){if(d=a._next||a.nextSibling)return d.textContent.charAt(0)===c;a=a.parentNode||a._parent}return!1},
T=function(a){var b,c,d=y(a.childNodes),e=d.length;for(b=0;e>b;b++)c=d[b],c._isSplit?T(c):(b&&3===c.previousSibling.nodeType?c.previousSibling.nodeValue+=3===c.nodeType?c.nodeValue:c.firstChild.nodeValue:3!==c.nodeType&&a.insertBefore(c.firstChild,c),a.removeChild(c))},L=function(a,b,c,e){var m,g,q=y(a.childNodes),V=q.length,l="absolute"===b.position||!0===b.absolute;if(3!==a.nodeType||1<V){b.absolute=!1;for(m=0;V>m;m++)g=q[m],(3!==g.nodeType||/\S+/.test(g.nodeValue))&&(l&&3!==g.nodeType&&"inline"===
k(g,"display",null,!0)&&(g.style.display="inline-block",g.style.position="relative"),g._isSplit=!0,L(g,b,c,e));return b.absolute=l,void(a._isSplit=!0)}var X,T,B,ha,H,x,la,ma,q=b.span?"span":"div",V=-1!==(b.type||b.split||"chars,words,lines").indexOf("chars"),Y="absolute"===b.position||!0===b.absolute,l=b.wordDelimiter||" ",Y=" "!==l?"":Y?"&#173; ":" ",ca=b.span?"</span>":"</div>",ia=!0,qa=b.specialChars?"function"==typeof b.specialChars?b.specialChars:h:null;X=f.createElement("div");var pa=a.parentNode;
pa.insertBefore(X,a);X.textContent=a.nodeValue;pa.removeChild(a);a=X;X=d(a);x=-1!==X.indexOf("<");!1!==b.reduceWhiteSpace&&(X=X.replace(p," ").replace(n,""));x&&(X=X.split("<").join("{{LT}}"));ha=X.length;T=(" "===X.charAt(0)?Y:"")+c();for(B=0;ha>B;B++)if(H=X.charAt(B),qa&&(ma=qa(X.substr(B),b.specialChars)))H=X.substr(B,ma||1),T+=V&&" "!==H?e()+H+"</"+q+">":H,B+=ma-1;else if(H===l&&X.charAt(B-1)!==l&&B){T+=ia?ca:"";for(ia=!1;X.charAt(B+1)===l;)T+=Y,B++;B===ha-1?T+=Y:")"!==X.charAt(B+1)&&(T+=Y+c(),
ia=!0)}else"{"===H&&"{{LT}}"===X.substr(B,6)?(T+=V?e()+"{{LT}}</"+q+">":"{{LT}}",B+=5):55296<=H.charCodeAt(0)&&56319>=H.charCodeAt(0)||65024<=X.charCodeAt(B+1)&&65039>=X.charCodeAt(B+1)?(g=z(X.substr(B,2)),la=z(X.substr(B+2,2)),m=127462<=g&&127487>=g&&127462<=la&&127487>=la||127995<=la&&127999>=la?4:2,T+=V&&" "!==H?e()+X.substr(B,m)+"</"+q+">":X.substr(B,m),B+=m-1):T+=V&&" "!==H?e()+H+"</"+q+">":H;a.outerHTML=T+(ia?ca:"");x&&r(pa,"{{LT}}","<")},a=m.prototype;a.split=function(a){this.isSplit&&this.revert();
this.vars=a=a||this.vars;this._originals.length=this.chars.length=this.words.length=this.lines.length=0;for(var b,c,d,m=this.elements.length,g=a.span?"span":"div",y=V(a.wordsClass,g),g=V(a.charsClass,g);-1<--m;){d=this.elements[m];this._originals[m]=d.innerHTML;b=d.clientHeight;c=d.clientWidth;L(d,a,y,g);var h=a,l=this.chars,z=this.words,p=this.lines,n=void 0,B=void 0,H=void 0,x=void 0,la=void 0,ma=void 0,Y=void 0,ca=void 0,ia=void 0,qa=void 0,pa=void 0,ka=e(d),aa=k(d,"paddingLeft",ka),Y=-999,E=k(d,
"borderBottomWidth",ka)+k(d,"borderTopWidth",ka),va=k(d,"borderLeftWidth",ka)+k(d,"borderRightWidth",ka),Ca=k(d,"paddingTop",ka)+k(d,"paddingBottom",ka),Fa=k(d,"paddingLeft",ka)+k(d,"paddingRight",ka),xa=.2*k(d,"fontSize"),ka=k(d,"textAlign",ka,!0),oa=[],ba=[],t=[],w=h.wordDelimiter||" ",u=h.span?"span":"div",n=h.type||h.split||"chars,words,lines",A=p&&-1!==n.indexOf("lines")?[]:null,M=-1!==n.indexOf("words"),R=-1!==n.indexOf("chars"),N="absolute"===h.position||!0===h.absolute,S=h.linesClass,O=-1!==
(S||"").indexOf("++"),Ga=[];A&&1===d.children.length&&d.children[0]._isSplit&&(d=d.children[0]);O&&(S=S.split("++").join(""));B=d.getElementsByTagName("*");H=B.length;la=[];for(n=0;H>n;n++)la[n]=B[n];if(A||N)for(n=0;H>n;n++)x=la[n],((B=x.parentNode===d)||N||R&&!M)&&(pa=x.offsetTop,A&&B&&Math.abs(pa-Y)>xa&&("BR"!==x.nodeName||0===n)&&(ma=[],A.push(ma),Y=pa),N&&(x._x=x.offsetLeft,x._y=pa,x._w=x.offsetWidth,x._h=x.offsetHeight),A&&((x._isSplit&&B||!R&&B||M&&B||!M&&x.parentNode.parentNode===d&&!x.parentNode._isSplit)&&
(ma.push(x),x._x-=aa,X(x,d,w)&&(x._wordEnd=!0)),"BR"===x.nodeName&&(x.nextSibling&&"BR"===x.nextSibling.nodeName||0===n)&&A.push([])));for(n=0;H>n;n++)x=la[n],B=x.parentNode===d,"BR"!==x.nodeName?(N&&(ca=x.style,M||B||(x._x+=x.parentNode._x,x._y+=x.parentNode._y),ca.left=x._x+"px",ca.top=x._y+"px",ca.position="absolute",ca.display="block",ca.width=x._w+1+"px",ca.height=x._h+"px"),!M&&R?x._isSplit?(x._next=x.nextSibling,x.parentNode.appendChild(x)):x.parentNode._isSplit?(x._parent=x.parentNode,!x.previousSibling&&
x.firstChild&&(x.firstChild._isFirst=!0),x.nextSibling&&" "===x.nextSibling.textContent&&!x.nextSibling.nextSibling&&Ga.push(x.nextSibling),x._next=x.nextSibling&&x.nextSibling._isFirst?null:x.nextSibling,x.parentNode.removeChild(x),la.splice(n--,1),H--):B||(pa=!x.nextSibling&&X(x.parentNode,d,w),x.parentNode._parent&&x.parentNode._parent.appendChild(x),pa&&x.parentNode.appendChild(f.createTextNode(" ")),h.span&&(x.style.display="inline"),oa.push(x)):x.parentNode._isSplit&&!x._isSplit&&""!==x.innerHTML?
ba.push(x):R&&!x._isSplit&&(h.span&&(x.style.display="inline"),oa.push(x))):A||N?(x.parentNode&&x.parentNode.removeChild(x),la.splice(n--,1),H--):M||d.appendChild(x);for(n=Ga.length;-1<--n;)Ga[n].parentNode.removeChild(Ga[n]);if(A){N&&(ia=f.createElement(u),d.appendChild(ia),qa=ia.offsetWidth+"px",pa=ia.offsetParent===d?0:d.offsetLeft,d.removeChild(ia));ca=d.style.cssText;for(d.style.cssText="display:none;";d.firstChild;)d.removeChild(d.firstChild);Y=" "===w&&(!N||!M&&!R);for(n=0;n<A.length;n++){ma=
A[n];ia=f.createElement(u);ia.style.cssText="display:block;text-align:"+ka+";position:"+(N?"absolute;":"relative;");S&&(ia.className=S+(O?n+1:""));t.push(ia);H=ma.length;for(B=0;H>B;B++)"BR"!==ma[B].nodeName&&(x=ma[B],ia.appendChild(x),Y&&x._wordEnd&&ia.appendChild(f.createTextNode(" ")),N&&(0===B&&(ia.style.top=x._y+"px",ia.style.left=aa+pa+"px"),x.style.top="0px",pa&&(x.style.left=x._x-pa+"px")));0===H?ia.innerHTML="&nbsp;":M||R||(T(ia),r(ia,String.fromCharCode(160)," "));N&&(ia.style.width=qa,
ia.style.height=x._h+"px");d.appendChild(ia)}d.style.cssText=ca}N&&(b>d.clientHeight&&(d.style.height=b-Ca+"px",d.clientHeight<b&&(d.style.height=b+E+"px")),c>d.clientWidth&&(d.style.width=c-Fa+"px",d.clientWidth<c&&(d.style.width=c+va+"px")));q(l,oa);M&&q(z,ba);q(p,t)}return this.chars.reverse(),this.words.reverse(),this.lines.reverse(),this.isSplit=!0,this};a.revert=function(){if(!this._originals)throw"revert() call wasn't scoped properly.";for(var a=this._originals.length;-1<--a;)this.elements[a].innerHTML=
this._originals[a];return this.chars=[],this.words=[],this.lines=[],this.isSplit=!1,this};m.selector=b.$||b.jQuery||function(a){var c=b.$||b.jQuery;return c?(m.selector=c,c(a)):"undefined"==typeof document?a:document.querySelectorAll?document.querySelectorAll(a):document.getElementById("#"===a.charAt(0)?a.substr(1):a)};m.version="0.6.0"}(_gsScope);
(function(b){var c=function(){return(_gsScope.GreenSockGlobals||_gsScope)[b]};"undefined"!=typeof module&&module.exports?module.exports=c():"function"==typeof define&&define.amd&&define([],c)})("SplitText");_gsScope="undefined"!=typeof module&&module.exports&&"undefined"!=typeof global?global:this||window;
...
d=function(b,d){return""!==d&&d||!c.test(b)?b.split(d||""):b.match(a)},f=_gsScope._gsDefine.plugin({propName:"text",API:2,version:"0.6.2",init:function(a,c,f,l){var h=a.nodeName.toUpperCase();if("function"==typeof c&&(c=c(l,a)),this._svg=a.getBBox&&("TEXT"===h||"TSPAN"===h),!("innerHTML"in a||this._svg))return!1;if(this._target=a,"object"!=typeof c&&(c={value:c}),void 0===c.value)return this._text=this._original=[""],!0;this._delimiter=c.delimiter||"";this._original=d(b(a).replace(/\s+/g," "),this._delimiter);
...
this.vars.repeatDelay||0;this._repeat&&this._uncache(!0);this.render=e.prototype.render},g=a._internals,k=g.isSelector,l=g.isArray,h=e.prototype=a.to({},.1,{}),n=[];e.version="2.0.1";h.constructor=e;h.kill()._gc=!1;e.killTweensOf=e.killDelayedCallsTo=a.killTweensOf;e.getTweensOf=a.getTweensOf;e.lagSmoothing=a.lagSmoothing;e.ticker=a.ticker;e.render=a.render;h.invalidate=function(){return this._yoyo=!0===this.vars.yoyo||!!this.vars.yoyoEase,this._repeat=this.vars.repeat||0,this._repeatDelay=this.vars.repeatDelay||
0,this._yoyoEase=null,this._uncache(!0),a.prototype.invalidate.call(this)};h.updateTo=function(b,c){var d,f=this.ratio,e=this.vars.immediateRender||b.immediateRender;c&&this._startTime<this._timeline._time&&(this._startTime=this._timeline._time,this._uncache(!1),this._gc?this._enabled(!0,!1):this._timeline.insert(this,this._startTime-this._delay));for(d in b)this.vars[d]=b[d];if(this._initted||e)if(c)this._initted=!1,e&&this.render(0,!0,!0);else if(this._gc&&this._enabled(!0,!1),this._notifyPluginsOfEnabled&&
this._firstPT&&a._onPluginEvent("_onDisable",this),.998<this._time/this._duration)d=this._totalTime,this.render(0,!0,!1),this._initted=!1,this.render(d,!0,!1);else if(this._initted=!1,this._init(),0<this._time||e)for(f=1/(1-f),e=this._firstPT;e;)d=e.s+e.c,e.c*=f,e.s=d-e.c,e=e._next;return this};h.render=function(b,c,d){this._initted||0===this._duration&&this.vars.repeat&&this.invalidate();var f,e,h,k,l,z,n,p,B=this._dirty?this.totalDuration():this._totalDuration,G=this._time,Q=this._totalTime,J=this._cycle,
W=this._duration,D=this._rawPrevTime;if(b>=B-1E-7&&0<=b?(this._totalTime=B,this._cycle=this._repeat,this._yoyo&&0!==(1&this._cycle)?(this._time=0,this.ratio=this._ease._calcEnd?this._ease.getRatio(0):0):(this._time=W,this.ratio=this._ease._calcEnd?this._ease.getRatio(1):1),this._reversed||(f=!0,e="onComplete",d=d||this._timeline.autoRemoveChildren),0===W&&(this._initted||!this.vars.lazy||d)&&(this._startTime===this._timeline._duration&&(b=0),(0>D||0>=b&&-1E-7<=b||1E-10===D&&"isPause"!==this.data)&&
D!==b&&(d=!0,1E-10<D&&(e="onReverseComplete")),this._rawPrevTime=n=!c||b||D===b?b:1E-10)):1E-7>b?(this._totalTime=this._time=this._cycle=0,this.ratio=this._ease._calcEnd?this._ease.getRatio(0):0,(0!==Q||0===W&&0<D)&&(e="onReverseComplete",f=this._reversed),0>b&&(this._active=!1,0===W&&(this._initted||!this.vars.lazy||d)&&(0<=D&&(d=!0),this._rawPrevTime=n=!c||b||D===b?b:1E-10)),this._initted||(d=!0)):(this._totalTime=this._time=b,0!==this._repeat&&(h=W+this._repeatDelay,this._cycle=this._totalTime/
h>>0,0!==this._cycle&&this._cycle===this._totalTime/h&&b>=Q&&this._cycle--,this._time=this._totalTime-this._cycle*h,this._yoyo&&0!==(1&this._cycle)&&(this._time=W-this._time,p=this._yoyoEase||this.vars.yoyoEase,p&&(this._yoyoEase||(!0!==p||this._initted?this._yoyoEase=p=!0===p?this._ease:p instanceof Ease?p:Ease.map[p]:(p=this.vars.ease,this._yoyoEase=p=p?p instanceof Ease?p:"function"==typeof p?new Ease(p,this.vars.easeParams):Ease.map[p]||a.defaultEase:a.defaultEase)),this.ratio=p?1-p.getRatio((W-
this._time)/W):0)),this._time>W?this._time=W:0>this._time&&(this._time=0)),this._easeType&&!p?(k=this._time/W,l=this._easeType,z=this._easePower,(1===l||3===l&&.5<=k)&&(k=1-k),3===l&&(k*=2),1===z?k*=k:2===z?k*=k*k:3===z?k*=k*k*k:4===z&&(k*=k*k*k*k),1===l?this.ratio=1-k:2===l?this.ratio=k:.5>this._time/W?this.ratio=k/2:this.ratio=1-k/2):p||(this.ratio=this._ease.getRatio(this._time/W))),G===this._time&&!d&&J===this._cycle)return void(Q!==this._totalTime&&this._onUpdate&&(c||this._callback("onUpdate")));
if(!this._initted){if(this._init(),!this._initted||this._gc)return;if(!d&&this._firstPT&&(!1!==this.vars.lazy&&this._duration||this.vars.lazy&&!this._duration))return this._time=G,this._totalTime=Q,this._rawPrevTime=D,this._cycle=J,g.lazyTweens.push(this),void(this._lazy=[b,c]);!this._time||f||p?f&&this._ease._calcEnd&&!p&&(this.ratio=this._ease.getRatio(0===this._time?0:1)):this.ratio=this._ease.getRatio(this._time/W)}!1!==this._lazy&&(this._lazy=!1);this._active||!this._paused&&this._time!==G&&
0<=b&&(this._active=!0);0!==Q||(2===this._initted&&0<b&&this._init(),this._startAt&&(0<=b?this._startAt.render(b,!0,d):e||(e="_dummyGS")),!this.vars.onStart||0===this._totalTime&&0!==W||!c&&this._callback("onStart"));for(h=this._firstPT;h;)h.f?h.t[h.p](h.c*this.ratio+h.s):h.t[h.p]=h.c*this.ratio+h.s,h=h._next;this._onUpdate&&(0>b&&this._startAt&&this._startTime&&this._startAt.render(b,!0,d),c||(this._totalTime!==Q||e)&&this._callback("onUpdate"));this._cycle!==J&&(c||this._gc||this.vars.onRepeat&&
...
d.immediateRender=0!=d.immediateRender&&0!=c.immediateRender,new e(a,b,d)};e.staggerTo=e.allTo=function(b,c,r,g,h,z,p){g=g||0;var B,I,F,C,K=0,G=[],Q=function(){r.onComplete&&r.onComplete.apply(r.onCompleteScope||this,arguments);h.apply(p||r.callbackScope||this,z||n)},J=r.cycle,W=r.startAt&&r.startAt.cycle;l(b)||("string"==typeof b&&(b=a.selector(b)||b),k(b)&&(b=d(b)));b=b||[];0>g&&(b=d(b),b.reverse(),g*=-1);B=b.length-1;for(F=0;B>=F;F++){I={};for(C in r)I[C]=r[C];if(J&&(f(I,b,F),null!=I.duration&&
(c=I.duration,delete I.duration)),W){W=I.startAt={};for(C in r.startAt)W[C]=r.startAt[C];f(I.startAt,b,F)}I.delay=K+(I.delay||0);F===B&&h&&(I.onComplete=Q);G[F]=new e(b[F],c,I);K+=g}return G};e.staggerFrom=e.allFrom=function(a,b,c,d,f,g,h){return c.runBackwards=!0,c.immediateRender=0!=c.immediateRender,e.staggerTo(a,b,c,d,f,g,h)};e.staggerFromTo=e.allFromTo=function(a,b,c,d,f,g,h,k){return d.startAt=c,d.immediateRender=0!=d.immediateRender&&0!=c.immediateRender,e.staggerTo(a,b,d,f,g,h,k)};e.delayedCall=
function(a,b,c,d,f){return new e(b,0,{delay:a,onComplete:b,onCompleteParams:c,callbackScope:d,onReverseComplete:b,onReverseCompleteParams:c,immediateRender:!1,useFrames:f,overwrite:0})};e.set=function(a,b){return new e(a,0,b)};e.isTweening=function(b){return 0<a.getTweensOf(b,!0).length};var p=function(b,c){for(var d=[],f=0,e=b._first;e;)e instanceof a?d[f++]=e:(c&&(d[f++]=e),d=d.concat(p(e,c)),f=d.length),e=e._next;return d},z=e.getAllTweens=function(a){return p(b._rootTimeline,a).concat(p(b._rootFramesTimeline,
a))};e.killAll=function(a,b,d,f){null==b&&(b=!0);null==d&&(d=!0);var e,g,h=z(0!=f),k=h.length,l=b&&d&&f;for(g=0;k>g;g++)f=h[g],(l||f instanceof c||(e=f.target===f.vars.onComplete)&&d||b&&!e)&&(a?f.totalTime(f._reversed?0:f.totalDuration()):f._enabled(!1,!1))};e.killChildTweensOf=function(b,c){if(null!=b){var f,q,h,z=g.tweenLookup;if("string"==typeof b&&(b=a.selector(b)||b),k(b)&&(b=d(b)),l(b))for(q=b.length;-1<--q;)e.killChildTweensOf(b[q],c);else{f=[];for(h in z)for(q=z[h].target.parentNode;q;)q===
b&&(f=f.concat(z[h].tweens)),q=q.parentNode;h=f.length;for(q=0;h>q;q++)c&&f[q].totalTime(f[q].totalDuration()),f[q]._enabled(!1,!1)}}};var B=function(a,b,d,f){b=!1!==b;d=!1!==d;f=!1!==f;for(var e,g=z(f),h=b&&d&&f,k=g.length;-1<--k;)f=g[k],(h||f instanceof c||(e=f.target===f.vars.onComplete)&&d||b&&!e)&&f.paused(a)};return e.pauseAll=function(a,b,c){B(!0,a,b,c)},e.resumeAll=function(a,b,c){B(!1,a,b,c)},e.globalTimeScale=function(c){var d=b._rootTimeline,f=a.ticker.time;return arguments.length?(c=c||
...
f=a._internals,e=d._internals={},g=f.isSelector,k=f.isArray,l=f.lazyTweens,h=f.lazyRender,n=_gsScope._gsDefine.globals,p=function(a){var b,c={};for(b in a)c[b]=a[b];return c},z=function(a,b,c){var d,f,e=a.cycle;for(d in e)f=e[d],a[d]="function"==typeof f?f(c,b[c]):f[c%f.length];delete a.cycle},B=e.pauseCallback=function(){},V=function(a){var b,c=[],d=a.length;for(b=0;b!==d;c.push(a[b++]));return c},f=d.prototype=new c;return d.version="2.0.1",f.constructor=d,f.kill()._gc=f._forcingPlayhead=f._hasPause=
!1,f.to=function(b,c,d,f){var e=d.repeat&&n.TweenMax||a;return c?this.add(new e(b,c,d),f):this.set(b,d,f)},f.from=function(b,c,d,f){return this.add((d.repeat&&n.TweenMax||a).from(b,c,d),f)},f.fromTo=function(b,c,d,f,e){var g=f.repeat&&n.TweenMax||a;return c?this.add(g.fromTo(b,c,d,f),e):this.set(b,f,e)},f.staggerTo=function(b,c,f,e,h,k,l,n){n=new d({onComplete:k,onCompleteParams:l,callbackScope:n,smoothChildTiming:this.smoothChildTiming});var B=f.cycle;"string"==typeof b&&(b=a.selector(b)||b);b=b||
[];g(b)&&(b=V(b));e=e||0;0>e&&(b=V(b),b.reverse(),e*=-1);for(l=0;l<b.length;l++)k=p(f),k.startAt&&(k.startAt=p(k.startAt),k.startAt.cycle&&z(k.startAt,b,l)),B&&(z(k,b,l),null!=k.duration&&(c=k.duration,delete k.duration)),n.to(b[l],c,k,l*e);return this.add(n,h)},f.staggerFrom=function(a,b,c,d,f,e,g,h){return c.immediateRender=0!=c.immediateRender,c.runBackwards=!0,this.staggerTo(a,b,c,d,f,e,g,h)},f.staggerFromTo=function(a,b,c,d,f,e,g,h,k){return d.startAt=c,d.immediateRender=0!=d.immediateRender&&
0!=c.immediateRender,this.staggerTo(a,b,d,f,e,g,h,k)},f.call=function(b,c,d,f){return this.add(a.delayedCall(0,b,c,d),f)},f.set=function(b,c,d){return d=this._parseTimeOrLabel(d,0,!0),null==c.immediateRender&&(c.immediateRender=d===this._time&&!this._paused),this.add(new a(b,0,c),d)},d.exportRoot=function(b,c){b=b||{};null==b.smoothChildTiming&&(b.smoothChildTiming=!0);var f,e,g,h,k=new d(b),l=k._timeline;null==c&&(c=!0);l._remove(k,!0);k._startTime=0;k._rawPrevTime=k._time=k._totalTime=l._time;for(g=
l._first;g;)h=g._next,c&&g instanceof a&&g.target===g.vars.onComplete||(e=g._startTime-g._delay,0>e&&(f=1),k.add(g,e)),g=h;return l.add(k,0),f&&k.totalDuration(),k},f.add=function(f,e,g,h){var l,z,p;if("number"!=typeof e&&(e=this._parseTimeOrLabel(e,0,!0,f)),!(f instanceof b)){if(f instanceof Array||f&&f.push&&k(f)){g=g||"normal";h=h||0;l=f.length;for(z=0;l>z;z++)k(p=f[z])&&(p=new d({tweens:p})),this.add(p,e),"string"!=typeof p&&"function"!=typeof p&&("sequence"===g?e=p._startTime+p.totalDuration()/
p._timeScale:"start"===g&&(p._startTime-=p.delay())),e+=h;return this._uncache(!0)}if("string"==typeof f)return this.addLabel(f,e);if("function"!=typeof f)throw"Cannot add "+f+" into the timeline; it is not a tween, timeline, function, or string.";f=a.delayedCall(0,f)}if(c.prototype.add.call(this,f,e),f._time&&f.render((this.rawTime()-f._startTime)*f._timeScale,!1,!1),(this._gc||this._time===this._duration)&&!this._paused&&this._duration<this.duration())for(g=this,f=g.rawTime()>f._startTime;g._timeline;)f&&
g._timeline.smoothChildTiming?g.totalTime(g._totalTime,!0):g._gc&&g._enabled(!0,!1),g=g._timeline;return this},f.remove=function(a){if(a instanceof b){this._remove(a,!1);var c=a._timeline=a.vars.useFrames?b._rootFramesTimeline:b._rootTimeline;return a._startTime=(a._paused?a._pauseTime:c._time)-(a._reversed?a.totalDuration()-a._totalTime:a._totalTime)/a._timeScale,this}if(a instanceof Array||a&&a.push&&k(a)){for(c=a.length;-1<--c;)this.remove(a[c]);return this}return"string"==typeof a?this.removeLabel(a):
this.kill(null,a)},f._remove=function(a,b){c.prototype._remove.call(this,a,b);return this._last?this._time>this.duration()&&(this._time=this._duration,this._totalTime=this._totalDuration):this._time=this._totalTime=this._duration=this._totalDuration=0,this},f.append=function(a,b){return this.add(a,this._parseTimeOrLabel(null,b,!0,a))},f.insert=f.insertMultiple=function(a,b,c,d){return this.add(a,b||0,c,d)},f.appendMultiple=function(a,b,c,d){return this.add(a,this._parseTimeOrLabel(null,b,!0,a),c,
d)},f.addLabel=function(a,b){return this._labels[a]=this._parseTimeOrLabel(b),this},f.addPause=function(b,c,d,f){d=a.delayedCall(0,B,d,f||this);return d.vars.onComplete=d.vars.onReverseComplete=c,d.data="isPause",this._hasPause=!0,this.add(d,b)},f.removeLabel=function(a){return delete this._labels[a],this},f.getLabelTime=function(a){return null!=this._labels[a]?this._labels[a]:-1},f._parseTimeOrLabel=function(a,c,d,f){var e;if(f instanceof b&&f.timeline===this)this.remove(f);else if(f&&(f instanceof
Array||f.push&&k(f)))for(e=f.length;-1<--e;)f[e]instanceof b&&f[e].timeline===this&&this.remove(f[e]);if(f="number"!=typeof a||c?99999999999<this.duration()?this.recent().endTime(!1):this._duration:0,"string"==typeof c)return this._parseTimeOrLabel(c,d&&"number"==typeof a&&null==this._labels[c]?a-f:0,d);if(c=c||0,"string"!=typeof a||!isNaN(a)&&null==this._labels[a])null==a&&(a=f);else{if(e=a.indexOf("="),-1===e)return null==this._labels[a]?d?this._labels[a]=f+c:c:this._labels[a]+c;c=parseInt(a.charAt(e-
1)+"1",10)*Number(a.substr(e+1));a=1<e?this._parseTimeOrLabel(a.substr(0,e-1),0,d):f}return Number(a)+c},f.seek=function(a,b){return this.totalTime("number"==typeof a?a:this._parseTimeOrLabel(a),!1!==b)},f.stop=function(){return this.paused(!0)},f.gotoAndPlay=function(a,b){return this.play(a,b)},f.gotoAndStop=function(a,b){return this.pause(a,b)},f.render=function(a,b,c){this._gc&&this._enabled(!0,!1);var d,f,e,g,k,z,p,n=this._time,B=this._dirty?this.totalDuration():this._totalDuration,V=this._startTime,
J=this._timeScale,W=this._paused;if(n!==this._time&&(a+=this._time-n),a>=B-1E-7&&0<=a)this._totalTime=this._time=B,this._reversed||this._hasPausedChild()||(f=!0,g="onComplete",k=!!this._timeline.autoRemoveChildren,0===this._duration&&(0>=a&&-1E-7<=a||0>this._rawPrevTime||1E-10===this._rawPrevTime)&&this._rawPrevTime!==a&&this._first&&(k=!0,1E-10<this._rawPrevTime&&(g="onReverseComplete"))),this._rawPrevTime=this._duration||!b||a||this._rawPrevTime===a?a:1E-10,a=B+1E-4;else if(1E-7>a)if(this._totalTime=
this._time=0,(0!==n||0===this._duration&&1E-10!==this._rawPrevTime&&(0<this._rawPrevTime||0>a&&0<=this._rawPrevTime))&&(g="onReverseComplete",f=this._reversed),0>a)this._active=!1,this._timeline.autoRemoveChildren&&this._reversed?(k=f=!0,g="onReverseComplete"):0<=this._rawPrevTime&&this._first&&(k=!0),this._rawPrevTime=a;else{if(this._rawPrevTime=this._duration||!b||a||this._rawPrevTime===a?a:1E-10,0===a&&f)for(d=this._first;d&&0===d._startTime;)d._duration||(f=!1),d=d._next;a=0;this._initted||(k=
!0)}else{if(this._hasPause&&!this._forcingPlayhead&&!b){if(a>=n)for(d=this._first;d&&d._startTime<=a&&!z;)d._duration||"isPause"!==d.data||d.ratio||0===d._startTime&&0===this._rawPrevTime||(z=d),d=d._next;else for(d=this._last;d&&d._startTime>=a&&!z;)d._duration||"isPause"===d.data&&0<d._rawPrevTime&&(z=d),d=d._prev;z&&(this._time=a=z._startTime,this._totalTime=a+this._cycle*(this._totalDuration+this._repeatDelay))}this._totalTime=this._time=this._rawPrevTime=a}if(this._time!==n&&this._first||c||
k||z){if(this._initted||(this._initted=!0),this._active||!this._paused&&this._time!==n&&0<a&&(this._active=!0),0===n&&this.vars.onStart&&(0===this._time&&this._duration||b||this._callback("onStart")),p=this._time,p>=n)for(d=this._first;d&&(e=d._next,p===this._time&&(!this._paused||W));)(d._active||d._startTime<=p&&!d._paused&&!d._gc)&&(z===d&&this.pause(),d._reversed?d.render((d._dirty?d.totalDuration():d._totalDuration)-(a-d._startTime)*d._timeScale,b,c):d.render((a-d._startTime)*d._timeScale,b,
c)),d=e;else for(d=this._last;d&&(e=d._prev,p===this._time&&(!this._paused||W));){if(d._active||d._startTime<=n&&!d._paused&&!d._gc){if(z===d){for(z=d._prev;z&&z.endTime()>this._time;)z.render(z._reversed?z.totalDuration()-(a-z._startTime)*z._timeScale:(a-z._startTime)*z._timeScale,b,c),z=z._prev;z=null;this.pause()}d._reversed?d.render((d._dirty?d.totalDuration():d._totalDuration)-(a-d._startTime)*d._timeScale,b,c):d.render((a-d._startTime)*d._timeScale,b,c)}d=e}this._onUpdate&&(b||(l.length&&h(),
this._callback("onUpdate")));g&&(this._gc||(V===this._startTime||J!==this._timeScale)&&(0===this._time||B>=this.totalDuration())&&(f&&(l.length&&h(),this._timeline.autoRemoveChildren&&this._enabled(!1,!1),this._active=!1),!b&&this.vars[g]&&this._callback(g)))}},f._hasPausedChild=function(){for(var a=this._first;a;){if(a._paused||a instanceof d&&a._hasPausedChild())return!0;a=a._next}return!1},f.getChildren=function(b,c,d,f){f=f||-9999999999;for(var e=[],g=this._first,h=0;g;)g._startTime<f||(g instanceof
a?!1!==c&&(e[h++]=g):(!1!==d&&(e[h++]=g),!1!==b&&(e=e.concat(g.getChildren(!0,c,d)),h=e.length))),g=g._next;return e},f.getTweensOf=function(b,c){var d,f,e=this._gc,g=[],h=0;e&&this._enabled(!0,!0);d=a.getTweensOf(b);for(f=d.length;-1<--f;)(d[f].timeline===this||c&&this._contains(d[f]))&&(g[h++]=d[f]);return e&&this._enabled(!1,!0),g},f.recent=function(){return this._recent},f._contains=function(a){for(a=a.timeline;a;){if(a===this)return!0;a=a.timeline}return!1},f.shiftChildren=function(a,b,c){c=
c||0;for(var d,f=this._first,e=this._labels;f;)f._startTime>=c&&(f._startTime+=a),f=f._next;if(b)for(d in e)e[d]>=c&&(e[d]+=a);return this._uncache(!0)},f._kill=function(a,b){if(!a&&!b)return this._enabled(!1,!1);for(var c=b?this.getTweensOf(b):this.getChildren(!0,!0,!1),d=c.length,f=!1;-1<--d;)c[d]._kill(a,b)&&(f=!0);return f},f.clear=function(a){var b=this.getChildren(!1,!0,!0),c=b.length;for(this._time=this._totalTime=0;-1<--c;)b[c]._enabled(!1,!1);return!1!==a&&(this._labels={}),this._uncache(!0)},
f.invalidate=function(){for(var a=this._first;a;)a.invalidate(),a=a._next;return b.prototype.invalidate.call(this)},f._enabled=function(a,b){if(a===this._gc)for(var d=this._first;d;)d._enabled(a,!0),d=d._next;return c.prototype._enabled.call(this,a,b)},f.totalTime=function(a,c,d){this._forcingPlayhead=!0;var f=b.prototype.totalTime.apply(this,arguments);return this._forcingPlayhead=!1,f},f.duration=function(a){return arguments.length?(0!==this.duration()&&0!==a&&this.timeScale(this._duration/a),this):
(this._dirty&&this.totalDuration(),this._duration)},f.totalDuration=function(a){if(!arguments.length){if(this._dirty){var b,c,d=0;c=this._last;for(var f=999999999999;c;)b=c._prev,c._dirty&&c.totalDuration(),c._startTime>f&&this._sortChildren&&!c._paused&&!this._calculatingDuration?(this._calculatingDuration=1,this.add(c,c._startTime-c._delay),this._calculatingDuration=0):f=c._startTime,0>c._startTime&&!c._paused&&(d-=c._startTime,this._timeline.smoothChildTiming&&(this._startTime+=c._startTime/this._timeScale,
this._time-=c._startTime,this._totalTime-=c._startTime,this._rawPrevTime-=c._startTime),this.shiftChildren(-c._startTime,!1,-9999999999),f=0),c=c._startTime+c._totalDuration/c._timeScale,c>d&&(d=c),c=b;this._duration=this._totalDuration=d;this._dirty=!1}return this._totalDuration}return a&&this.totalDuration()?this.timeScale(this._totalDuration/a):this},f.paused=function(a){if(!a)for(var c=this._first,d=this._time;c;)c._startTime===d&&"isPause"===c.data&&(c._rawPrevTime=0),c=c._next;return b.prototype.paused.apply(this,
arguments)},f.usesFrames=function(){for(var a=this._timeline;a._timeline;)a=a._timeline;return a===b._rootFramesTimeline},f.rawTime=function(a){return a&&(this._paused||this._repeat&&0<this.time()&&1>this.totalProgress())?this._totalTime%(this._duration+this._repeatDelay):this._paused?this._totalTime:(this._timeline.rawTime(a)-this._startTime)*this._timeScale},d},!0);_gsScope._gsDefine("TimelineMax",["TimelineLite","TweenLite","easing.Ease"],function(b,c,a){var d=function(a){b.call(this,a);this._repeat=
this.vars.repeat||0;this._repeatDelay=this.vars.repeatDelay||0;this._cycle=0;this._yoyo=!0===this.vars.yoyo;this._dirty=!0},f=c._internals,e=f.lazyTweens,g=f.lazyRender,k=_gsScope._gsDefine.globals,l=new a(null,null,1,0);a=d.prototype=new b;return a.constructor=d,a.kill()._gc=!1,d.version="2.0.1",a.invalidate=function(){return this._yoyo=!0===this.vars.yoyo,this._repeat=this.vars.repeat||0,this._repeatDelay=this.vars.repeatDelay||0,this._uncache(!0),b.prototype.invalidate.call(this)},a.addCallback=
function(a,b,d,f){return this.add(c.delayedCall(0,a,d,f),b)},a.removeCallback=function(a,b){if(a)if(null==b)this._kill(null,a);else for(var c=this.getTweensOf(a,!1),d=c.length,f=this._parseTimeOrLabel(b);-1<--d;)c[d]._startTime===f&&c[d]._enabled(!1,!1);return this},a.removePause=function(a){return this.removeCallback(b._internals.pauseCallback,a)},a.tweenTo=function(a,b){b=b||{};var d,f,e,g={ease:l,useFrames:this.usesFrames(),immediateRender:!1,lazy:!1},m=b.repeat&&k.TweenMax||c;for(f in b)g[f]=
b[f];return g.time=this._parseTimeOrLabel(a),d=Math.abs(Number(g.time)-this._time)/this._timeScale||.001,e=new m(this,d,g),g.onStart=function(){e.target.paused(!0);e.vars.time===e.target.time()||d!==e.duration()||e.isFromTo||e.duration(Math.abs(e.vars.time-e.target.time())/e.target._timeScale).render(e.time(),!0,!0);b.onStart&&b.onStart.apply(b.onStartScope||b.callbackScope||e,b.onStartParams||[])},e},a.tweenFromTo=function(a,b,c){c=c||{};a=this._parseTimeOrLabel(a);c.startAt={onComplete:this.seek,
onCompleteParams:[a],callbackScope:this};c.immediateRender=!1!==c.immediateRender;b=this.tweenTo(b,c);return b.isFromTo=1,b.duration(Math.abs(b.vars.time-a)/this._timeScale||.001)},a.render=function(a,b,c){this._gc&&this._enabled(!0,!1);var d,f,k,m,r,l,y,X=this._time,T=this._dirty?this.totalDuration():this._totalDuration,L=this._duration,I=this._totalTime,F=this._startTime,C=this._timeScale,K=this._rawPrevTime,G=this._paused,Q=this._cycle;if(X!==this._time&&(a+=this._time-X),a>=T-1E-7&&0<=a)this._locked||
(this._totalTime=T,this._cycle=this._repeat),this._reversed||this._hasPausedChild()||(f=!0,m="onComplete",r=!!this._timeline.autoRemoveChildren,0===this._duration&&(0>=a&&-1E-7<=a||0>K||1E-10===K)&&K!==a&&this._first&&(r=!0,1E-10<K&&(m="onReverseComplete"))),this._rawPrevTime=this._duration||!b||a||this._rawPrevTime===a?a:1E-10,this._yoyo&&0!==(1&this._cycle)?this._time=a=0:(this._time=L,a=L+1E-4);else if(1E-7>a)if(this._locked||(this._totalTime=this._cycle=0),this._time=0,(0!==X||0===L&&1E-10!==
K&&(0<K||0>a&&0<=K)&&!this._locked)&&(m="onReverseComplete",f=this._reversed),0>a)this._active=!1,this._timeline.autoRemoveChildren&&this._reversed?(r=f=!0,m="onReverseComplete"):0<=K&&this._first&&(r=!0),this._rawPrevTime=a;else{if(this._rawPrevTime=L||!b||a||this._rawPrevTime===a?a:1E-10,0===a&&f)for(d=this._first;d&&0===d._startTime;)d._duration||(f=!1),d=d._next;a=0;this._initted||(r=!0)}else if(0===L&&0>K&&(r=!0),this._time=this._rawPrevTime=a,this._locked||(this._totalTime=a,0!==this._repeat&&
(d=L+this._repeatDelay,this._cycle=this._totalTime/d>>0,0!==this._cycle&&this._cycle===this._totalTime/d&&a>=I&&this._cycle--,this._time=this._totalTime-this._cycle*d,this._yoyo&&0!==(1&this._cycle)&&(this._time=L-this._time),this._time>L?(this._time=L,a=L+1E-4):0>this._time?this._time=a=0:a=this._time)),this._hasPause&&!this._forcingPlayhead&&!b){if(a=this._time,a>=X||this._repeat&&Q!==this._cycle)for(d=this._first;d&&d._startTime<=a&&!l;)d._duration||"isPause"!==d.data||d.ratio||0===d._startTime&&
0===this._rawPrevTime||(l=d),d=d._next;else for(d=this._last;d&&d._startTime>=a&&!l;)d._duration||"isPause"===d.data&&0<d._rawPrevTime&&(l=d),d=d._prev;l&&l._startTime<L&&(this._time=a=l._startTime,this._totalTime=a+this._cycle*(this._totalDuration+this._repeatDelay))}if(this._cycle!==Q&&!this._locked){d=this._yoyo&&0!==(1&Q);var J=d===(this._yoyo&&0!==(1&this._cycle)),W=this._totalTime,D=this._cycle,ea=this._rawPrevTime,Z=this._time;if((this._totalTime=Q*L,this._cycle<Q?d=!d:this._totalTime+=L,this._time=
X,this._rawPrevTime=0===L?K-1E-4:K,this._cycle=Q,this._locked=!0,X=d?0:L,this.render(X,b,0===L),b||this._gc||this.vars.onRepeat&&(this._cycle=D,this._locked=!1,this._callback("onRepeat")),X!==this._time)||(J&&(this._cycle=Q,this._locked=!0,X=d?L+1E-4:-1E-4,this.render(X,!0,!1)),this._locked=!1,this._paused&&!G))return;this._time=Z;this._totalTime=W;this._cycle=D;this._rawPrevTime=ea}if(!(this._time!==X&&this._first||c||r||l))return void(I!==this._totalTime&&this._onUpdate&&(b||this._callback("onUpdate")));
if(this._initted||(this._initted=!0),this._active||!this._paused&&this._totalTime!==I&&0<a&&(this._active=!0),0===I&&this.vars.onStart&&(0===this._totalTime&&this._totalDuration||b||this._callback("onStart")),y=this._time,y>=X)for(d=this._first;d&&(k=d._next,y===this._time&&(!this._paused||G));)(d._active||d._startTime<=this._time&&!d._paused&&!d._gc)&&(l===d&&this.pause(),d._reversed?d.render((d._dirty?d.totalDuration():d._totalDuration)-(a-d._startTime)*d._timeScale,b,c):d.render((a-d._startTime)*
d._timeScale,b,c)),d=k;else for(d=this._last;d&&(k=d._prev,y===this._time&&(!this._paused||G));){if(d._active||d._startTime<=X&&!d._paused&&!d._gc){if(l===d){for(l=d._prev;l&&l.endTime()>this._time;)l.render(l._reversed?l.totalDuration()-(a-l._startTime)*l._timeScale:(a-l._startTime)*l._timeScale,b,c),l=l._prev;l=null;this.pause()}d._reversed?d.render((d._dirty?d.totalDuration():d._totalDuration)-(a-d._startTime)*d._timeScale,b,c):d.render((a-d._startTime)*d._timeScale,b,c)}d=k}this._onUpdate&&(b||
(e.length&&g(),this._callback("onUpdate")));m&&(this._locked||this._gc||(F===this._startTime||C!==this._timeScale)&&(0===this._time||T>=this.totalDuration())&&(f&&(e.length&&g(),this._timeline.autoRemoveChildren&&this._enabled(!1,!1),this._active=!1),!b&&this.vars[m]&&this._callback(m)))},a.getActive=function(a,b,c){null==a&&(a=!0);null==b&&(b=!0);null==c&&(c=!1);var d=[];c=this.getChildren(a,b,c);var f=0,e=c.length;for(a=0;e>a;a++)b=c[a],b.isActive()&&(d[f++]=b);return d},a.getLabelAfter=function(a){a||
...
c;this.d=d;this.da=d-a;this.ca=c-a;this.ba=b-a},k=function(a,b,c,d){var f={a:a},e={},g={},k={c:d},l=(a+b)/2,h=(b+c)/2;c=(c+d)/2;b=(l+h)/2;var h=(h+c)/2,n=(h-b)/8;return f.b=l+(a-l)/4,e.b=b+n,f.c=e.a=(f.b+e.b)/2,e.c=g.a=(b+h)/2,g.b=h-n,k.b=c+(d-c)/4,g.c=k.a=(g.b+k.b)/2,[f,e,g,k]},l=function(b,e,h,l,m,r){var q,y,n,T,L={},I=[],F=r||b[0];m="string"==typeof m?","+m+",":",x,y,z,left,top,right,bottom,marginTop,marginLeft,marginRight,marginBottom,paddingLeft,paddingTop,paddingRight,paddingBottom,backgroundPosition,backgroundPosition_y,";
null==e&&(e=1);for(y in b[0])I.push(y);if(1<b.length){n=b[b.length-1];T=!0;for(q=I.length;-1<--q;)if(y=I[q],.05<Math.abs(F[y]-n[y])){T=!1;break}T&&(b=b.concat(),r&&b.unshift(r),b.push(b[1]),r=b[b.length-3])}c.length=a.length=d.length=0;for(q=I.length;-1<--q;){y=I[q];f[y]=-1!==m.indexOf(","+y+",");n=y;var F=b,C=y,K=f[y],G=r,Q=void 0,J=void 0,W=void 0,D=void 0,ea=void 0,W=void 0,Z=[];if(G)for(F=[G].concat(F),J=F.length;-1<--J;)"string"==typeof(W=F[J][C])&&"="===W.charAt(1)&&(F[J][C]=G[C]+Number(W.charAt(0)+
W.substr(2)));if(Q=F.length-2,0>Q)F=(Z[0]=new g(F[0][C],0,0,F[0][C]),Z);else{for(J=0;Q>J;J++)W=F[J][C],D=F[J+1][C],Z[J]=new g(W,0,0,D),K&&(ea=F[J+2][C],c[J]=(c[J]||0)+(D-W)*(D-W),a[J]=(a[J]||0)+(ea-D)*(ea-D));F=(Z[J]=new g(F[J][C],0,0,F[J+1][C]),Z)}L[n]=F}for(q=c.length;-1<--q;)c[q]=Math.sqrt(c[q]),a[q]=Math.sqrt(a[q]);if(!l){for(q=I.length;-1<--q;)if(f[y])for(b=L[I[q]],n=b.length-1,m=0;n>m;m++)r=b[m+1].da/a[m]+b[m].da/c[m]||0,d[m]=(d[m]||0)+r*r;for(q=d.length;-1<--q;)d[q]=Math.sqrt(d[q])}q=I.length;
for(m=h?4:1;-1<--q;){y=I[q];r=b=L[y];n=e;F=h;C=l;y=f[y];for(var na=void 0,ha=D=W=Z=ea=void 0,H=void 0,x=void 0,la=r.length-1,ma=0,Y=r[0].a,K=0;la>K;K++)J=r[ma],G=J.a,Q=J.d,na=r[ma+1].d,y?(ha=c[K],H=a[K],x=(H+ha)*n*.25/(C?.5:d[K]||.5),ea=Q-(Q-G)*(C?.5*n:0!==ha?x/ha:0),Z=Q+(na-Q)*(C?.5*n:0!==H?x/H:0),W=Q-(ea+((Z-ea)*(3*ha/(ha+H)+.5)/4||0))):(ea=Q-(Q-G)*n*.5,Z=Q+(na-Q)*n*.5,W=Q-(ea+Z)/2),ea+=W,Z+=W,J.c=na=ea,0!==K?J.b=Y:J.b=Y=J.a+.6*(J.c-J.a),J.da=Q-G,J.ca=na-G,J.ba=Y-G,F?(D=k(G,Y,na,Q),r.splice(ma,
1,D[0],D[1],D[2],D[3]),ma+=4):ma++,Y=Z;J=r[ma];J.b=Y;J.c=Y+.4*(J.d-Y);J.da=J.d-J.a;J.ca=J.c-J.a;J.ba=Y-J.a;F&&(D=k(J.a,Y,J.c,J.d),r.splice(ma,1,D[0],D[1],D[2],D[3]));T&&(b.splice(0,m),b.splice(b.length-m,m))}return L},h=_gsScope._gsDefine.plugin({propName:"bezier",priority:-1,version:"1.3.8",API:2,global:!0,init:function(a,b,c){this._target=a;b instanceof Array&&(b={values:b});this._func={};this._mod={};this._props=[];this._timeRes=null==b.timeResolution?6:parseInt(b.timeResolution,10);var d,f,e,
k,h,n=b.values||[],T={};e=n[0];this._autoRotate=(f=b.autoRotate||c.vars.orientToBezier)?f instanceof Array?f:[["x","y","rotation",!0===f?0:Number(f)||0]]:null;for(d in e)this._props.push(d);for(e=this._props.length;-1<--e;)d=this._props[e],this._overwriteProps.push(d),f=this._func[d]="function"==typeof a[d],T[d]=f?a[d.indexOf("set")||"function"!=typeof a["get"+d.substr(3)]?d:"get"+d.substr(3)]():parseFloat(a[d]),h||T[d]!==n[0][d]&&(h=T);if("cubic"!==b.type&&"quadratic"!==b.type&&"soft"!==b.type)T=
l(n,isNaN(b.curviness)?1:b.curviness,!1,"thruBasic"===b.type,b.correlate,h);else{e=n;var n=(n=b.type)||"soft",L,I,F,C,K,G,Q;b={};h="cubic"===n?3:2;var J="soft"===n,W=[];if(J&&T&&(e=[T].concat(e)),null==e||e.length<h+1)throw"invalid Bezier data";for(L in e[0])W.push(L);for(C=W.length;-1<--C;){L=W[C];b[L]=f=[];Q=0;G=e.length;for(K=0;G>K;K++)n=null==T?e[K][L]:"string"==typeof(I=e[K][L])&&"="===I.charAt(1)?T[L]+Number(I.charAt(0)+I.substr(2)):Number(I),J&&1<K&&G-1>K&&(f[Q++]=(n+f[Q-2])/2),f[Q++]=n;G=
Q-h+1;for(K=Q=0;G>K;K+=h)n=f[K],L=f[K+1],I=f[K+2],F=2===h?0:f[K+3],f[Q++]=I=3===h?new g(n,L,I,F):new g(n,(2*L+n)/3,(2*L+I)/3,I);f.length=Q}T=b}if(this._beziers=T,this._segCount=this._beziers[d].length,this._timeRes){f=this._beziers;d=this._timeRes;d=d>>0||6;T=[];L=[];e=I=0;b=d-1;h=[];n=[];for(k in f){C=f[k];K=T;G=d;var D=void 0,ea=void 0,Z=void 0,na=void 0,ha=void 0,W=1/G;for(F=C.length;-1<--F;)for(Z=C[F],ea=Z.a,Q=Z.d-ea,J=Z.c-ea,Z=Z.b-ea,ea=0,na=1;G>=na;na++)D=W*na,ha=1-D,D=ea-(ea=(D*D*Q+3*ha*(D*
J+ha*Z))*D),ha=F*G+na-1,K[ha]=(K[ha]||0)+D*D}f=T.length;for(k=0;f>k;k++)I+=Math.sqrt(T[k]),C=k%d,n[C]=I,C===b&&(e+=I,C=k/d>>0,h[C]=n,L[C]=e,I=0,n=[]);this._length=e;this._lengths=L;this._segments=h;this._l1=this._li=this._s1=this._si=0;this._l2=this._lengths[0];this._curSeg=this._segments[0];this._s2=this._curSeg[0];this._prec=1/this._curSeg.length}if(f=this._autoRotate)for(this._initialRotations=[],f[0]instanceof Array||(this._autoRotate=f=[f]),e=f.length;-1<--e;){for(k=0;3>k;k++)d=f[e][k],this._func[d]=
...
a;);0===f&&a<this._s1?this._s1=0:f++;this._s2=e[f];this._si=f}g=(f+(a-this._s1)/(this._s2-this._s1))*this._prec||0}else c=0>a?0:1<=a?g-1:g*a>>0,g*=a-1/g*c;d=1-g;for(f=this._props.length;-1<--f;)a=this._props[f],e=this._beziers[a][c],k=(g*g*e.da+3*d*(g*e.ca+d*e.ba))*g+e.a,this._mod[a]&&(k=this._mod[a](k,l)),h[a]?l[a](k):l[a]=k;if(this._autoRotate){var L,I,F,C,K,G,Q=this._autoRotate;for(f=Q.length;-1<--f;)a=Q[f][2],K=Q[f][3]||0,G=!0===Q[f][4]?1:b,e=this._beziers[Q[f][0]],d=this._beziers[Q[f][1]],e&&
d&&(e=e[c],d=d[c],L=e.a+(e.b-e.a)*g,F=e.b+(e.c-e.b)*g,L+=(F-L)*g,F+=(e.c+(e.d-e.c)*g-F)*g,I=d.a+(d.b-d.a)*g,C=d.b+(d.c-d.b)*g,I+=(C-I)*g,C+=(d.c+(d.d-d.c)*g-C)*g,k=n?Math.atan2(C-I,F-L)*G+K:this._initialRotations[f],this._mod[a]&&(k=this._mod[a](k,l)),h[a]?l[a](k):l[a]=k)}}}),n=h.prototype;h.bezierThrough=l;h.cubicToQuadratic=k;h._autoCSS=!0;h.quadraticToCubic=function(a,b,c){return new g(a,(2*b+a)/3,(2*b+c)/3,c)};h._cssRegister=function(){var a=e.CSSPlugin;if(a){var a=a._internals,b=a._parseToProxy,
c=a._setPluginRatio,d=a.CSSPropTween;a._registerComplexSpecialProp("bezier",{parser:function(a,f,e,g,k,l){f instanceof Array&&(f={values:f});l=new h;var n,p,F=f.values,C=F.length-1,K=[],G={};if(0>C)return k;for(e=0;C>=e;e++)p=b(a,F[e],g,k,l,C!==e),K[e]=p.end;for(n in f)G[n]=f[n];return G.values=K,k=new d(a,"bezier",0,0,p.pt,2),k.data=p,k.plugin=l,k.setRatio=c,0===G.autoRotate&&(G.autoRotate=!0),!G.autoRotate||G.autoRotate instanceof Array||(e=!0===G.autoRotate?0:Number(G.autoRotate),G.autoRotate=
null!=p.end.left?[["left","top","rotation",e,!1]]:null!=p.end.x?[["x","y","rotation",e,!1]]:!1),G.autoRotate&&(g._transform||g._enableTransforms(!1),p.autoRotate=g._target._gsTransform,p.proxy.rotation=p.autoRotate.rotation||0,g._overwriteProps.push("rotation")),l._onInitTween(p.proxy,G,g._tween),k}})}};n._mod=function(a){for(var b,c=this._overwriteProps,d=c.length;-1<--d;)(b=a[c[d]])&&"function"==typeof b&&(this._mod[c[d]]=b)};n._kill=function(a){var b,c,d=this._props;for(b in this._beziers)if(b in
a)for(delete this._beziers[b],delete this._func[b],c=d.length;-1<--c;)d[c]===b&&d.splice(c,1);if(d=this._autoRotate)for(c=d.length;-1<--c;)a[d[c][2]]&&d.splice(c,1);return this._super._kill.call(this,a)}})();_gsScope._gsDefine("plugins.CSSPlugin",["plugins.TweenPlugin","TweenLite"],function(b,c){var a,d,f,e,g=function(){b.call(this,"css");this._overwriteProps.length=0;this.setRatio=g.prototype.setRatio},k=_gsScope._gsDefine.globals,l={},h=g.prototype=new b("css");h.constructor=g;g.version="1.20.5";
g.API=2;g.defaultTransformPerspective=0;g.defaultSkewType="compensated";g.defaultSmoothOrigin=!0;h="px";g.suffixMap={top:h,right:h,bottom:h,left:h,width:h,height:h,fontSize:h,padding:h,margin:h,perspective:h,lineHeight:""};var n,p,z,B,V,m,r,q,y=/(?:\-|\.|\b)(\d|\.|e\-)+/g,X=/(?:\d|\-\d|\.\d|\-\.\d|\+=\d|\-=\d|\+=.\d|\-=\.\d)+/g,T=/(?:\+=|\-=|\-|\b)[\d\-\.]+[a-zA-Z0-9]*(?:%|\b)/gi,L=/(?![+-]?\d*\.?\d+|[+-]|e[+-]\d+)[^0-9]/g,I=/(?:\d|\-|\+|=|#|\.)*/g,F=/opacity *= *([^)]*)/i,C=/opacity:([^;]*)/i,K=
/alpha\(opacity *=.+?\)/i,G=/^(rgb|hsl)/,Q=/([A-Z])/g,J=/-([a-z])/gi,W=/(^(?:url\(\"|url\())|(?:(\"\))$|\)$)/gi,D=function(a,b){return b.toUpperCase()},ea=/(?:Left|Right|Width)/i,Z=/(M11|M12|M21|M22)=[\d\-\.e]+/gi,na=/progid\:DXImageTransform\.Microsoft\.Matrix\(.+?\)/i,ha=/,(?=[^\)]*(?:\(|$))/gi,H=/[\s,\(]/i,x=Math.PI/180,la=180/Math.PI,ma={},Y={style:{}},ca=_gsScope.document||{createElement:function(){return Y}},ia=function(a,b){return ca.createElementNS?ca.createElementNS(b||"http://www.w3.org/1999/xhtml",
a):ca.createElement(a)},qa=ia("div"),pa=ia("img"),ka=g._internals={_specialProps:l},aa=(_gsScope.navigator||{}).userAgent||"",E=function(){var a=aa.indexOf("Android"),b=ia("a");return z=-1!==aa.indexOf("Safari")&&-1===aa.indexOf("Chrome")&&(-1===a||3<parseFloat(aa.substr(a+8,2))),V=z&&6>parseFloat(aa.substr(aa.indexOf("Version/")+8,2)),B=-1!==aa.indexOf("Firefox"),(/MSIE ([0-9]{1,}[\.0-9]{0,})/.exec(aa)||/Trident\/.*rv:([0-9]{1,}[\.0-9]{0,})/.exec(aa))&&(m=parseFloat(RegExp.$1)),b?(b.style.cssText=
"top:1px;opacity:.55;",/^0.55/.test(b.style.opacity)):!1}(),va=function(a){return F.test("string"==typeof a?a:(a.currentStyle?a.currentStyle.filter:a.style.filter)||"")?parseFloat(RegExp.$1)/100:1},Ca="",Fa="",xa=function(a,b){b=b||qa;var c,d,f=b.style;if(void 0!==f[a])return a;a=a.charAt(0).toUpperCase()+a.substr(1);c=["O","Moz","ms","Ms","Webkit"];for(d=5;-1<--d&&void 0===f[c[d]+a];);return 0<=d?(Fa=3===d?"ms":c[d],Ca="-"+Fa.toLowerCase()+"-",Fa+a):null},oa=("undefined"!=typeof window?window:ca.defaultView||
{getComputedStyle:function(){}}).getComputedStyle,ba=g.getStyle=function(a,b,c,d,f){var e;return E||"opacity"!==b?(!d&&a.style[b]?e=a.style[b]:(c=c||oa(a))?e=c[b]||c.getPropertyValue(b)||c.getPropertyValue(b.replace(Q,"-$1").toLowerCase()):a.currentStyle&&(e=a.currentStyle[b]),null==f||e&&"none"!==e&&"auto"!==e&&"auto auto"!==e?e:f):va(a)},t=ka.convertToPixels=function(a,b,d,f,e){if("px"===f||!f&&"lineHeight"!==b)return d;if("auto"===f||!d)return 0;var k,Ia,r,h=ea.test(b),l=a;k=qa.style;var w=0>d,
u=1===d;if(w&&(d=-d),u&&(d*=100),"lineHeight"!==b||f)if("%"===f&&-1!==b.indexOf("border"))k=d/100*(h?a.clientWidth:a.clientHeight);else{if(k.cssText="border:0 solid red;position:"+ba(a,"position")+";line-height:0;","%"!==f&&l.appendChild&&"v"!==f.charAt(0)&&"rem"!==f)k[h?"borderLeftWidth":"borderTopWidth"]=d+f;else{if(l=a.parentNode||ca.body,-1!==ba(l,"display").indexOf("flex")&&(k.position="absolute"),Ia=l._gsCache,r=c.ticker.frame,Ia&&h&&Ia.time===r)return Ia.width*d/100;k[h?"width":"height"]=d+
f}l.appendChild(qa);k=parseFloat(qa[h?"offsetWidth":"offsetHeight"]);l.removeChild(qa);h&&"%"===f&&!1!==g.cacheWidths&&(Ia=l._gsCache=l._gsCache||{},Ia.time=r,Ia.width=k/d*100);0!==k||e||(k=t(a,b,d,f,!0))}else Ia=oa(a).lineHeight,a.style.lineHeight=d,k=parseFloat(oa(a).lineHeight),a.style.lineHeight=Ia;return u&&(k/=100),w?-k:k},w=ka.calculateOffset=function(a,b,c){if("absolute"!==ba(a,"position",c))return 0;var d="left"===b?"Left":"Top";c=ba(a,"margin"+d,c);return a["offset"+d]-(t(a,b,parseFloat(c),
c.replace(I,""))||0)},u=function(a,b){var c,d,f,e={};if(b=b||oa(a,null))if(c=b.length)for(;-1<--c;)f=b[c],-1!==f.indexOf("-transform")&&mb!==f||(e[f.replace(J,D)]=b.getPropertyValue(f));else for(c in b)-1!==c.indexOf("Transform")&&wa!==c||(e[c]=b[c]);else if(b=a.currentStyle||a.style)for(c in b)"string"==typeof c&&void 0===e[c]&&(e[c.replace(J,D)]=b[c]);return E||(e.opacity=va(a)),d=Ja(a,b,!1),e.rotation=d.rotation,e.skewX=d.skewX,e.scaleX=d.scaleX,e.scaleY=d.scaleY,e.x=d.x,e.y=d.y,Aa&&(e.z=d.z,e.rotationX=
d.rotationX,e.rotationY=d.rotationY,e.scaleZ=d.scaleZ),e.filters&&delete e.filters,e},A=function(a,b,c,d,f){var e,g,t,k={},r=a.style;for(g in c)"cssText"!==g&&"length"!==g&&isNaN(g)&&(b[g]!==(e=c[g])||f&&f[g])&&-1===g.indexOf("Origin")&&("number"==typeof e||"string"==typeof e)&&(k[g]="auto"!==e||"left"!==g&&"top"!==g?""!==e&&"auto"!==e&&"none"!==e||"string"!=typeof b[g]||""===b[g].replace(L,"")?e:0:w(a,g),void 0!==r[g]&&(t=new ja(r,g,r[g],t)));if(d)for(g in d)"className"!==g&&(k[g]=d[g]);return{difs:k,
firstMPT:t}},M={width:["Left","Right"],height:["Top","Bottom"]},R=["marginLeft","marginRight","marginTop","marginBottom"],N=function(a,b){if("contain"===a||"auto"===a||"auto auto"===a)return a+" ";null!=a&&""!==a||(a="0 0");var c,d=a.split(" ");c=-1!==a.indexOf("left")?"0%":-1!==a.indexOf("right")?"100%":d[0];var f=-1!==a.indexOf("top")?"0%":-1!==a.indexOf("bottom")?"100%":d[1];if(3<d.length&&!b){d=a.split(", ").join(",").split(",");a=[];for(c=0;c<d.length;c++)a.push(N(d[c]));return a.join(",")}return null==
f?f="center"===c?"50%":"0":"center"===f&&(f="50%"),("center"===c||isNaN(parseFloat(c))&&-1===(c+"").indexOf("="))&&(c="50%"),a=c+" "+f+(2<d.length?" "+d[2]:""),b&&(b.oxp=-1!==c.indexOf("%"),b.oyp=-1!==f.indexOf("%"),b.oxr="="===c.charAt(1),b.oyr="="===f.charAt(1),b.ox=parseFloat(c.replace(L,"")),b.oy=parseFloat(f.replace(L,"")),b.v=a),b||a},S=function(a,b){return"function"==typeof a&&(a=a(q,r)),"string"==typeof a&&"="===a.charAt(1)?parseInt(a.charAt(0)+"1",10)*parseFloat(a.substr(2)):parseFloat(a)-
parseFloat(b)||0},O=function(a,b){return"function"==typeof a&&(a=a(q,r)),null==a?b:"string"==typeof a&&"="===a.charAt(1)?parseInt(a.charAt(0)+"1",10)*parseFloat(a.substr(2))+b:parseFloat(a)||0},Ga=function(a,b,c,d){var f,e,g,t;return"function"==typeof a&&(a=a(q,r)),null==a?g=b:"number"==typeof a?g=a:(f=a.split("_"),t="="===a.charAt(1),e=(t?parseInt(a.charAt(0)+"1",10)*parseFloat(f[0].substr(2)):parseFloat(f[0]))*(-1===a.indexOf("rad")?1:la)-(t?0:b),f.length&&(d&&(d[c]=b+e),-1!==a.indexOf("short")&&
(e%=360,e!==e%180&&(e=0>e?e+360:e-360)),-1!==a.indexOf("_cw")&&0>e?e=(e+3599999999640)%360-360*(e/360|0):-1!==a.indexOf("ccw")&&0<e&&(e=(e-3599999999640)%360-360*(e/360|0))),g=b+e),1E-6>g&&-1E-6<g&&(g=0),g},ua={aqua:[0,255,255],lime:[0,255,0],silver:[192,192,192],black:[0,0,0],maroon:[128,0,0],teal:[0,128,128],blue:[0,0,255],navy:[0,0,128],white:[255,255,255],fuchsia:[255,0,255],olive:[128,128,0],yellow:[255,255,0],orange:[255,165,0],gray:[128,128,128],purple:[128,0,128],green:[0,128,0],red:[255,
0,0],pink:[255,192,203],cyan:[0,255,255],transparent:[255,255,255,0]},La=function(a,b,c){return a=0>a?a+1:1<a?a-1:a,255*(1>6*a?b+(c-b)*a*6:.5>a?c:2>3*a?b+(c-b)*(2/3-a)*6:b)+.5|0},Ba=g.parseColor=function(a,b){var c,d,f,e,g,t,k,r,h,l,w;if(a)if("number"==typeof a)c=[a>>16,a>>8&255,255&a];else{if(","===a.charAt(a.length-1)&&(a=a.substr(0,a.length-1)),ua[a])c=ua[a];else if("#"===a.charAt(0))4===a.length&&(d=a.charAt(1),f=a.charAt(2),e=a.charAt(3),a="#"+d+d+f+f+e+e),a=parseInt(a.substr(1),16),c=[a>>16,
a>>8&255,255&a];else if("hsl"===a.substr(0,3))if(c=w=a.match(y),b){if(-1!==a.indexOf("="))return a.match(X)}else g=Number(c[0])%360/360,t=Number(c[1])/100,k=Number(c[2])/100,f=.5>=k?k*(t+1):k+t-k*t,d=2*k-f,3<c.length&&(c[3]=Number(c[3])),c[0]=La(g+1/3,d,f),c[1]=La(g,d,f),c[2]=La(g-1/3,d,f);else c=a.match(y)||ua.transparent;c[0]=Number(c[0]);c[1]=Number(c[1]);c[2]=Number(c[2]);3<c.length&&(c[3]=Number(c[3]))}else c=ua.black;return b&&!w&&(d=c[0]/255,f=c[1]/255,e=c[2]/255,r=Math.max(d,f,e),h=Math.min(d,
f,e),k=(r+h)/2,r===h?g=t=0:(l=r-h,t=.5<k?l/(2-r-h):l/(r+h),g=r===d?(f-e)/l+(e>f?6:0):r===f?(e-d)/l+2:(d-f)/l+4,g*=60),c[0]=g+.5|0,c[1]=100*t+.5|0,c[2]=100*k+.5|0),c},Ta=function(a,b){var c,d,f,e=a.match(v)||[],g=0,t="";if(!e.length)return a;for(c=0;c<e.length;c++)d=e[c],f=a.substr(g,a.indexOf(d,g)-g),g+=f.length+d.length,d=Ba(d,b),3===d.length&&d.push(1),t+=f+(b?"hsla("+d[0]+","+d[1]+"%,"+d[2]+"%,"+d[3]:"rgba("+d.join(","))+")";return t+a.substr(g)},v="(?:\\b(?:(?:rgb|rgba|hsl|hsla)\\(.+?\\))|\\B#(?:[0-9a-f]{3}){1,2}\\b";
for(h in ua)v+="|"+h+"\\b";v=new RegExp(v+")","gi");g.colorStringFilter=function(a){var b,c=a[0]+" "+a[1];v.test(c)&&(b=-1!==c.indexOf("hsl(")||-1!==c.indexOf("hsla("),a[0]=Ta(a[0],b),a[1]=Ta(a[1],b));v.lastIndex=0};c.defaultStringFilter||(c.defaultStringFilter=g.colorStringFilter);var U=function(a,b,c,d){if(null==a)return function(a){return a};var f,e=b?(a.match(v)||[""])[0]:"",g=a.split(e).join("").match(T)||[],t=a.substr(0,a.indexOf(g[0])),k=")"===a.charAt(a.length-1)?")":"",r=-1!==a.indexOf(" ")?
" ":",",h=g.length,l=0<h?g[0].replace(y,""):"";return h?f=b?function(a){var b,Xa,Ka;if("number"==typeof a)a+=l;else if(d&&ha.test(a)){a=a.replace(ha,"|").split("|");for(Ka=0;Ka<a.length;Ka++)a[Ka]=f(a[Ka]);return a.join(",")}if(b=(a.match(v)||[e])[0],Xa=a.split(b).join("").match(T)||[],Ka=Xa.length,h>Ka--)for(;++Ka<h;)Xa[Ka]=c?Xa[(Ka-1)/2|0]:g[Ka];return t+Xa.join(r)+r+b+k+(-1!==a.indexOf("inset")?" inset":"")}:function(a){var b,e;if("number"==typeof a)a+=l;else if(d&&ha.test(a)){a=a.replace(ha,"|").split("|");
for(e=0;e<a.length;e++)a[e]=f(a[e]);return a.join(",")}if(b=a.match(T)||[],e=b.length,h>e--)for(;++e<h;)b[e]=c?b[(e-1)/2|0]:g[e];return t+b.join(r)+k}:function(a){return a}},Sa=function(a){return a=a.split(","),function(b,c,d,f,e,g,t){d=(c+"").split(" ");t={};for(c=0;4>c;c++)t[a[c]]=d[c]=d[c]||d[(c-1)/2>>0];return f.parse(b,t,e,g)}},ja=(ka._setPluginRatio=function(a){this.plugin.setRatio(a);var b,c,d;d=this.data;for(var f=d.proxy,e=d.firstMPT;e;)b=f[e.v],e.r?b=e.r(b):1E-6>b&&-1E-6<b&&(b=0),e.t[e.p]=
b,e=e._next;if(d.autoRotate&&(d.autoRotate.rotation=d.mod?d.mod.call(this._tween,f.rotation,this.t,this._tween):f.rotation),1===a||0===a)for(e=d.firstMPT,d=1===a?"e":"b";e;){if(c=e.t,c.type){if(1===c.type){b=c.xs0+c.s+c.xs1;for(a=1;a<c.l;a++)b+=c["xn"+a]+c["xs"+(a+1)];c[d]=b}}else c[d]=c.s+c.xs0;e=e._next}},function(a,b,c,d,f){this.t=a;this.p=b;this.v=c;this.r=f;d&&(d._prev=this,this._next=d)}),ya=(ka._parseToProxy=function(a,b,c,d,f,e){var g,t,k,r=d,h={},l={};t=c._transform;var w=ma;c._transform=
null;ma=b;d=a=c.parse(a,b,d,f);ma=w;for(e&&(c._transform=t,r&&(r._prev=null,r._prev&&(r._prev._next=null)));d&&d!==r;){if(1>=d.type&&(g=d.p,l[g]=d.s+d.c,h[g]=d.s,e||(k=new ja(d,"s",g,k,d.r),d.c=0),1===d.type))for(c=d.l;0<--c;)t="xn"+c,g=d.p+"_"+t,l[g]=d.data[t],h[g]=d[t],e||(k=new ja(d,t,g,k,d.rxp[t]));d=d._next}return{proxy:h,end:l,firstMPT:k,pt:a}},ka.CSSPropTween=function(b,c,d,f,g,t,k,r,h,l,w){this.t=b;this.p=c;this.s=d;this.c=f;this.n=k||c;b instanceof ya||e.push(this.n);this.r=r?"function"==
typeof r?r:Math.round:r;this.type=t||0;h&&(this.pr=h,a=!0);this.b=void 0===l?d:l;this.e=void 0===w?d+f:w;g&&(this._next=g,g._prev=this)}),Ua=function(a,b,c,d,f,e){a=new ya(a,b,c,d-c,f,-1,e);return a.b=c,a.e=a.xs0=d,a},gb=g.parseComplex=function(a,b,c,d,f,e,t,k,h,l){c=c||e||"";"function"==typeof d&&(d=d(q,r));t=new ya(a,b,0,0,t,l?2:1,null,!1,k,c,d);d+="";f&&v.test(d+c)&&(d=[c,d],g.colorStringFilter(d),c=d[0],d=d[1]);var w,u,A,m,U;a=c.split(", ").join(",").split(" ");b=d.split(", ").join(",").split(" ");
k=a.length;var M=!1!==n;(-1!==d.indexOf(",")||-1!==c.indexOf(","))&&(-1!==(d+c).indexOf("rgb")||-1!==(d+c).indexOf("hsl")?(a=a.join(" ").replace(ha,", ").split(" "),b=b.join(" ").replace(ha,", ").split(" ")):(a=a.join(" ").split(",").join(", ").split(" "),b=b.join(" ").split(",").join(", ").split(" ")),k=a.length);k!==b.length&&(a=(e||"").split(" "),k=a.length);t.plugin=h;t.setRatio=l;for(c=v.lastIndex=0;k>c;c++)if(u=a[c],h=b[c]+"",m=parseFloat(u),m||0===m)t.appendXtra("",m,S(h,m),h.replace(X,""),
M&&-1!==h.indexOf("px")?Math.round:!1,!0);else if(f&&v.test(u))w=h.indexOf(")")+1,w=")"+(w?h.substr(w):""),U=-1!==h.indexOf("hsl")&&E,e=h,u=Ba(u,U),h=Ba(h,U),(l=6<u.length+h.length)&&!E&&0===h[3]?(t["xs"+t.l]+=t.l?" transparent":"transparent",t.e=t.e.split(b[c]).join("transparent")):(E||(l=!1),U?t.appendXtra(e.substr(0,e.indexOf("hsl"))+(l?"hsla(":"hsl("),u[0],S(h[0],u[0]),",",!1,!0).appendXtra("",u[1],S(h[1],u[1]),"%,",!1).appendXtra("",u[2],S(h[2],u[2]),l?"%,":"%"+w,!1):t.appendXtra(e.substr(0,
e.indexOf("rgb"))+(l?"rgba(":"rgb("),u[0],h[0]-u[0],",",Math.round,!0).appendXtra("",u[1],h[1]-u[1],",",Math.round).appendXtra("",u[2],h[2]-u[2],l?",":w,Math.round),l&&(u=4>u.length?1:u[3],t.appendXtra("",u,(4>h.length?1:h[3])-u,w,!1))),v.lastIndex=0;else if(l=u.match(y)){if(A=h.match(X),!A||A.length!==l.length)return t;for(h=w=0;h<l.length;h++)U=l[h],e=u.indexOf(U,w),t.appendXtra(u.substr(w,e-w),Number(U),S(A[h],U),"",M&&"px"===u.substr(e+U.length,2)?Math.round:!1,0===h),w=e+U.length;t["xs"+t.l]+=
u.substr(w)}else t["xs"+t.l]+=t.l||t["xs"+t.l]?" "+h:h;if(-1!==d.indexOf("=")&&t.data){w=t.xs0+t.data.s;for(c=1;c<t.l;c++)w+=t["xs"+c]+t.data["xn"+c];t.e=w+t["xs"+c]}return t.l||(t.type=-1,t.xs0=t.e),t.xfirst||t},za=9,h=ya.prototype;for(h.l=h.pr=0;0<--za;)h["xn"+za]=0,h["xs"+za]="";h.xs0="";h._next=h._prev=h.xfirst=h.data=h.plugin=h.setRatio=h.rxp=null;h.appendXtra=function(a,b,c,d,f,e){var g=this.l;return this["xs"+g]+=e&&(g||this["xs"+g])?" "+a:a||"",c||0===g||this.plugin?(this.l++,this.type=this.setRatio?
2:1,this["xs"+this.l]=d||"",0<g?(this.data["xn"+g]=b+c,this.rxp["xn"+g]=f,this["xn"+g]=b,this.plugin||(this.xfirst=new ya(this,"xn"+g,b,c,this.xfirst||this,0,this.n,f,this.pr),this.xfirst.xs0=0),this):(this.data={s:b+c},this.rxp={},this.s=b,this.c=c,this.r=f,this)):(this["xs"+g]+=b+(d||""),this)};var Da=function(a,b){b=b||{};this.p=b.prefix?xa(a)||a:a;l[a]=l[this.p]=this;this.format=b.formatter||U(b.defaultValue,b.color,b.collapsible,b.multi);b.parser&&(this.parse=b.parser);this.clrs=b.color;this.multi=
b.multi;this.keyword=b.keyword;this.dflt=b.defaultValue;this.pr=b.priority||0},ra=ka._registerComplexSpecialProp=function(a,b,c){"object"!=typeof b&&(b={parser:c});var d=a.split(","),f=b.defaultValue;c=c||[f];for(a=0;a<d.length;a++)b.prefix=0===a&&b.prefix,b.defaultValue=c[a]||f,new Da(d[a],b)},xb=ka._registerPluginProp=function(a){if(!l[a]){var b=a.charAt(0).toUpperCase()+a.substr(1)+"Plugin";ra(a,{parser:function(a,c,d,f,e,g,t){var h=k.com.greensock.plugins[b];h?a=(h._cssRegister(),l[d].parse(a,
c,d,f,e,g,t)):(_gsScope.console&&console.log("Error: "+b+" js file not loaded."),a=e);return a}})}},h=Da.prototype;h.parseComplex=function(a,b,c,d,f,e){var g,t,k,h,r,l,u=this.keyword;if(this.multi&&(ha.test(c)||ha.test(b)?(t=b.replace(ha,"|").split("|"),k=c.replace(ha,"|").split("|")):u&&(t=[b],k=[c])),k){h=k.length>t.length?k.length:t.length;for(g=0;h>g;g++)b=t[g]=t[g]||this.dflt,c=k[g]=k[g]||this.dflt,u&&(r=b.indexOf(u),l=c.indexOf(u),r!==l&&(-1===l?t[g]=t[g].split(u).join(""):-1===r&&(t[g]+=" "+
u)));b=t.join(", ");c=k.join(", ")}return gb(a,this.p,b,c,this.clrs,this.dflt,d,this.pr,f,e)};h.parse=function(a,b,c,d,e,g,t){return this.parseComplex(a.style,this.format(ba(a,this.p,f,!1,this.dflt)),this.format(b),e,g)};g.registerSpecialProp=function(a,b,c){ra(a,{parser:function(a,d,f,e,g,t,k){g=new ya(a,f,0,0,g,2,f,!1,c);return g.plugin=t,g.setRatio=b(a,d,e._tween,f),g},priority:c})};g.useSVGTransformAttr=!0;var Va,Ha="scaleX scaleY scaleZ x y z skewX skewY rotation rotationX rotationY perspective xPercent yPercent".split(" "),
wa=xa("transform"),mb=Ca+"transform",Ma=xa("transformOrigin"),Aa=null!==xa("perspective"),hb=ka.Transform=function(){this.perspective=parseFloat(g.defaultTransformPerspective)||0;this.force3D=!1!==g.defaultForce3D&&Aa?g.defaultForce3D||"auto":!1},ab=_gsScope.SVGElement,jb=function(a,b,c){var d;a=ca.createElementNS("http://www.w3.org/2000/svg",a);var f=/([a-z])([A-Z])/g;for(d in c)a.setAttributeNS(null,d.replace(f,"$1-$2").toLowerCase(),c[d]);return b.appendChild(a),a},bb=ca.documentElement||{},sb=
function(){var a,b,c,d=m||/Android/i.test(aa)&&!_gsScope.chrome;return ca.createElementNS&&!d&&(a=jb("svg",bb),b=jb("rect",a,{width:100,height:50,x:100}),c=b.getBoundingClientRect().width,b.style[Ma]="50% 50%",b.style[wa]="scaleX(0.5)",d=c===b.getBoundingClientRect().width&&!(B&&Aa),bb.removeChild(a)),d}(),db=function(a,b,c,d,f,e){var t,k,h,r,l,u,w,v,A,m,q,U,n,M=a._gsTransform,R=Na(a,!0);M&&(U=M.xOrigin,n=M.yOrigin);(!d||2>(t=d.split(" ")).length)&&(u=a.getBBox(),0===u.x&&0===u.y&&0===u.width+u.height&&
(u={x:parseFloat(a.hasAttribute("x")?a.getAttribute("x"):a.hasAttribute("cx")?a.getAttribute("cx"):0)||0,y:parseFloat(a.hasAttribute("y")?a.getAttribute("y"):a.hasAttribute("cy")?a.getAttribute("cy"):0)||0,width:0,height:0}),b=N(b).split(" "),t=[(-1!==b[0].indexOf("%")?parseFloat(b[0])/100*u.width:parseFloat(b[0]))+u.x,(-1!==b[1].indexOf("%")?parseFloat(b[1])/100*u.height:parseFloat(b[1]))+u.y]);c.xOrigin=b=parseFloat(t[0]);c.yOrigin=r=parseFloat(t[1]);d&&R!==kb&&(l=R[0],u=R[1],w=R[2],v=R[3],A=R[4],
m=R[5],q=l*v-u*w,q&&(k=v/q*b+-w/q*r+(w*m-v*A)/q,h=-u/q*b+l/q*r-(l*m-u*A)/q,b=c.xOrigin=t[0]=k,r=c.yOrigin=t[1]=h));M&&(e&&(c.xOffset=M.xOffset,c.yOffset=M.yOffset,M=c),f||!1!==f&&!1!==g.defaultSmoothOrigin?(k=b-U,h=r-n,M.xOffset+=k*R[0]+h*R[2]-k,M.yOffset+=k*R[1]+h*R[3]-h):M.xOffset=M.yOffset=0);e||a.setAttribute("data-svg-origin",t.join(" "))},ob=function(a){var b,c=ia("svg",this.ownerSVGElement&&this.ownerSVGElement.getAttribute("xmlns")||"http://www.w3.org/2000/svg"),d=this.parentNode,f=this.nextSibling,
e=this.style.cssText;if(bb.appendChild(c),c.appendChild(this),this.style.display="block",a)try{b=this.getBBox(),this._originalGetBBox=this.getBBox,this.getBBox=ob}catch(g){}else this._originalGetBBox&&(b=this._originalGetBBox());return f?d.insertBefore(this,f):d.appendChild(this),bb.removeChild(c),this.style.cssText=e,b},pb=function(a){var b;if(!(b=!ab||!a.getCTM||a.parentNode&&!a.ownerSVGElement)){var c;try{c=a.getBBox()}catch(d){c=ob.call(a,!0)}b=!c}return!b},kb=[1,0,0,1,0,0],Na=function(a,b){var c,
d,f,e,g,t,k=a._gsTransform||new hb,h=a.style;if(wa?d=ba(a,mb,null,!0):a.currentStyle&&(d=a.currentStyle.filter.match(Z),d=d&&4===d.length?[d[0].substr(4),Number(d[2].substr(4)),Number(d[1].substr(4)),d[3].substr(4),k.x||0,k.y||0].join():""),c=!d||"none"===d||"matrix(1, 0, 0, 1, 0, 0)"===d,!wa||!(t=!oa(a)||"none"===oa(a).display)&&a.parentNode||(t&&(e=h.display,h.display="block"),a.parentNode||(g=1,bb.appendChild(a)),d=ba(a,mb,null,!0),c=!d||"none"===d||"matrix(1, 0, 0, 1, 0, 0)"===d,e?h.display=e:
t&&Ea(h,"display"),g&&bb.removeChild(a)),(k.svg||a.getCTM&&pb(a))&&(c&&-1!==(h[wa]+"").indexOf("matrix")&&(d=h[wa],c=0),f=a.getAttribute("transform"),c&&f&&(f=a.transform.baseVal.consolidate().matrix,d="matrix("+f.a+","+f.b+","+f.c+","+f.d+","+f.e+","+f.f+")",c=0)),c)return kb;f=(d||"").match(y)||[];for(za=f.length;-1<--za;)e=Number(f[za]),f[za]=(g=e-(e|=0))?(1E5*g+(0>g?-.5:.5)|0)/1E5+e:e;return b&&6<f.length?[f[0],f[1],f[4],f[5],f[12],f[13]]:f},Ja=ka.getTransform=function(a,b,d,f){if(a._gsTransform&&
d&&!f)return a._gsTransform;var e,t,k,h=d?a._gsTransform||new hb:new hb,r=0>h.scaleX,l=Aa?parseFloat(ba(a,Ma,b,!1,"0 0 0").split(" ")[2])||h.zOrigin||0:0,u=parseFloat(g.defaultTransformPerspective)||0;if(h.svg=!(!a.getCTM||!pb(a)),h.svg&&(db(a,ba(a,Ma,b,!1,"50% 50%")+"",h,a.getAttribute("data-svg-origin")),Va=g.useSVGTransformAttr||sb),e=Na(a),e!==kb){if(16===e.length){var w,v,A,m,u=e[0];b=e[1];f=e[2];var q=e[3],U=e[4],n=e[5],M=e[6],R=e[7],N=e[8],S=e[9],y=e[10],O=e[12],ja=e[13],x=e[14],p=e[11],da=
Math.atan2(M,y);h.zOrigin&&(x=-h.zOrigin,O=N*x-e[12],ja=S*x-e[13],x=y*x+h.zOrigin-e[14]);h.rotationX=da*la;da&&(m=Math.cos(-da),k=Math.sin(-da),w=U*m+N*k,v=n*m+S*k,A=M*m+y*k,N=U*-k+N*m,S=n*-k+S*m,y=M*-k+y*m,p=R*-k+p*m,U=w,n=v,M=A);da=Math.atan2(-f,y);h.rotationY=da*la;da&&(m=Math.cos(-da),k=Math.sin(-da),w=u*m-N*k,v=b*m-S*k,A=f*m-y*k,S=b*k+S*m,y=f*k+y*m,p=q*k+p*m,u=w,b=v,f=A);da=Math.atan2(b,u);h.rotation=da*la;da&&(m=Math.cos(da),k=Math.sin(da),w=u*m+b*k,v=U*m+n*k,A=N*m+S*k,b=b*m-u*k,n=n*m-U*k,S=
S*m-N*k,u=w,U=v,N=A);h.rotationX&&359.9<Math.abs(h.rotationX)+Math.abs(h.rotation)&&(h.rotationX=h.rotation=0,h.rotationY=180-h.rotationY);da=Math.atan2(U,n);h.scaleX=(1E5*Math.sqrt(u*u+b*b+f*f)+.5|0)/1E5;h.scaleY=(1E5*Math.sqrt(n*n+M*M)+.5|0)/1E5;h.scaleZ=(1E5*Math.sqrt(N*N+S*S+y*y)+.5|0)/1E5;u/=h.scaleX;U/=h.scaleY;b/=h.scaleX;n/=h.scaleY;2E-5<Math.abs(da)?(h.skewX=da*la,U=0,"simple"!==h.skewType&&(h.scaleY*=1/Math.cos(da))):h.skewX=0;h.perspective=p?1/(0>p?-p:p):0;h.x=O;h.y=ja;h.z=x;h.svg&&(h.x-=
h.xOrigin-(h.xOrigin*u-h.yOrigin*U),h.y-=h.yOrigin-(h.yOrigin*b-h.xOrigin*n))}else Aa&&!f&&e.length&&h.x===e[4]&&h.y===e[5]&&(h.rotationX||h.rotationY)||(w=(m=6<=e.length)?e[0]:1,v=e[1]||0,A=e[2]||0,m=m?e[3]:1,h.x=e[4]||0,h.y=e[5]||0,e=Math.sqrt(w*w+v*v),k=Math.sqrt(m*m+A*A),b=w||v?Math.atan2(v,w)*la:h.rotation||0,f=A||m?Math.atan2(A,m)*la+b:h.skewX||0,h.scaleX=e,h.scaleY=k,h.rotation=b,h.skewX=f,Aa&&(h.rotationX=h.rotationY=h.z=0,h.perspective=u,h.scaleZ=1),h.svg&&(h.x-=h.xOrigin-(h.xOrigin*w+h.yOrigin*
A),h.y-=h.yOrigin-(h.xOrigin*v+h.yOrigin*m)));90<Math.abs(h.skewX)&&270>Math.abs(h.skewX)&&(r?(h.scaleX*=-1,h.skewX+=0>=h.rotation?180:-180,h.rotation+=0>=h.rotation?180:-180):(h.scaleY*=-1,h.skewX+=0>=h.skewX?180:-180));h.zOrigin=l;for(t in h)2E-5>h[t]&&-2E-5<h[t]&&(h[t]=0)}return d&&(a._gsTransform=h,h.svg&&(Va&&a.style[wa]?c.delayedCall(.001,function(){Ea(a.style,wa)}):!Va&&a.getAttribute("transform")&&c.delayedCall(.001,function(){a.removeAttribute("transform")}))),h},eb=function(a){var b,c,d=
this.data,f=-d.rotation*x,e=f+d.skewX*x,g=(Math.cos(f)*d.scaleX*1E5|0)/1E5,h=(Math.sin(f)*d.scaleX*1E5|0)/1E5,k=(Math.sin(e)*-d.scaleY*1E5|0)/1E5,r=(Math.cos(e)*d.scaleY*1E5|0)/1E5,e=this.t.style;if(f=this.t.currentStyle){c=h;h=-k;k=-c;b=f.filter;e.filter="";var l,u;c=this.t.offsetWidth;var w=this.t.offsetHeight,v="absolute"!==f.position,A="progid:DXImageTransform.Microsoft.Matrix(M11="+g+", M12="+h+", M21="+k+", M22="+r,U=d.x+c*d.xPercent/100,q=d.y+w*d.yPercent/100;if(null!=d.ox&&(l=(d.oxp?c*d.ox*
.01:d.ox)-c/2,u=(d.oyp?w*d.oy*.01:d.oy)-w/2,U+=l-(l*g+u*h),q+=u-(l*k+u*r)),v?(l=c/2,u=w/2,A+=", Dx="+(l-(l*g+u*h)+U)+", Dy="+(u-(l*k+u*r)+q)+")"):A+=", sizingMethod='auto expand')",-1!==b.indexOf("DXImageTransform.Microsoft.Matrix(")?e.filter=b.replace(na,A):e.filter=A+" "+b,(0===a||1===a)&&1===g&&0===h&&0===k&&1===r&&(v&&-1===A.indexOf("Dx=0, Dy=0")||F.test(b)&&100!==parseFloat(RegExp.$1)||-1===b.indexOf(b.indexOf("Alpha"))&&e.removeAttribute("filter")),!v)for(a=8>m?1:-1,l=d.ieOffsetX||0,u=d.ieOffsetY||
0,d.ieOffsetX=Math.round((c-((0>g?-g:g)*c+(0>h?-h:h)*w))/2+U),d.ieOffsetY=Math.round((w-((0>r?-r:r)*w+(0>k?-k:k)*c))/2+q),za=0;4>za;za++)g=R[za],h=f[g],c=-1!==h.indexOf("px")?parseFloat(h):t(this.t,g,parseFloat(h),h.replace(I,""))||0,h=c!==d[g]?2>za?-d.ieOffsetX:-d.ieOffsetY:2>za?l-d.ieOffsetX:u-d.ieOffsetY,e[g]=(d[g]=Math.round(c-h*(0===za||2===za?1:a)))+"px"}},qb=ka.set3DTransformRatio=ka.setTransformRatio=function(a){var b,c,d,f,e,g,t,h,k,r,l,u,w,v,A,m,U,q=this.data,n=this.t.style,M=q.rotation,
N=q.rotationX,R=q.rotationY,S=q.scaleX,y=q.scaleY,O=q.scaleZ,p=q.x,da=q.y,Oa=q.z,lb=q.svg,Wa=q.perspective;t=q.force3D;h=q.skewY;k=q.skewX;if(h&&(k+=h,M+=h),!((1!==a&&0!==a||"auto"!==t||this.tween._totalTime!==this.tween._totalDuration&&this.tween._totalTime)&&t||Oa||Wa||R||N)&&1===O||Va&&lb||!Aa)return void(M||k||lb?(M*=x,g=k*x,c=Math.cos(M)*S,f=Math.sin(M)*S,d=Math.sin(M-g)*-y,e=Math.cos(M-g)*y,g&&"simple"===q.skewType&&(b=Math.tan(g-h*x),b=Math.sqrt(1+b*b),d*=b,e*=b,h&&(b=Math.tan(h*x),b=Math.sqrt(1+
b*b),c*=b,f*=b)),lb&&(p+=q.xOrigin-(q.xOrigin*c+q.yOrigin*d)+q.xOffset,da+=q.yOrigin-(q.xOrigin*f+q.yOrigin*e)+q.yOffset,Va&&(q.xPercent||q.yPercent)&&(v=this.t.getBBox(),p+=.01*q.xPercent*v.width,da+=.01*q.yPercent*v.height),v=1E-6,v>p&&p>-v&&(p=0),v>da&&da>-v&&(da=0)),w=(1E5*c|0)/1E5+","+(1E5*f|0)/1E5+","+(1E5*d|0)/1E5+","+(1E5*e|0)/1E5+","+p+","+da+")",lb&&Va?this.t.setAttribute("transform","matrix("+w):n[wa]=(q.xPercent||q.yPercent?"translate("+q.xPercent+"%,"+q.yPercent+"%) matrix(":"matrix(")+
w):n[wa]=(q.xPercent||q.yPercent?"translate("+q.xPercent+"%,"+q.yPercent+"%) matrix(":"matrix(")+S+",0,0,"+y+","+p+","+da+")");if(B&&(v=1E-4,v>S&&S>-v&&(S=O=2E-5),v>y&&y>-v&&(y=O=2E-5),!Wa||q.z||q.rotationX||q.rotationY||(Wa=0)),M||k)M*=x,A=c=Math.cos(M),m=f=Math.sin(M),k&&(M-=k*x,A=Math.cos(M),m=Math.sin(M),"simple"===q.skewType&&(b=Math.tan((k-h)*x),b=Math.sqrt(1+b*b),A*=b,m*=b,q.skewY&&(b=Math.tan(h*x),b=Math.sqrt(1+b*b),c*=b,f*=b))),d=-m,e=A;else{if(!(R||N||1!==O||Wa||lb))return void(n[wa]=(q.xPercent||
q.yPercent?"translate("+q.xPercent+"%,"+q.yPercent+"%) translate3d(":"translate3d(")+p+"px,"+da+"px,"+Oa+"px)"+(1!==S||1!==y?" scale("+S+","+y+")":""));c=e=1;d=f=0}k=1;a=g=t=h=r=l=0;u=Wa?-1/Wa:0;w=q.zOrigin;v=1E-6;(M=R*x)&&(A=Math.cos(M),m=Math.sin(M),t=-m,r=u*-m,a=c*m,g=f*m,k=A,u*=A,c*=A,f*=A);(M=N*x)&&(A=Math.cos(M),m=Math.sin(M),b=d*A+a*m,U=e*A+g*m,h=k*m,l=u*m,a=d*-m+a*A,g=e*-m+g*A,k*=A,u*=A,d=b,e=U);1!==O&&(a*=O,g*=O,k*=O,u*=O);1!==y&&(d*=y,e*=y,h*=y,l*=y);1!==S&&(c*=S,f*=S,t*=S,r*=S);(w||lb)&&
(w&&(p+=a*-w,da+=g*-w,Oa+=k*-w+w),lb&&(p+=q.xOrigin-(q.xOrigin*c+q.yOrigin*d)+q.xOffset,da+=q.yOrigin-(q.xOrigin*f+q.yOrigin*e)+q.yOffset),v>p&&p>-v&&(p="0"),v>da&&da>-v&&(da="0"),v>Oa&&Oa>-v&&(Oa=0));w=q.xPercent||q.yPercent?"translate("+q.xPercent+"%,"+q.yPercent+"%) matrix3d(":"matrix3d(";w=w+((v>c&&c>-v?"0":c)+","+(v>f&&f>-v?"0":f)+","+(v>t&&t>-v?"0":t))+(","+(v>r&&r>-v?"0":r)+","+(v>d&&d>-v?"0":d)+","+(v>e&&e>-v?"0":e));N||R||1!==O?(w+=","+(v>h&&h>-v?"0":h)+","+(v>l&&l>-v?"0":l)+","+(v>a&&a>
-v?"0":a),w+=","+(v>g&&g>-v?"0":g)+","+(v>k&&k>-v?"0":k)+","+(v>u&&u>-v?"0":u)+","):w+=",0,0,0,0,1,0,";n[wa]=w+(p+","+da+","+Oa+","+(Wa?1+-Oa/Wa:1)+")")},h=hb.prototype;h.x=h.y=h.z=h.skewX=h.skewY=h.rotation=h.rotationX=h.rotationY=h.zOrigin=h.xPercent=h.yPercent=h.xOffset=h.yOffset=0;h.scaleX=h.scaleY=h.scaleZ=1;ra("transform,scale,scaleX,scaleY,scaleZ,x,y,z,rotation,rotationX,rotationY,rotationZ,skewX,skewY,shortRotation,shortRotationX,shortRotationY,shortRotationZ,transformOrigin,svgOrigin,transformPerspective,directionalRotation,parseTransform,force3D,skewType,xPercent,yPercent,smoothOrigin",
{parser:function(a,b,c,d,e,t,h){if(d._lastParsedTransform===h)return e;d._lastParsedTransform=h;var k,l=h.scale&&"function"==typeof h.scale?h.scale:0;"function"==typeof h[c]&&(k=h[c],h[c]=b);l&&(h.scale=l(q,a));var u,w,v,A,m,U,M,n;b=a._gsTransform;var S=a.style,R=Ha.length,y={},p=Ja(a,f,!0,h.parseTransform),ja=h.transform&&("function"==typeof h.transform?h.transform(q,r):h.transform);if(p.skewType=h.skewType||p.skewType||g.defaultSkewType,d._transform=p,ja&&"string"==typeof ja&&wa)w=qa.style,w[wa]=
ja,w.display="block",w.position="absolute",-1!==ja.indexOf("%")&&(w.width=ba(a,"width"),w.height=ba(a,"height")),ca.body.appendChild(qa),u=Ja(qa,null,!1),"simple"===p.skewType&&(u.scaleY*=Math.cos(u.skewX*x)),p.svg&&(m=p.xOrigin,U=p.yOrigin,u.x-=p.xOffset,u.y-=p.yOffset,(h.transformOrigin||h.svgOrigin)&&(ja={},db(a,N(h.transformOrigin),ja,h.svgOrigin,h.smoothOrigin,!0),m=ja.xOrigin,U=ja.yOrigin,u.x-=ja.xOffset-p.xOffset,u.y-=ja.yOffset-p.yOffset),(m||U)&&(M=Na(qa,!0),u.x-=m-(m*M[0]+U*M[2]),u.y-=U-
(m*M[1]+U*M[3]))),ca.body.removeChild(qa),u.perspective||(u.perspective=p.perspective),null!=h.xPercent&&(u.xPercent=O(h.xPercent,p.xPercent)),null!=h.yPercent&&(u.yPercent=O(h.yPercent,p.yPercent));else if("object"==typeof h){if(u={scaleX:O(null!=h.scaleX?h.scaleX:h.scale,p.scaleX),scaleY:O(null!=h.scaleY?h.scaleY:h.scale,p.scaleY),scaleZ:O(h.scaleZ,p.scaleZ),x:O(h.x,p.x),y:O(h.y,p.y),z:O(h.z,p.z),xPercent:O(h.xPercent,p.xPercent),yPercent:O(h.yPercent,p.yPercent),perspective:O(h.transformPerspective,
p.perspective)},v=h.directionalRotation,null!=v)if("object"==typeof v)for(w in v)h[w]=v[w];else h.rotation=v;"string"==typeof h.x&&-1!==h.x.indexOf("%")&&(u.x=0,u.xPercent=O(h.x,p.xPercent));"string"==typeof h.y&&-1!==h.y.indexOf("%")&&(u.y=0,u.yPercent=O(h.y,p.yPercent));u.rotation=Ga("rotation"in h?h.rotation:"shortRotation"in h?h.shortRotation+"_short":"rotationZ"in h?h.rotationZ:p.rotation,p.rotation,"rotation",y);Aa&&(u.rotationX=Ga("rotationX"in h?h.rotationX:"shortRotationX"in h?h.shortRotationX+
"_short":p.rotationX||0,p.rotationX,"rotationX",y),u.rotationY=Ga("rotationY"in h?h.rotationY:"shortRotationY"in h?h.shortRotationY+"_short":p.rotationY||0,p.rotationY,"rotationY",y));u.skewX=Ga(h.skewX,p.skewX);u.skewY=Ga(h.skewY,p.skewY)}Aa&&null!=h.force3D&&(p.force3D=h.force3D,A=!0);for((v=p.force3D||p.z||p.rotationX||p.rotationY||u.z||u.rotationX||u.rotationY||u.perspective)||null==h.scale||(u.scaleZ=1);-1<--R;)n=Ha[R],ja=u[n]-p[n],(1E-6<ja||-1E-6>ja||null!=h[n]||null!=ma[n])&&(A=!0,e=new ya(p,
n,p[n],ja,e),n in y&&(e.e=y[n]),e.xs0=0,e.plugin=t,d._overwriteProps.push(e.n));return ja=h.transformOrigin,p.svg&&(ja||h.svgOrigin)&&(m=p.xOffset,U=p.yOffset,db(a,N(ja),u,h.svgOrigin,h.smoothOrigin),e=Ua(p,"xOrigin",(b?p:u).xOrigin,u.xOrigin,e,"transformOrigin"),e=Ua(p,"yOrigin",(b?p:u).yOrigin,u.yOrigin,e,"transformOrigin"),(m!==p.xOffset||U!==p.yOffset)&&(e=Ua(p,"xOffset",b?m:p.xOffset,p.xOffset,e,"transformOrigin"),e=Ua(p,"yOffset",b?U:p.yOffset,p.yOffset,e,"transformOrigin")),ja="0px 0px"),(ja||
Aa&&v&&p.zOrigin)&&(wa?(A=!0,n=Ma,ja=(ja||ba(a,n,f,!1,"50% 50%"))+"",e=new ya(S,n,0,0,e,-1,"transformOrigin"),e.b=S[n],e.plugin=t,Aa?(w=p.zOrigin,ja=ja.split(" "),p.zOrigin=(2<ja.length&&(0===w||"0px"!==ja[2])?parseFloat(ja[2]):w)||0,e.xs0=e.e=ja[0]+" "+(ja[1]||"50%")+" 0px",e=new ya(p,"zOrigin",0,0,e,-1,e.n),e.b=w,e.xs0=e.e=p.zOrigin):e.xs0=e.e=ja):N(ja+"",p)),A&&(d._transformType=p.svg&&Va||!v&&3!==this._transformType?2:3),k&&(h[c]=k),l&&(h.scale=l),e},prefix:!0});ra("boxShadow",{defaultValue:"0px 0px 0px 0px #999",
prefix:!0,color:!0,multi:!0,keyword:"inset"});ra("borderRadius",{defaultValue:"0px",parser:function(a,b,c,e,g,h){b=this.format(b);var k,u,r,l,w,v,A,m,q,U,n,M,p,S=["borderTopLeftRadius","borderTopRightRadius","borderBottomRightRadius","borderBottomLeftRadius"],R=a.style;e=parseFloat(a.offsetWidth);h=parseFloat(a.offsetHeight);b=b.split(" ");for(k=0;k<S.length;k++)this.p.indexOf("border")&&(S[k]=xa(S[k])),l=r=ba(a,S[k],f,!1,"0px"),-1!==l.indexOf(" ")&&(r=l.split(" "),l=r[0],r=r[1]),w=u=b[k],v=parseFloat(l),
q=l.substr((v+"").length),(U="="===w.charAt(1))?(A=parseInt(w.charAt(0)+"1",10),w=w.substr(2),A*=parseFloat(w),m=w.substr((A+"").length-(0>A?1:0))||""):(A=parseFloat(w),m=w.substr((A+"").length)),""===m&&(m=d[c]||q),m!==q&&(n=t(a,"borderLeft",v,q),M=t(a,"borderTop",v,q),"%"===m?(l=n/e*100+"%",r=M/h*100+"%"):"em"===m?(p=t(a,"borderLeft",1,"em"),l=n/p+"em",r=M/p+"em"):(l=n+"px",r=M+"px"),U&&(w=parseFloat(l)+A+m,u=parseFloat(r)+A+m)),g=gb(R,S[k],l+" "+r,w+" "+u,!1,"0px",g);return g},prefix:!0,formatter:U("0px 0px 0px 0px",
!1,!0)});ra("borderBottomLeftRadius,borderBottomRightRadius,borderTopLeftRadius,borderTopRightRadius",{defaultValue:"0px",parser:function(a,b,c,d,e,g){return gb(a.style,c,this.format(ba(a,c,f,!1,"0px 0px")),this.format(b),!1,"0px",e)},prefix:!0,formatter:U("0px 0px",!1,!0)});ra("backgroundPosition",{defaultValue:"0 0",parser:function(a,b,c,d,e,g){var t,h,k;c=f||oa(a,null);c=this.format((c?m?c.getPropertyValue("background-position-x")+" "+c.getPropertyValue("background-position-y"):c.getPropertyValue("background-position"):
a.currentStyle.backgroundPositionX+" "+a.currentStyle.backgroundPositionY)||"0 0");var u=this.format(b);if(-1!==c.indexOf("%")!=(-1!==u.indexOf("%"))&&2>u.split(",").length&&(t=ba(a,"backgroundImage").replace(W,""),t&&"none"!==t)){b=c.split(" ");d=u.split(" ");pa.setAttribute("src",t);for(t=2;-1<--t;)c=b[t],h=-1!==c.indexOf("%"),h!==(-1!==d[t].indexOf("%"))&&(k=0===t?a.offsetWidth-pa.width:a.offsetHeight-pa.height,b[t]=h?parseFloat(c)/100*k+"px":parseFloat(c)/k*100+"%");c=b.join(" ")}return this.parseComplex(a.style,
c,u,e,g)},formatter:N});ra("backgroundSize",{defaultValue:"0 0",formatter:function(a){return a+="","co"===a.substr(0,2)?a:N(-1===a.indexOf(" ")?a+" "+a:a)}});ra("perspective",{defaultValue:"0px",prefix:!0});ra("perspectiveOrigin",{defaultValue:"50% 50%",prefix:!0});ra("transformStyle",{prefix:!0});ra("backfaceVisibility",{prefix:!0});ra("userSelect",{prefix:!0});ra("margin",{parser:Sa("marginTop,marginRight,marginBottom,marginLeft")});ra("padding",{parser:Sa("paddingTop,paddingRight,paddingBottom,paddingLeft")});
ra("clip",{defaultValue:"rect(0px,0px,0px,0px)",parser:function(a,b,c,d,e,g){var t,h,k;return 9>m?(h=a.currentStyle,k=8>m?" ":",",t="rect("+h.clipTop+k+h.clipRight+k+h.clipBottom+k+h.clipLeft+")",b=this.format(b).split(",").join(k)):(t=this.format(ba(a,this.p,f,!1,this.dflt)),b=this.format(b)),this.parseComplex(a.style,t,b,e,g)}});ra("textShadow",{defaultValue:"0px 0px 0px #999",color:!0,multi:!0});ra("autoRound,strictUnits",{parser:function(a,b,c,d,f){return f}});ra("border",{defaultValue:"0px solid #000",
parser:function(a,b,c,d,e,g){c=ba(a,"borderTopWidth",f,!1,"0px");b=this.format(b).split(" ");d=b[0].replace(I,"");return"px"!==d&&(c=parseFloat(c)/t(a,"borderTopWidth",1,d)+d),this.parseComplex(a.style,this.format(c+" "+ba(a,"borderTopStyle",f,!1,"solid")+" "+ba(a,"borderTopColor",f,!1,"#000")),b.join(" "),e,g)},color:!0,formatter:function(a){var b=a.split(" ");return b[0]+" "+(b[1]||"solid")+" "+(a.match(v)||["#000"])[0]}});ra("borderWidth",{parser:Sa("borderTopWidth,borderRightWidth,borderBottomWidth,borderLeftWidth")});
ra("float,cssFloat,styleFloat",{parser:function(a,b,c,d,f,e){a=a.style;d="cssFloat"in a?"cssFloat":"styleFloat";return new ya(a,d,0,0,f,-1,c,!1,0,a[d],b)}});var Qa=function(a){var b,c=this.t,d=c.filter||ba(this.data,"filter")||"";a=this.s+this.c*a|0;100===a&&(-1===d.indexOf("atrix(")&&-1===d.indexOf("radient(")&&-1===d.indexOf("oader(")?(c.removeAttribute("filter"),b=!ba(this.data,"filter")):(c.filter=d.replace(K,""),b=!0));b||(this.xn1&&(c.filter=d=d||"alpha(opacity="+a+")"),-1===d.indexOf("pacity")?
0===a&&this.xn1||(c.filter=d+" alpha(opacity="+a+")"):c.filter=d.replace(F,"opacity="+a))};ra("opacity,alpha,autoAlpha",{defaultValue:"1",parser:function(a,b,c,d,e,g){var t=parseFloat(ba(a,"opacity",f,!1,"1")),h=a.style,k="autoAlpha"===c;return"string"==typeof b&&"="===b.charAt(1)&&(b=("-"===b.charAt(0)?-1:1)*parseFloat(b.substr(2))+t),k&&1===t&&"hidden"===ba(a,"visibility",f)&&0!==b&&(t=0),E?e=new ya(h,"opacity",t,b-t,e):(e=new ya(h,"opacity",100*t,100*(b-t),e),e.xn1=k?1:0,h.zoom=1,e.type=2,e.b=
"alpha(opacity="+e.s+")",e.e="alpha(opacity="+(e.s+e.c)+")",e.data=a,e.plugin=g,e.setRatio=Qa),k&&(e=new ya(h,"visibility",0,0,e,-1,null,!1,0,0!==t?"inherit":"hidden",0===b?"hidden":"inherit"),e.xs0="inherit",d._overwriteProps.push(e.n),d._overwriteProps.push(c)),e}});var Ea=function(a,b){b&&(a.removeProperty?(("ms"===b.substr(0,2)||"webkit"===b.substr(0,6))&&(b="-"+b),a.removeProperty(b.replace(Q,"-$1").toLowerCase())):a.removeAttribute(b))},ib=function(a){if(this.t._gsClassPT=this,1===a||0===a){this.t.setAttribute("class",
0===a?this.b:this.e);for(var b=this.data,c=this.t.style;b;)b.v?c[b.p]=b.v:Ea(c,b.p),b=b._next;1===a&&this.t._gsClassPT===this&&(this.t._gsClassPT=null)}else this.t.getAttribute("class")!==this.e&&this.t.setAttribute("class",this.e)};ra("className",{parser:function(b,c,d,e,g,t,h){var k,r,l,w,v=b.getAttribute("class")||"",m=b.style.cssText;if(g=e._classNamePT=new ya(b,d,0,0,g,2),g.setRatio=ib,g.pr=-11,a=!0,g.b=v,d=u(b,f),r=b._gsClassPT){l={};for(w=r.data;w;)l[w.p]=1,w=w._next;r.setRatio(1)}return b._gsClassPT=
g,g.e="="!==c.charAt(1)?c:v.replace(new RegExp("(?:\\s|^)"+c.substr(2)+"(?![\\w-])"),"")+("+"===c.charAt(0)?" "+c.substr(2):""),b.setAttribute("class",g.e),k=A(b,d,u(b),h,l),b.setAttribute("class",v),g.data=k.firstMPT,b.style.cssText=m,g.xfirst=e.parse(b,k.difs,g,t)}});var zb=function(a){if((1===a||0===a)&&this.data._totalTime===this.data._totalDuration&&"isFromStart"!==this.data.data){var b,c,d,e,f=this.t.style,g=l.transform.parse;if("all"===this.e)f.cssText="",d=!0;else for(a=this.e.split(" ").join("").split(","),
c=a.length;-1<--c;)b=a[c],l[b]&&(l[b].parse===g?d=!0:b="transformOrigin"===b?Ma:l[b].p),Ea(f,b);d&&(Ea(f,wa),e=this.t._gsTransform,e&&(e.svg&&(this.t.removeAttribute("data-svg-origin"),this.t.removeAttribute("transform")),delete this.t._gsTransform))}};ra("clearProps",{parser:function(b,c,d,e,f){return f=new ya(b,d,0,0,f,2),f.setRatio=zb,f.e=c,f.pr=-10,f.data=e._tween,a=!0,f}});h=["bezier","throwProps","physicsProps","physics2D"];for(za=h.length;za--;)xb(h[za]);h=g.prototype;h._firstPT=h._lastParsedTransform=
h._transform=null;h._onInitTween=function(b,c,t,h){if(!b.nodeType)return!1;this._target=r=b;this._tween=t;this._vars=c;q=h;n=c.autoRound;a=!1;d=c.suffixMap||g.suffixMap;f=oa(b,"");e=this._overwriteProps;var k,w,v,m,U;h=b.style;if(p&&""===h.zIndex&&(k=ba(b,"zIndex",f),("auto"===k||""===k)&&this._addLazySet(h,"zIndex",0)),"string"==typeof c&&(m=h.cssText,k=u(b,f),h.cssText=m+";"+c,k=A(b,k,u(b)).difs,!E&&C.test(c)&&(k.opacity=parseFloat(RegExp.$1)),c=k,h.cssText=m),c.className?this._firstPT=w=l.className.parse(b,
c.className,"className",this,null,null,c):this._firstPT=w=this.parse(b,c,null),this._transformType){c=3===this._transformType;wa?z&&(p=!0,""===h.zIndex&&(v=ba(b,"zIndex",f),("auto"===v||""===v)&&this._addLazySet(h,"zIndex",0)),V&&this._addLazySet(h,"WebkitBackfaceVisibility",this._vars.WebkitBackfaceVisibility||(c?"visible":"hidden"))):h.zoom=1;for(v=w;v&&v._next;)v=v._next;c=new ya(b,"transform",0,0,null,2);this._linkCSSP(c,null,v);c.setRatio=wa?qb:eb;c.data=this._transform||Ja(b,f,!0);c.tween=t;
c.pr=-1;e.pop()}if(a){for(;w;){b=w._next;for(v=m;v&&v.pr>w.pr;)v=v._next;(w._prev=v?v._prev:U)?w._prev._next=w:m=w;(w._next=v)?v._prev=w:U=w;w=b}this._firstPT=m}return!0};h.parse=function(a,b,c,e){var g,h,k,u,v,m,A,U,p,S=a.style;for(g in b){if(v=b[g],"function"==typeof v&&(v=v(q,r)),h=l[g])c=h.parse(a,v,g,this,c,e,b);else{if("--"===g.substr(0,2)){this._tween._propLookup[g]=this._addTween.call(this._tween,a.style,"setProperty",oa(a).getPropertyValue(g)+"",v+"",g,!1,g);continue}h=ba(a,g,f)+"";U="string"==
typeof v;if("color"===g||"fill"===g||"stroke"===g||-1!==g.indexOf("Color")||U&&G.test(v))U||(v=Ba(v),v=(3<v.length?"rgba(":"rgb(")+v.join(",")+")"),c=gb(S,g,h,v,!0,"transparent",c,0,e);else if(U&&H.test(v))c=gb(S,g,h,v,!0,null,c,0,e);else{m=(k=parseFloat(h))||0===k?h.substr((k+"").length):"";if(""===h||"auto"===h)if("width"===g||"height"===g){k=a;var R=g;m=f;if("svg"===(k.nodeName+"").toLowerCase())k=(m||oa(k))[R]||0;else if(k.getCTM&&pb(k))k=k.getBBox()[R]||0;else{p=parseFloat("width"===R?k.offsetWidth:
k.offsetHeight);var R=M[R],N=R.length;for(m=m||oa(k,null);-1<--N;)p-=parseFloat(ba(k,"padding"+R[N],m,!0))||0,p-=parseFloat(ba(k,"border"+R[N]+"Width",m,!0))||0;k=p}m="px"}else"left"===g||"top"===g?(k=w(a,g,f),m="px"):(k="opacity"!==g?0:1,m="");(p=U&&"="===v.charAt(1))?(u=parseInt(v.charAt(0)+"1",10),v=v.substr(2),u*=parseFloat(v),A=v.replace(I,"")):(u=parseFloat(v),A=U?v.replace(I,""):"");""===A&&(A=g in d?d[g]:m);v=u||0===u?(p?u+k:u)+A:b[g];m===A||""===A&&"lineHeight"!==g||!u&&0!==u||!k||(k=t(a,
g,k,m),"%"===A?(k/=t(a,g,100,"%")/100,!0!==b.strictUnits&&(h=k+"%")):"em"===A||"rem"===A||"vw"===A||"vh"===A?k/=t(a,g,1,A):"px"!==A&&(u=t(a,g,u,A),A="px"),!p||!u&&0!==u||(v=u+k+A));p&&(u+=k);!k&&0!==k||!u&&0!==u?void 0!==S[g]&&(v||"NaN"!=v+""&&null!=v)?(c=new ya(S,g,u||k||0,0,c,-1,g,!1,0,h,v),c.xs0="none"!==v||"display"!==g&&-1===g.indexOf("Style")?v:h):_gsScope.console&&console.log("invalid "+g+" tween value: "+b[g]):(c=new ya(S,g,k,u-k,c,0,g,!1!==n&&("px"===A||"zIndex"===g),0,h,v),c.xs0=A)}}e&&
c&&!c.plugin&&(c.plugin=e)}return c};h.setRatio=function(a){var b,c,d,e=this._firstPT;if(1!==a||this._tween._time!==this._tween._duration&&0!==this._tween._time)if(a||this._tween._time!==this._tween._duration&&0!==this._tween._time||-1E-6===this._tween._rawPrevTime)for(;e;){if(b=e.c*a+e.s,e.r?b=e.r(b):1E-6>b&&-1E-6<b&&(b=0),e.type)if(1===e.type)if(d=e.l,2===d)e.t[e.p]=e.xs0+b+e.xs1+e.xn1+e.xs2;else if(3===d)e.t[e.p]=e.xs0+b+e.xs1+e.xn1+e.xs2+e.xn2+e.xs3;else if(4===d)e.t[e.p]=e.xs0+b+e.xs1+e.xn1+
...
c}}else e.t[e.p]=b+e.xs0;else e.t[e.p]=e.e;else e.setRatio(a);e=e._next}};h._enableTransforms=function(a){this._transform=this._transform||Ja(this._target,f,!0);this._transformType=this._transform.svg&&Va||!a&&3!==this._transformType?2:3};var rb=function(a){this.t[this.p]=this.e;this.data._linkCSSP(this,this._next,null,!0)};h._addLazySet=function(a,b,c){a=this._firstPT=new ya(a,b,0,0,this._firstPT,2);a.e=c;a.setRatio=rb;a.data=this};h._linkCSSP=function(a,b,c,d){return a&&(b&&(b._prev=a),a._next&&
...
b.getAttribute(f)+"",a+"",f,!1,f),this._overwriteProps.push(f);return!0}})})();_gsScope._gsDefine.plugin({propName:"directionalRotation",version:"0.3.1",API:2,init:function(b,c,a,d){"object"!=typeof c&&(c={rotation:c});this.finals={};var f,e,g,k,l,h;a=!0===c.useRadians?2*Math.PI:360;for(f in c)"useRadians"!==f&&(k=c[f],"function"==typeof k&&(k=k(d,b)),h=(k+"").split("_"),e=h[0],g=parseFloat("function"!=typeof b[f]?b[f]:b[f.indexOf("set")||"function"!=typeof b["get"+f.substr(3)]?f:"get"+f.substr(3)]()),
k=this.finals[f]="string"==typeof e&&"="===e.charAt(1)?g+parseInt(e.charAt(0)+"1",10)*Number(e.substr(2)):Number(e)||0,l=k-g,h.length&&(e=h.join("_"),-1!==e.indexOf("short")&&(l%=a,l!==l%(a/2)&&(l=0>l?l+a:l-a)),-1!==e.indexOf("_cw")&&0>l?l=(l+9999999999*a)%a-(l/a|0)*a:-1!==e.indexOf("ccw")&&0<l&&(l=(l-9999999999*a)%a-(l/a|0)*a)),(1E-6<l||-1E-6>l)&&(this._addTween(b,f,g,g+l,f),this._overwriteProps.push(f)));return!0},set:function(b){if(1!==b)this._super.setRatio.call(this,b);else for(b=this._firstPT;b;)b.f?
b.t[b.p](this.finals[b.p]):b.t[b.p]=this.finals[b.p],b=b._next}})._autoCSS=!0;_gsScope._gsDefine("easing.Back",["easing.Ease"],function(b){var c,a,d,f,e=_gsScope.GreenSockGlobals||_gsScope,g=2*Math.PI,k=Math.PI/2,l=e.com.greensock._class,h=function(a,c){var d=l("easing."+a,function(){},!0),e=d.prototype=new b;return e.constructor=d,e.getRatio=c,d},n=b.register||function(){},p=function(a,b,c,d,e){b=l("easing."+a,{easeOut:new b,easeIn:new c,easeInOut:new d},!0);return n(b,a),b},z=function(a,b,c){this.t=
a;this.v=b;c&&(this.next=c,c.prev=this,this.c=c.v-b,this.gap=c.t-a)},B=function(a,c){var d=l("easing."+a,function(a){this._p1=a||0===a?a:1.70158;this._p2=1.525*this._p1},!0),e=d.prototype=new b;return e.constructor=d,e.getRatio=c,e.config=function(a){return new d(a)},d},B=p("Back",B("BackOut",function(a){return--a*a*((this._p1+1)*a+this._p1)+1}),B("BackIn",function(a){return a*a*((this._p1+1)*a-this._p1)}),B("BackInOut",function(a){return 1>(a*=2)?.5*a*a*((this._p2+1)*a-this._p2):.5*((a-=2)*a*((this._p2+
1)*a+this._p2)+2)})),V=l("easing.SlowMo",function(a,b,c){null==a?a=.7:1<a&&(a=1);this._p=1!==a?b||0===b?b:.7:0;this._p1=(1-a)/2;this._p2=a;this._p3=this._p1+this._p2;this._calcEnd=!0===c},!0),m=V.prototype=new b;return m.constructor=V,m.getRatio=function(a){var b=a+(.5-a)*this._p;return a<this._p1?this._calcEnd?1-(a=1-a/this._p1)*a:b-(a=1-a/this._p1)*a*a*a*b:a>this._p3?this._calcEnd?1===a?0:1-(a=(a-this._p3)/this._p1)*a:b+(a-b)*(a=(a-this._p3)/this._p1)*a*a*a:this._calcEnd?1:b},V.ease=new V(.7,.7),
m.config=V.config=function(a,b,c){return new V(a,b,c)},c=l("easing.SteppedEase",function(a,b){a=a||1;this._p1=1/a;this._p2=a+(b?0:1);this._p3=b?1:0},!0),m=c.prototype=new b,m.constructor=c,m.getRatio=function(a){return 0>a?a=0:1<=a&&(a=.999999999),((this._p2*a|0)+this._p3)*this._p1},m.config=c.config=function(a,b){return new c(a,b)},a=l("easing.ExpoScaleEase",function(a,b,c){this._p1=Math.log(b/a);this._p2=b-a;this._p3=a;this._ease=c},!0),m=a.prototype=new b,m.constructor=a,m.getRatio=function(a){return this._ease&&
(a=this._ease.getRatio(a)),(this._p3*Math.exp(this._p1*a)-this._p3)/this._p2},m.config=a.config=function(b,c,d){return new a(b,c,d)},d=l("easing.RoughEase",function(a){a=a||{};for(var c,d,e,f,g=a.taper||"none",h=[],k=0,l=f=0|(a.points||20),m=!1!==a.randomize,n=!0===a.clamp,p=a.template instanceof b?a.template:null,B="number"==typeof a.strength?.4*a.strength:.4;-1<--l;)a=m?Math.random():1/f*l,c=p?p.getRatio(a):a,"none"===g?d=B:"out"===g?(e=1-a,d=e*e*B):"in"===g?d=a*a*B:.5>a?(e=2*a,d=e*e*.5*B):(e=2*
(1-a),d=e*e*.5*B),m?c+=Math.random()*d-.5*d:l%2?c+=.5*d:c-=.5*d,n&&(1<c?c=1:0>c&&(c=0)),h[k++]={x:a,y:c};h.sort(function(a,b){return a.x-b.x});d=new z(1,1,null);for(l=f;-1<--l;)f=h[l],d=new z(f.x,f.y,d);this._prev=new z(0,0,0!==d.t?d:d.next)},!0),m=d.prototype=new b,m.constructor=d,m.getRatio=function(a){var b=this._prev;if(a>b.t){for(;b.next&&a>=b.t;)b=b.next;b=b.prev}else for(;b.prev&&a<=b.t;)b=b.prev;return this._prev=b,b.v+(a-b.t)/b.gap*b.c},m.config=function(a){return new d(a)},d.ease=new d,
p("Bounce",h("BounceOut",function(a){return 1/2.75>a?7.5625*a*a:2/2.75>a?7.5625*(a-=1.5/2.75)*a+.75:2.5/2.75>a?7.5625*(a-=2.25/2.75)*a+.9375:7.5625*(a-=2.625/2.75)*a+.984375}),h("BounceIn",function(a){return(a=1-a)<1/2.75?1-7.5625*a*a:2/2.75>a?1-(7.5625*(a-=1.5/2.75)*a+.75):2.5/2.75>a?1-(7.5625*(a-=2.25/2.75)*a+.9375):1-(7.5625*(a-=2.625/2.75)*a+.984375)}),h("BounceInOut",function(a){var b=.5>a;return a=b?1-2*a:2*a-1,a=1/2.75>a?7.5625*a*a:2/2.75>a?7.5625*(a-=1.5/2.75)*a+.75:2.5/2.75>a?7.5625*(a-=
2.25/2.75)*a+.9375:7.5625*(a-=2.625/2.75)*a+.984375,b?.5*(1-a):.5*a+.5})),p("Circ",h("CircOut",function(a){return Math.sqrt(1- --a*a)}),h("CircIn",function(a){return-(Math.sqrt(1-a*a)-1)}),h("CircInOut",function(a){return 1>(a*=2)?-.5*(Math.sqrt(1-a*a)-1):.5*(Math.sqrt(1-(a-=2)*a)+1)})),f=function(a,c,d){var e=l("easing."+a,function(a,b){this._p1=1<=a?a:1;this._p2=(b||d)/(1>a?a:1);this._p3=this._p2/g*(Math.asin(1/this._p1)||0);this._p2=g/this._p2},!0);a=e.prototype=new b;return a.constructor=e,a.getRatio=
c,a.config=function(a,b){return new e(a,b)},e},p("Elastic",f("ElasticOut",function(a){return this._p1*Math.pow(2,-10*a)*Math.sin((a-this._p3)*this._p2)+1},.3),f("ElasticIn",function(a){return-(this._p1*Math.pow(2,10*--a)*Math.sin((a-this._p3)*this._p2))},.3),f("ElasticInOut",function(a){return 1>(a*=2)?-.5*this._p1*Math.pow(2,10*--a)*Math.sin((a-this._p3)*this._p2):this._p1*Math.pow(2,-10*--a)*Math.sin((a-this._p3)*this._p2)*.5+1},.45)),p("Expo",h("ExpoOut",function(a){return 1-Math.pow(2,-10*a)}),
h("ExpoIn",function(a){return Math.pow(2,10*(a-1))-.001}),h("ExpoInOut",function(a){return 1>(a*=2)?.5*Math.pow(2,10*(a-1)):.5*(2-Math.pow(2,-10*(a-1)))})),p("Sine",h("SineOut",function(a){return Math.sin(a*k)}),h("SineIn",function(a){return-Math.cos(a*k)+1}),h("SineInOut",function(a){return-.5*(Math.cos(Math.PI*a)-1)})),l("easing.EaseLookup",{find:function(a){return b.map[a]}},!0),n(e.SlowMo,"SlowMo","ease,"),n(d,"RoughEase","ease,"),n(c,"SteppedEase","ease,"),B},!0)});_gsScope._gsDefine&&_gsScope._gsQueue.pop()();
(function(b,c){var a={},d=b.document,f=b.GreenSockGlobals=b.GreenSockGlobals||b,e=f[c];if(e)return"undefined"!=typeof module&&module.exports&&(module.exports=e),e;var g,k,l,h,n=function(a){var b=a.split("."),c=f;for(a=0;a<b.length;a++)c[b[a]]=c=c[b[a]]||{};return c},p=n("com.greensock"),z=function(a){var b,c=[],d=a.length;for(b=0;b!==d;c.push(a[b++]));return c},B=function(){},V=function(){var a=Object.prototype.toString,b=a.call([]);return function(c){return null!=c&&(c instanceof Array||"object"==
typeof c&&!!c.push&&a.call(c)===b)}}(),m={},r=function(d,e,g,h){this.sc=m[d]?m[d].sc:[];m[d]=this;this.gsClass=null;this.func=g;var k=[];this.check=function(l){for(var p,q,O,y,x=e.length,z=x;-1<--x;)(p=m[e[x]]||new r(e[x],[])).gsClass?(k[x]=p.gsClass,z--):l&&p.sc.push(this);if(0===z&&g){if(q=("com.greensock."+d).split("."),O=q.pop(),y=n(q.join("."))[O]=this.gsClass=g.apply(g,k),h)if(f[O]=a[O]=y,"undefined"!=typeof module&&module.exports)if(d===c)for(x in module.exports=a[c]=y,a)y[x]=a[x];else a[c]&&
(a[c][O]=y);else"function"==typeof define&&define.amd&&define((b.GreenSockAMDPath?b.GreenSockAMDPath+"/":"")+d.split(".").pop(),[],function(){return y});for(x=0;x<this.sc.length;x++)this.sc[x].check()}};this.check(!0)},q=b._gsDefine=function(a,b,c,d){return new r(a,b,c,d)},y=p._class=function(a,b,c){return b=b||function(){},q(a,[],function(){return b},c),b};q.globals=f;var X=[0,0,1,1],T=y("easing.Ease",function(a,b,c,d){this._func=a;this._type=c||0;this._power=d||0;this._params=b?X.concat(b):X},!0),
L=T.map={},I=T.register=function(a,b,c,d){var e,f,g;b=b.split(",");for(var h=b.length,k=(c||"easeIn,easeOut,easeInOut").split(",");-1<--h;)for(e=b[h],c=d?y("easing."+e,null,!0):p.easing[e]||{},f=k.length;-1<--f;)g=k[f],L[e+"."+g]=L[g+e]=c[g]=a.getRatio?a:a[g]||new a},e=T.prototype;e._calcEnd=!1;e.getRatio=function(a){if(this._func)return this._params[0]=a,this._func.apply(null,this._params);var b=this._type,c=this._power,d=1===b?1-a:2===b?a:.5>a?2*a:2*(1-a);return 1===c?d*=d:2===c?d*=d*d:3===c?d*=
d*d*d:4===c&&(d*=d*d*d*d),1===b?1-d:2===b?d:.5>a?d/2:1-d/2};g=["Linear","Quad","Cubic","Quart","Quint,Strong"];for(k=g.length;-1<--k;)e=g[k]+",Power"+k,I(new T(null,null,1,k),e,"easeOut",!0),I(new T(null,null,2,k),e,"easeIn"+(0===k?",easeNone":"")),I(new T(null,null,3,k),e,"easeInOut");L.linear=p.easing.Linear.easeIn;L.swing=p.easing.Quad.easeInOut;var F=y("events.EventDispatcher",function(a){this._listeners={};this._eventTarget=a||this}),e=F.prototype;e.addEventListener=function(a,b,c,d,e){e=e||
0;var f,g=this._listeners[a],k=0;this!==l||h||l.wake();null==g&&(this._listeners[a]=g=[]);for(f=g.length;-1<--f;)a=g[f],a.c===b&&a.s===c?g.splice(f,1):0===k&&a.pr<e&&(k=f+1);g.splice(k,0,{c:b,s:c,up:d,pr:e})};e.removeEventListener=function(a,b){var c,d=this._listeners[a];if(d)for(c=d.length;-1<--c;)if(d[c].c===b)return void d.splice(c,1)};e.dispatchEvent=function(a){var b,c,d,e=this._listeners[a];if(e)for(b=e.length,1<b&&(e=e.slice(0)),c=this._eventTarget;-1<--b;)(d=e[b])&&(d.up?d.c.call(d.s||c,{type:a,
target:c}):d.c.call(d.s||c))};var C=b.requestAnimationFrame,K=b.cancelAnimationFrame,G=Date.now||function(){return(new Date).getTime()},Q=G();g=["ms","moz","webkit","o"];for(k=g.length;-1<--k&&!C;)C=b[g[k]+"RequestAnimationFrame"],K=b[g[k]+"CancelAnimationFrame"]||b[g[k]+"CancelRequestAnimationFrame"];y("Ticker",function(a,b){var c,e,f,g,k,m=this,n=G(),p=!1!==b&&C?"auto":!1,q=500,r=33,x=function(a){var b,d;b=G()-Q;b>q&&(n+=b-r);Q+=b;m.time=(Q-n)/1E3;b=m.time-k;(!c||0<b||!0===a)&&(m.frame++,k+=b+(b>=
g?.004:g-b),d=!0);!0!==a&&(f=e(x));d&&m.dispatchEvent("tick")};F.call(m);m.time=m.frame=0;m.tick=function(){x(!0)};m.lagSmoothing=function(a,b){return arguments.length?(q=a||1E10,void(r=Math.min(b,q,0))):1E10>q};m.sleep=function(){null!=f&&(p&&K?K(f):clearTimeout(f),e=B,f=null,m===l&&(h=!1))};m.wake=function(a){null!==f?m.sleep():a?n+=-Q+(Q=G()):10<m.frame&&(Q=G()-q+5);e=0===c?B:p&&C?C:function(a){return setTimeout(a,1E3*(k-m.time)+1|0)};m===l&&(h=!0);x(2)};m.fps=function(a){return arguments.length?
(c=a,g=1/(c||60),k=this.time+g,void m.wake()):c};m.useRAF=function(a){return arguments.length?(m.sleep(),p=a,void m.fps(c)):p};m.fps(a);setTimeout(function(){"auto"===p&&5>m.frame&&"hidden"!==(d||{}).visibilityState&&m.useRAF(!1)},1500)});e=p.Ticker.prototype=new p.events.EventDispatcher;e.constructor=p.Ticker;var J=y("core.Animation",function(a,b){if(this.vars=b=b||{},this._duration=this._totalDuration=a||0,this._delay=Number(b.delay)||0,this._timeScale=1,this._active=!0===b.immediateRender,this.data=
b.data,this._reversed=!0===b.reversed,aa){h||l.wake();var c=this.vars.useFrames?ka:aa;c.add(this,c._time);this.vars.paused&&this.paused(!0)}});l=J.ticker=new p.Ticker;e=J.prototype;e._dirty=e._gc=e._initted=e._paused=!1;e._totalTime=e._time=0;e._rawPrevTime=-1;e._next=e._last=e._onUpdate=e._timeline=e.timeline=null;e._paused=!1;var W=function(){h&&2E3<G()-Q&&("hidden"!==(d||{}).visibilityState||!l.lagSmoothing())&&l.wake();var a=setTimeout(W,2E3);a.unref&&a.unref()};W();e.play=function(a,b){return null!=
...
this._totalTime:(b-this._startTime)/this._timeScale,this.render(b,b===this._totalTime,!0))),this._gc&&!a&&this._enabled(!0,!1),this};g=y("core.SimpleTimeline",function(a){J.call(this,0,a);this.autoRemoveChildren=this.smoothChildTiming=!0});e=g.prototype=new J;e.constructor=g;e.kill()._gc=!1;e._first=e._last=e._recent=null;e._sortChildren=!1;e.add=e.insert=function(a,b,c,d){if(a._startTime=Number(b||0)+a._delay,a._paused&&this!==a._timeline&&(a._pauseTime=this.rawTime()-(a._timeline.rawTime()-a._pauseTime)),
...
a._prev:this._last===a&&(this._last=a._prev),a._next=a._prev=a.timeline=null,a===this._recent&&(this._recent=this._last),this._timeline&&this._uncache(!0)),this};e.render=function(a,b,c){var d,e=this._first;for(this._totalTime=this._time=this._rawPrevTime=a;e;)d=e._next,(e._active||a>=e._startTime&&!e._paused&&!e._gc)&&(e._reversed?e.render((e._dirty?e.totalDuration():e._totalDuration)-(a-e._startTime)*e._timeScale,b,c):e.render((a-e._startTime)*e._timeScale,b,c)),e=d};e.rawTime=function(){return h||
l.wake(),this._totalTime};var D=y("TweenLite",function(a,c,d){if(J.call(this,c,d),this.render=D.prototype.render,null==a)throw"Cannot tween a null target.";this.target=a="string"!=typeof a?a:D.selector(a)||a;var e,f;e=a.jquery||a.length&&a!==b&&a[0]&&(a[0]===b||a[0].nodeType&&a[0].style&&!a.nodeType);d=this.vars.overwrite;if(this._overwrite=d=null==d?pa[D.defaultOverwrite]:"number"==typeof d?d>>0:pa[d],(e||a instanceof Array||a.push&&V(a))&&"number"!=typeof a[0])for(this._targets=f=z(a),this._propLookup=
[],this._siblings=[],a=0;a<f.length;a++)(e=f[a])?"string"!=typeof e?e.length&&e!==b&&e[0]&&(e[0]===b||e[0].nodeType&&e[0].style&&!e.nodeType)?(f.splice(a--,1),this._targets=f=f.concat(z(e))):(this._siblings[a]=Ca(e,this,!1),1===d&&1<this._siblings[a].length&&xa(e,this,null,1,this._siblings[a])):(e=f[a--]=D.selector(e),"string"==typeof e&&f.splice(a+1,1)):f.splice(a--,1);else this._propLookup={},this._siblings=Ca(a,this,!1),1===d&&1<this._siblings.length&&xa(a,this,null,1,this._siblings);(this.vars.immediateRender||
0===c&&0===this._delay&&!1!==this.vars.immediateRender)&&(this._time=-1E-10,this.render(Math.min(0,-this._delay)))},!0),ea=function(a){return a&&a.length&&a!==b&&a[0]&&(a[0]===b||a[0].nodeType&&a[0].style&&!a.nodeType)},e=D.prototype=new J;e.constructor=D;e.kill()._gc=!1;e.ratio=0;e._firstPT=e._targets=e._overwrittenProps=e._startAt=null;e._notifyPluginsOfEnabled=e._lazy=!1;D.version="2.0.1";D.defaultEase=e._ease=new T(null,null,1,1);D.defaultOverwrite="auto";D.ticker=l;D.autoSleep=120;D.lagSmoothing=
function(a,b){l.lagSmoothing(a,b)};D.selector=b.$||b.jQuery||function(a){var c=b.$||b.jQuery;return c?(D.selector=c,c(a)):(d||(d=b.document),d?d.querySelectorAll?d.querySelectorAll(a):d.getElementById("#"===a.charAt(0)?a.substr(1):a):a)};var Z=[],na={},ha=/(?:(-|-=|\+=)?\d*\.?\d*(?:e[\-+]?\d+)?)[0-9]/gi,H=/[\+-]=-?[\.\d]/,x=function(a){for(var b,c=this._firstPT;c;)b=c.blob?1===a&&null!=this.end?this.end:a?this.join(""):this.start:c.c*a+c.s,c.m?b=c.m.call(this._tween,b,this._target||c.t,this._tween):
1E-6>b&&-1E-6<b&&!c.blob&&(b=0),c.f?c.fp?c.t[c.p](c.fp,b):c.t[c.p](b):c.t[c.p]=b,c=c._next},la=function(a,b,c,d){var e,f,g,h,k=[],l=0,m="",n=0;k.start=a;k.end=b;a=k[0]=a+"";b=k[1]=b+"";c&&(c(k),a=k[0],b=k[1]);k.length=0;a=a.match(ha)||[];c=b.match(ha)||[];d&&(d._next=null,d.blob=1,k._firstPT=k._applyPT=d);f=c.length;for(d=0;f>d;d++)h=c[d],g=b.substr(l,b.indexOf(h,l)-l),m+=g||!d?g:",",l+=g.length,n?n=(n+1)%5:"rgba("===g.substr(-5)&&(n=1),h===a[d]||a.length<=d?m+=h:(m&&(k.push(m),m=""),e=parseFloat(a[d]),
k.push(e),k._firstPT={_next:k._firstPT,t:k,p:k.length-1,s:e,c:("="===h.charAt(1)?parseInt(h.charAt(0)+"1",10)*parseFloat(h.substr(2)):parseFloat(h)-e)||0,f:0,m:n&&4>n?Math.round:0}),l+=h.length;return m+=b.substr(l),m&&k.push(m),k.setRatio=x,H.test(b)&&(k.end=null),k},ma=function(a,b,c,d,e,f,g,h,k){"function"==typeof d&&(d=d(k||0,a));var l;k=typeof a[b];var m="function"!==k?"":b.indexOf("set")||"function"!=typeof a["get"+b.substr(3)]?b:"get"+b.substr(3);c="get"!==c?c:m?g?a[m](g):a[m]():a[b];m="string"==
typeof d&&"="===d.charAt(1);a={t:a,p:b,s:c,f:"function"===k,pg:0,n:e||b,m:f?"function"==typeof f?f:Math.round:0,pr:0,c:m?parseInt(d.charAt(0)+"1",10)*parseFloat(d.substr(2)):parseFloat(d)-c||0};return("number"!=typeof c||"number"!=typeof d&&!m)&&(g||isNaN(c)||!m&&isNaN(d)||"boolean"==typeof c||"boolean"==typeof d?(a.fp=g,l=la(c,m?parseFloat(a.s)+a.c+(a.s+"").replace(/[0-9\-\.]/g,""):d,h||D.defaultStringFilter,a),a={t:l,p:"setRatio",s:0,c:1,f:2,pg:0,n:e||b,pr:0,m:0}):(a.s=parseFloat(c),m||(a.c=parseFloat(d)-
a.s||0))),a.c?((a._next=this._firstPT)&&(a._next._prev=a),this._firstPT=a,a):void 0};k=D._internals={isArray:V,isSelector:ea,lazyTweens:Z,blobDif:la};var Y=D._plugins={},ca=k.tweenLookup={},ia=0,qa=k.reservedProps={ease:1,delay:1,overwrite:1,onComplete:1,onCompleteParams:1,onCompleteScope:1,useFrames:1,runBackwards:1,startAt:1,onUpdate:1,onUpdateParams:1,onUpdateScope:1,onStart:1,onStartParams:1,onStartScope:1,onReverseComplete:1,onReverseCompleteParams:1,onReverseCompleteScope:1,onRepeat:1,onRepeatParams:1,
onRepeatScope:1,easeParams:1,yoyo:1,immediateRender:1,repeat:1,repeatDelay:1,data:1,paused:1,reversed:1,autoCSS:1,lazy:1,onOverwrite:1,callbackScope:1,stringFilter:1,id:1,yoyoEase:1},pa={none:0,all:1,auto:2,concurrent:3,allOnStart:4,preexisting:5,"true":1,"false":0},ka=J._rootFramesTimeline=new g,aa=J._rootTimeline=new g,E=30,va=k.lazyRender=function(){var a,b=Z.length;for(na={};-1<--b;)(a=Z[b])&&!1!==a._lazy&&(a.render(a._lazy[0],a._lazy[1],!0),a._lazy=!1);Z.length=0};aa._startTime=l.time;ka._startTime=
l.frame;aa._active=ka._active=!0;setTimeout(va,1);J._updateRoot=D.render=function(){var a,b,c;if(Z.length&&va(),aa.render((l.time-aa._startTime)*aa._timeScale,!1,!1),ka.render((l.frame-ka._startTime)*ka._timeScale,!1,!1),Z.length&&va(),l.frame>=E){E=l.frame+(parseInt(D.autoSleep,10)||120);for(c in ca){b=ca[c].tweens;for(a=b.length;-1<--a;)b[a]._gc&&b.splice(a,1);0===b.length&&delete ca[c]}if(c=aa._first,(!c||c._paused)&&D.autoSleep&&!ka._first&&1===l._listeners.tick.length){for(;c&&c._paused;)c=c._next;
c||l.sleep()}}};l.addEventListener("tick",J._updateRoot);var Ca=function(a,b,c){var d,e,f=a._gsTweenID;if(ca[f||(a._gsTweenID=f="t"+ia++)]||(ca[f]={target:a,tweens:[]}),b&&(d=ca[f].tweens,d[e=d.length]=b,c))for(;-1<--e;)d[e]===b&&d.splice(e,1);return ca[f].tweens},Fa=function(a,b,c,d){var e,f,g=a.vars.onOverwrite;return g&&(e=g(a,b,c,d)),g=D.onOverwrite,g&&(f=g(a,b,c,d)),!1!==e&&!1!==f},xa=function(a,b,c,d,e){var f,g,h;if(1===d||4<=d){c=e.length;for(f=0;c>f;f++)if((h=e[f])!==b)h._gc||h._kill(null,
a,b)&&(g=!0);else if(5===d)break;return g}var k,l=b._startTime+1E-10,m=[],n=0,p=0===b._duration;for(f=e.length;-1<--f;)(h=e[f])===b||h._gc||h._paused||(h._timeline!==b._timeline?(k=k||oa(b,0,p),0===oa(h,k,p)&&(m[n++]=h)):h._startTime<=l&&h._startTime+h.totalDuration()/h._timeScale>l&&((p||!h._initted)&&2E-10>=l-h._startTime||(m[n++]=h)));for(f=n;-1<--f;)(h=m[f],2===d&&h._kill(c,a,b)&&(g=!0),2!==d||!h._firstPT&&h._initted)&&(2===d||Fa(h,b))&&h._enabled(!1,!1)&&(g=!0);return g},oa=function(a,b,c){for(var d=
a._timeline,e=d._timeScale,f=a._startTime;d._timeline;){if(f+=d._startTime,e*=d._timeScale,d._paused)return-100;d=d._timeline}return f/=e,f>b?f-b:c&&f===b||!a._initted&&2E-10>f-b?1E-10:(f+=a.totalDuration()/a._timeScale/e)>b+1E-10?0:f-b-1E-10};e._init=function(){var a,b,c,d,e=this.vars,f=this._overwrittenProps,g=this._duration;d=!!e.immediateRender;var h=e.ease;if(e.startAt){this._startAt&&(this._startAt.render(-1,!0),this._startAt.kill());c={};for(a in e.startAt)c[a]=e.startAt[a];if(c.data="isStart",
c.overwrite=!1,c.immediateRender=!0,c.lazy=d&&!1!==e.lazy,c.startAt=c.delay=null,c.onUpdate=e.onUpdate,c.onUpdateParams=e.onUpdateParams,c.onUpdateScope=e.onUpdateScope||e.callbackScope||this,this._startAt=D.to(this.target||{},0,c),d)if(0<this._time)this._startAt=null;else if(0!==g)return}else if(e.runBackwards&&0!==g)if(this._startAt)this._startAt.render(-1,!0),this._startAt.kill(),this._startAt=null;else{0!==this._time&&(d=!1);c={};for(a in e)qa[a]&&"autoCSS"!==a||(c[a]=e[a]);if(c.overwrite=0,c.data=
"isFromStart",c.lazy=d&&!1!==e.lazy,c.immediateRender=d,this._startAt=D.to(this.target,0,c),d){if(0===this._time)return}else this._startAt._init(),this._startAt._enabled(!1),this.vars.immediateRender&&(this._startAt=null)}if(this._ease=h=h?h instanceof T?h:"function"==typeof h?new T(h,e.easeParams):L[h]||D.defaultEase:D.defaultEase,e.easeParams instanceof Array&&h.config&&(this._ease=h.config.apply(h,e.easeParams)),this._easeType=this._ease._type,this._easePower=this._ease._power,this._firstPT=null,
this._targets)for(d=this._targets.length,a=0;d>a;a++)this._initProps(this._targets[a],this._propLookup[a]={},this._siblings[a],f?f[a]:null,a)&&(b=!0);else b=this._initProps(this.target,this._propLookup,this._siblings,f,0);if(b&&D._onPluginEvent("_onInitAllProps",this),f&&(this._firstPT||"function"!=typeof this.target&&this._enabled(!1,!1)),e.runBackwards)for(c=this._firstPT;c;)c.s+=c.c,c.c=-c.c,c=c._next;this._onUpdate=e.onUpdate;this._initted=!0};e._initProps=function(a,c,d,e,f){var g,h,k,l,m;if(null==
a)return!1;na[a._gsTweenID]&&va();if(!this.vars.css&&a.style&&a!==b&&a.nodeType&&Y.css&&!1!==this.vars.autoCSS){h=this.vars;var n={};for(m in h)qa[m]||m in a&&"transform"!==m&&"x"!==m&&"y"!==m&&"width"!==m&&"height"!==m&&"className"!==m&&"border"!==m||!(!Y[m]||Y[m]&&Y[m]._autoCSS)||(n[m]=h[m],delete h[m]);h.css=n}for(g in this.vars)if(h=this.vars[g],qa[g])h&&(h instanceof Array||h.push&&V(h))&&-1!==h.join("").indexOf("{self}")&&(this.vars[g]=this._swapSelfInParams(h,this));else if(Y[g]&&(l=new Y[g])._onInitTween(a,
this.vars[g],this,f)){this._firstPT=m={_next:this._firstPT,t:l,p:"setRatio",s:0,c:1,f:1,n:g,pg:1,pr:l._priority,m:0};for(h=l._overwriteProps.length;-1<--h;)c[l._overwriteProps[h]]=this._firstPT;(l._priority||l._onInitAllProps)&&(k=!0);(l._onDisable||l._onEnable)&&(this._notifyPluginsOfEnabled=!0);m._next&&(m._next._prev=m)}else c[g]=ma.call(this,a,g,"get",h,g,0,null,this.vars.stringFilter,f);return e&&this._kill(e,a)?this._initProps(a,c,d,e,f):1<this._overwrite&&this._firstPT&&1<d.length&&xa(a,this,
c,this._overwrite,d)?(this._kill(c,a),this._initProps(a,c,d,e,f)):(this._firstPT&&(!1!==this.vars.lazy&&this._duration||this.vars.lazy&&!this._duration)&&(na[a._gsTweenID]=!0),k)};e.render=function(a,b,c){var d,e,f,g,h=this._time,k=this._duration;f=this._rawPrevTime;if(a>=k-1E-7&&0<=a)this._totalTime=this._time=k,this.ratio=this._ease._calcEnd?this._ease.getRatio(1):1,this._reversed||(d=!0,e="onComplete",c=c||this._timeline.autoRemoveChildren),0===k&&(this._initted||!this.vars.lazy||c)&&(this._startTime===
this._timeline._duration&&(a=0),(0>f||0>=a&&-1E-7<=a||1E-10===f&&"isPause"!==this.data)&&f!==a&&(c=!0,1E-10<f&&(e="onReverseComplete")),this._rawPrevTime=g=!b||a||f===a?a:1E-10);else if(1E-7>a)this._totalTime=this._time=0,this.ratio=this._ease._calcEnd?this._ease.getRatio(0):0,(0!==h||0===k&&0<f)&&(e="onReverseComplete",d=this._reversed),0>a&&(this._active=!1,0===k&&(this._initted||!this.vars.lazy||c)&&(0<=f&&(1E-10!==f||"isPause"!==this.data)&&(c=!0),this._rawPrevTime=g=!b||a||f===a?a:1E-10)),(!this._initted||
this._startAt&&this._startAt.progress())&&(c=!0);else if(this._totalTime=this._time=a,this._easeType){var l=a/k,m=this._easeType,n=this._easePower;(1===m||3===m&&.5<=l)&&(l=1-l);3===m&&(l*=2);1===n?l*=l:2===n?l*=l*l:3===n?l*=l*l*l:4===n&&(l*=l*l*l*l);1===m?this.ratio=1-l:2===m?this.ratio=l:.5>a/k?this.ratio=l/2:this.ratio=1-l/2}else this.ratio=this._ease.getRatio(a/k);if(this._time!==h||c){if(!this._initted){if(this._init(),!this._initted||this._gc)return;if(!c&&this._firstPT&&(!1!==this.vars.lazy&&
this._duration||this.vars.lazy&&!this._duration))return this._time=this._totalTime=h,this._rawPrevTime=f,Z.push(this),void(this._lazy=[a,b]);this._time&&!d?this.ratio=this._ease.getRatio(this._time/k):d&&this._ease._calcEnd&&(this.ratio=this._ease.getRatio(0===this._time?0:1))}!1!==this._lazy&&(this._lazy=!1);this._active||!this._paused&&this._time!==h&&0<=a&&(this._active=!0);0!==h||(this._startAt&&(0<=a?this._startAt.render(a,!0,c):e||(e="_dummyGS")),!this.vars.onStart||0===this._time&&0!==k||!b&&
this._callback("onStart"));for(f=this._firstPT;f;)f.f?f.t[f.p](f.c*this.ratio+f.s):f.t[f.p]=f.c*this.ratio+f.s,f=f._next;this._onUpdate&&(0>a&&this._startAt&&-1E-4!==a&&this._startAt.render(a,!0,c),b||(this._time!==h||d||c)&&this._callback("onUpdate"));e&&(!this._gc||c)&&(0>a&&this._startAt&&!this._onUpdate&&-1E-4!==a&&this._startAt.render(a,!0,c),d&&(this._timeline.autoRemoveChildren&&this._enabled(!1,!1),this._active=!1),!b&&this.vars[e]&&this._callback(e),0===k&&1E-10===this._rawPrevTime&&1E-10!==
g&&(this._rawPrevTime=0))}};e._kill=function(a,b,c){if("all"===a&&(a=null),null==a&&(null==b||b===this.target))return this._lazy=!1,this._enabled(!1,!1);b="string"!=typeof b?b||this._targets||this.target:D.selector(b)||b;var d,e,f,g,h,k,l,m,n=c&&this._time&&c._startTime===this._startTime&&this._timeline===c._timeline;if((V(b)||ea(b))&&"number"!=typeof b[0])for(d=b.length;-1<--d;)this._kill(a,b[d],c)&&(k=!0);else{if(this._targets)for(d=this._targets.length;-1<--d;){if(b===this._targets[d]){h=this._propLookup[d]||
{};this._overwrittenProps=this._overwrittenProps||[];e=this._overwrittenProps[d]=a?this._overwrittenProps[d]||{}:"all";break}}else{if(b!==this.target)return!1;h=this._propLookup;e=this._overwrittenProps=a?this._overwrittenProps||{}:"all"}if(h){if(d=a||h,l=a!==e&&"all"!==e&&a!==h&&("object"!=typeof a||!a._tempKill),c&&(D.onOverwrite||this.vars.onOverwrite)){for(f in d)h[f]&&(m||(m=[]),m.push(f));if((m||!a)&&!Fa(this,c,b,m))return!1}for(f in d)(g=h[f])&&(n&&(g.f?g.t[g.p](g.s):g.t[g.p]=g.s,k=!0),g.pg&&
g.t._kill(d)&&(k=!0),g.pg&&0!==g.t._overwriteProps.length||(g._prev?g._prev._next=g._next:g===this._firstPT&&(this._firstPT=g._next),g._next&&(g._next._prev=g._prev),g._next=g._prev=null),delete h[f]),l&&(e[f]=1);!this._firstPT&&this._initted&&this._enabled(!1,!1)}}return k};e.invalidate=function(){return this._notifyPluginsOfEnabled&&D._onPluginEvent("_onDisable",this),this._firstPT=this._overwrittenProps=this._startAt=this._onUpdate=null,this._notifyPluginsOfEnabled=this._active=this._lazy=!1,this._propLookup=
this._targets?{}:[],J.prototype.invalidate.call(this),this.vars.immediateRender&&(this._time=-1E-10,this.render(Math.min(0,-this._delay))),this};e._enabled=function(a,b){if(h||l.wake(),a&&this._gc){var c,d=this._targets;if(d)for(c=d.length;-1<--c;)this._siblings[c]=Ca(d[c],this,!0);else this._siblings=Ca(this.target,this,!0)}return J.prototype._enabled.call(this,a,b),this._notifyPluginsOfEnabled&&this._firstPT?D._onPluginEvent(a?"_onEnable":"_onDisable",this):!1};D.to=function(a,b,c){return new D(a,
b,c)};D.from=function(a,b,c){return c.runBackwards=!0,c.immediateRender=0!=c.immediateRender,new D(a,b,c)};D.fromTo=function(a,b,c,d){return d.startAt=c,d.immediateRender=0!=d.immediateRender&&0!=c.immediateRender,new D(a,b,d)};D.delayedCall=function(a,b,c,d,e){return new D(b,0,{delay:a,onComplete:b,onCompleteParams:c,callbackScope:d,onReverseComplete:b,onReverseCompleteParams:c,immediateRender:!1,lazy:!1,useFrames:e,overwrite:0})};D.set=function(a,b){return new D(a,0,b)};D.getTweensOf=function(a,
b){if(null==a)return[];a="string"!=typeof a?a:D.selector(a)||a;var c,d,e,f;if((V(a)||ea(a))&&"number"!=typeof a[0]){c=a.length;for(d=[];-1<--c;)d=d.concat(D.getTweensOf(a[c],b));for(c=d.length;-1<--c;)for(f=d[c],e=c;-1<--e;)f===d[e]&&d.splice(c,1)}else if(a._gsTweenID)for(d=Ca(a).concat(),c=d.length;-1<--c;)(d[c]._gc||b&&!d[c].isActive())&&d.splice(c,1);return d||[]};D.killTweensOf=D.killDelayedCallsTo=function(a,b,c){"object"==typeof b&&(c=b,b=!1);b=D.getTweensOf(a,b);for(var d=b.length;-1<--d;)b[d]._kill(c,
a)};var ba=y("plugins.TweenPlugin",function(a,b){this._overwriteProps=(a||"").split(",");this._propName=this._overwriteProps[0];this._priority=b||0;this._super=ba.prototype},!0);if(e=ba.prototype,ba.version="1.19.0",ba.API=2,e._firstPT=null,e._addTween=ma,e.setRatio=x,e._kill=function(a){var b,c=this._overwriteProps,d=this._firstPT;if(null!=a[this._propName])this._overwriteProps=[];else for(b=c.length;-1<--b;)null!=a[c[b]]&&c.splice(b,1);for(;d;)null!=a[d.n]&&(d._next&&(d._next._prev=d._prev),d._prev?
(d._prev._next=d._next,d._prev=null):this._firstPT===d&&(this._firstPT=d._next)),d=d._next;return!1},e._mod=e._roundProps=function(a){for(var b,c=this._firstPT;c;)(b=a[this._propName]||null!=c.n&&a[c.n.split(this._propName+"_").join("")])&&"function"==typeof b&&(2===c.f?c.t._applyPT.m=b:c.m=b),c=c._next},D._onPluginEvent=function(a,b){var c,d,e,f,g,h=b._firstPT;if("_onInitAllProps"===a){for(;h;){g=h._next;for(d=e;d&&d.pr>h.pr;)d=d._next;(h._prev=d?d._prev:f)?h._prev._next=h:e=h;(h._next=d)?d._prev=
h:f=h;h=g}h=b._firstPT=e}for(;h;)h.pg&&"function"==typeof h.t[a]&&h.t[a]()&&(c=!0),h=h._next;return c},ba.activate=function(a){for(var b=a.length;-1<--b;)a[b].API===ba.API&&(Y[(new a[b])._propName]=a[b]);return!0},q.plugin=function(a){if(!(a&&a.propName&&a.init&&a.API))throw"illegal plugin definition.";var b,c=a.propName,d=a.priority||0,e=a.overwriteProps,f={init:"_onInitTween",set:"setRatio",kill:"_kill",round:"_mod",mod:"_mod",initAll:"_onInitAllProps"},g=y("plugins."+c.charAt(0).toUpperCase()+
c.substr(1)+"Plugin",function(){ba.call(this,c,d);this._overwriteProps=e||[]},!0===a.global),h=g.prototype=new ba(c);h.constructor=g;g.API=a.API;for(b in f)"function"==typeof a[b]&&(h[f[b]]=a[b]);return g.version=a.version,ba.activate([g]),g},g=b._gsQueue){for(k=0;k<g.length;k++)g[k]();for(e in m)m[e].func||b.console.log("GSAP encountered missing dependency: "+e)}h=!1})("undefined"!=typeof module&&module.exports&&"undefined"!=typeof global?global:this||window,"TweenMax");
...
0;g<d.length;g+=1)if(b[e]===d[g]){f=!0;break}f||d.push(b[e])}b=[];for(e=0;e<d.length;e+=1){f=!1;for(g=0;g<c.length;g+=1)if(d[e]===c[g]){f=!0;break}f||b.push(d[e])}a.className=b.join(" ").replace(/\s+/g," ").replace(/^\s+|\s+$/,"")}function l(a,b){for(var c=a.className.split(/\s+/),d=0,e=c.length;d<e;d++)if(c[d]==b)return!0;return!1}function h(a){return a.o.location.hostname||a.a.location.hostname}function n(a,b,c){function d(){l&&g&&h&&(l(k),l=null)}b=f(a,"link",{rel:"stylesheet",href:b,media:"all"});
var g=!1,h=!0,k=null,l=c||null;u?(b.onload=function(){g=!0;d()},b.onerror=function(){g=!0;k=Error("Stylesheet failed to load");d()}):setTimeout(function(){g=!0;d()},0);e(a,"head",b)}function p(a,b,c,d){var e=a.c.getElementsByTagName("head")[0];if(e){var g=f(a,"script",{src:b}),h=!1;g.onload=g.onreadystatechange=function(){h||this.readyState&&"loaded"!=this.readyState&&"complete"!=this.readyState||(h=!0,c&&c(null),g.onload=g.onreadystatechange=null,"HEAD"==g.parentNode.tagName&&e.removeChild(g))};
e.appendChild(g);setTimeout(function(){h||(h=!0,c&&c(Error("Script load timeout")))},d||5E3);return g}return null}function z(){this.a=0;this.c=null}function B(a){a.a++;return function(){a.a--;m(a)}}function V(a,b){a.c=b;m(a)}function m(a){0==a.a&&a.c&&(a.c(),a.c=null)}function r(a){this.a=a||"-"}function q(a,b){this.c=a;this.f=4;this.a="n";var c=(b||"n4").match(/^([nio])([1-9])$/i);c&&(this.a=c[1],this.f=parseInt(c[2],10))}function y(a){return L(a)+" "+(a.f+"00")+" 300px "+X(a.c)}function X(a){var b=
[];a=a.split(/,\s*/);for(var c=0;c<a.length;c++){var d=a[c].replace(/['"]/g,"");-1!=d.indexOf(" ")||/^\d/.test(d)?b.push("'"+d+"'"):b.push(d)}return b.join(",")}function T(a){return a.a+a.f}function L(a){var b="normal";"o"===a.a?b="oblique":"i"===a.a&&(b="italic");return b}function I(a){var b=4,c="n",d=null;a&&((d=a.match(/(normal|oblique|italic)/i))&&d[1]&&(c=d[1].substr(0,1).toLowerCase()),(d=a.match(/([1-9]00|normal|bold)/i))&&d[1]&&(/bold/i.test(d[1])?b=7:/[1-9]00/.test(d[1])&&(b=parseInt(d[1].substr(0,
1),10))));return c+b}function F(a,b){this.c=a;this.f=a.o.document.documentElement;this.h=b;this.a=new r("-");this.j=!1!==b.events;this.g=!1!==b.classes}function C(a){a.g&&k(a.f,[a.a.c("wf","loading")]);G(a,"loading")}function K(a){if(a.g){var b=l(a.f,a.a.c("wf","active")),c=[],d=[a.a.c("wf","loading")];b||c.push(a.a.c("wf","inactive"));k(a.f,c,d)}G(a,"inactive")}function G(a,b,c){if(a.j&&a.h[b])if(c)a.h[b](c.c,T(c));else a.h[b]()}function Q(){this.c={}}function J(a,b,c){var d=[],e;for(e in b)if(b.hasOwnProperty(e)){var f=
a.c[e];f&&d.push(f(b[e],c))}return d}function W(a,b){this.c=a;this.f=b;this.a=f(this.c,"span",{"aria-hidden":"true"},this.f)}function D(a){e(a.c,"body",a.a)}function ea(a){return"display:block;position:absolute;top:-9999px;left:-9999px;font-size:300px;width:auto;height:auto;line-height:normal;margin:0;padding:0;font-variant:normal;white-space:nowrap;font-family:"+X(a.c)+";"+("font-style:"+L(a)+";font-weight:"+(a.f+"00")+";")}function Z(a,b,c,d,e,f){this.g=a;this.j=b;this.a=d;this.c=c;this.f=e||3E3;
this.h=f||void 0}function na(a,b,c,d,e,f,g){this.v=a;this.B=b;this.c=c;this.a=d;this.s=g||"BESbswy";this.f={};this.w=e||3E3;this.u=f||null;this.m=this.j=this.h=this.g=null;this.g=new W(this.c,this.s);this.h=new W(this.c,this.s);this.j=new W(this.c,this.s);this.m=new W(this.c,this.s);a=new q(this.a.c+",serif",T(this.a));a=ea(a);this.g.a.style.cssText=a;a=new q(this.a.c+",sans-serif",T(this.a));a=ea(a);this.h.a.style.cssText=a;a=new q("serif",T(this.a));a=ea(a);this.j.a.style.cssText=a;a=new q("sans-serif",
T(this.a));a=ea(a);this.m.a.style.cssText=a;D(this.g);D(this.h);D(this.j);D(this.m)}function ha(){if(null===M){var a=/AppleWebKit\/([0-9]+)(?:\.([0-9]+))/.exec(window.navigator.userAgent);M=!!a&&(536>parseInt(a[1],10)||536===parseInt(a[1],10)&&11>=parseInt(a[2],10))}return M}function H(a,b,c){for(var d in A)if(A.hasOwnProperty(d)&&b===a.f[A[d]]&&c===a.f[A[d]])return!0;return!1}function x(a){var b=a.g.a.offsetWidth,c=a.h.a.offsetWidth,d;(d=b===a.f.serif&&c===a.f["sans-serif"])||(d=ha()&&H(a,b,c));
d?w()-a.A>=a.w?ha()&&H(a,b,c)&&(null===a.u||a.u.hasOwnProperty(a.a.c))?ma(a,a.v):ma(a,a.B):la(a):ma(a,a.v)}function la(b){setTimeout(a(function(){x(this)},b),50)}function ma(b,c){setTimeout(a(function(){g(this.g.a);g(this.h.a);g(this.j.a);g(this.m.a);c(this.a)},b),0)}function Y(a,b,c){this.c=a;this.a=b;this.f=0;this.m=this.j=!1;this.s=c}function ca(a){0==--a.f&&a.j&&(a.m?(a=a.a,a.g&&k(a.f,[a.a.c("wf","active")],[a.a.c("wf","loading"),a.a.c("wf","inactive")]),G(a,"active")):K(a.a))}function ia(a){this.j=
a;this.a=new Q;this.h=0;this.f=this.g=!0}function qa(b,c,d,e,f){var g=0==--b.h;(b.f||b.g)&&setTimeout(function(){var b=f||null,h=e||null||{};if(0===d.length&&g)K(c.a);else{c.f+=d.length;g&&(c.j=g);var l,m=[];for(l=0;l<d.length;l++){var n=d[l],v=h[n.c],p=c.a,q=n;p.g&&k(p.f,[p.a.c("wf",q.c,T(q).toString(),"loading")]);G(p,"fontloading",q);p=null;if(null===R)if(window.FontFace){var q=/Gecko.*Firefox\/(\d+)/.exec(window.navigator.userAgent),r=/OS X.*Version\/10\..*Safari/.exec(window.navigator.userAgent)&&
/Apple/.exec(window.navigator.vendor);R=q?42<parseInt(q[1],10):r?!1:!0}else R=!1;R?p=new Z(a(c.g,c),a(c.h,c),c.c,n,c.s,v):p=new na(a(c.g,c),a(c.h,c),c.c,n,c.s,b,v);m.push(p)}for(l=0;l<m.length;l++)m[l].start()}},0)}function pa(a,b,c){var d=[],e=c.timeout;C(b);var d=J(a.a,c,a.c),f=new Y(a.c,b,e);a.h=d.length;b=0;for(c=d.length;b<c;b++)d[b].load(function(b,c,d){qa(a,f,b,c,d)})}function ka(a,b){this.c=a;this.a=b}function aa(a,b){this.c=a;this.a=b}function E(a,b){a?this.c=a:this.c=N;this.a=[];this.f=
...
a;this.a=[];this.c={}}function xa(a){for(var b=a.f.length,c=0;c<b;c++){var d=a.f[c].split(":"),e=d[0].replace(/\+/g," "),f=["n4"];if(2<=d.length){var g,h=d[1];g=[];if(h)for(var h=h.split(","),k=h.length,l=0;l<k;l++){var m;m=h[l];if(m.match(/^[\w-]+$/)){var n=ua.exec(m.toLowerCase());if(null==n)m="";else{m=n[2];m=null==m||""==m?"n":Ga[m];n=n[1];if(null==n||""==n)n="4";else var p=O[n],n=p?p:isNaN(n)?"4":n.substr(0,1);m=[m,n].join("")}}else m="";m&&g.push(m)}0<g.length&&(f=g);3==d.length&&(d=d[2],g=
[],d=d?d.split(","):g,0<d.length&&(d=S[d[0]])&&(a.c[e]=d))}a.c[e]||(d=S[e])&&(a.c[e]=d);for(d=0;d<f.length;d+=1)a.a.push(new q(e,f[d]))}}function oa(a,b){this.c=a;this.a=b}function ba(a,b){this.c=a;this.a=b}function t(a,b){this.c=a;this.f=b;this.a=[]}var w=Date.now||function(){return+new Date},u=!!window.FontFace;r.prototype.c=function(a){for(var b=[],c=0;c<arguments.length;c++)b.push(arguments[c].replace(/[\W_]+/g,"").toLowerCase());return b.join(this.a)};Z.prototype.start=function(){var a=this.c.o.document,
b=this,c=w(),d=new Promise(function(d,e){function f(){w()-c>=b.f?e():a.fonts.load(y(b.a),b.h).then(function(a){1<=a.length?d():setTimeout(f,25)},function(){e()})}f()}),e=null,f=new Promise(function(a,c){e=setTimeout(c,b.f)});Promise.race([f,d]).then(function(){e&&(clearTimeout(e),e=null);b.g(b.a)},function(){b.j(b.a)})};var A={D:"serif",C:"sans-serif"},M=null;na.prototype.start=function(){this.f.serif=this.j.a.offsetWidth;this.f["sans-serif"]=this.m.a.offsetWidth;this.A=w();x(this)};var R=null;Y.prototype.g=
function(a){var b=this.a;b.g&&k(b.f,[b.a.c("wf",a.c,T(a).toString(),"active")],[b.a.c("wf",a.c,T(a).toString(),"loading"),b.a.c("wf",a.c,T(a).toString(),"inactive")]);G(b,"fontactive",a);this.m=!0;ca(this)};Y.prototype.h=function(a){var b=this.a;if(b.g){var c=l(b.f,b.a.c("wf",a.c,T(a).toString(),"active")),d=[],e=[b.a.c("wf",a.c,T(a).toString(),"loading")];c||d.push(b.a.c("wf",a.c,T(a).toString(),"inactive"));k(b.f,d,e)}G(b,"fontinactive",a);ca(this)};ia.prototype.load=function(a){this.c=new d(this.j,
a.context||this.j);this.g=!1!==a.events;this.f=!1!==a.classes;pa(this,new F(this.c,a),a)};ka.prototype.load=function(a){function b(){if(f["__mti_fntLst"+d]){var c=f["__mti_fntLst"+d](),e=[],g;if(c)for(var h=0;h<c.length;h++){var k=c[h].fontfamily;void 0!=c[h].fontStyle&&void 0!=c[h].fontWeight?(g=c[h].fontStyle+c[h].fontWeight,e.push(new q(k,g))):e.push(new q(k))}a(e)}else setTimeout(function(){b()},50)}var c=this,d=c.a.projectId,e=c.a.version;if(d){var f=c.c.o;p(this.c,(c.a.api||"https://fast.fonts.net/jsapi")+
"/"+d+".js"+(e?"?v="+e:""),function(e){e?a([]):(f["__MonotypeConfiguration__"+d]=function(){return c.a},b())}).id="__MonotypeAPIScript__"+d}else a([])};aa.prototype.load=function(a){var b,c,d=this.a.urls||[],e=this.a.families||[],f=this.a.testStrings||{},g=new z;b=0;for(c=d.length;b<c;b++)n(this.c,d[b],B(g));var h=[];b=0;for(c=e.length;b<c;b++)if(d=e[b].split(":"),d[1])for(var k=d[1].split(","),l=0;l<k.length;l+=1)h.push(new q(d[0],k[l]));else h.push(new q(d[0]));V(g,function(){a(h,f)})};var N="https://fonts.googleapis.com/css",
S={latin:"BESbswy","latin-ext":"\u00e7\u00f6\u00fc\u011f\u015f",cyrillic:"\u0439\u044f\u0416",greek:"\u03b1\u03b2\u03a3",khmer:"\u1780\u1781\u1782",Hanuman:"\u1780\u1781\u1782"},O={thin:"1",extralight:"2","extra-light":"2",ultralight:"2","ultra-light":"2",light:"3",regular:"4",book:"4",medium:"5","semi-bold":"6",semibold:"6","demi-bold":"6",demibold:"6",bold:"7","extra-bold":"8",extrabold:"8","ultra-bold":"8",ultrabold:"8",black:"9",heavy:"9",l:"3",r:"4",b:"7"},Ga={i:"i",italic:"i",n:"n",normal:"n"},
ua=/^(thin|(?:(?:extra|ultra)-?)?light|regular|book|medium|(?:(?:semi|demi|extra|ultra)-?)?bold|black|heavy|l|r|b|[1-9]00)?(n|i|normal|italic)?$/,La={Arimo:!0,Cousine:!0,Tinos:!0};oa.prototype.load=function(a){var b=new z,c=this.c,d=new E(this.a.api,this.a.text),e=this.a.families;va(d,e);var f=new Fa(e);xa(f);n(c,Ca(d),B(b));V(b,function(){a(f.a,f.c,La)})};ba.prototype.load=function(a){var b=this.a.id,c=this.c.o;b?p(this.c,(this.a.api||"https://use.typekit.net")+"/"+b+".js",function(b){if(b)a([]);
else if(c.Typekit&&c.Typekit.config&&c.Typekit.config.fn){b=c.Typekit.config.fn;for(var d=[],e=0;e<b.length;e+=2)for(var f=b[e],g=b[e+1],h=0;h<g.length;h++)d.push(new q(f,g[h]));try{c.Typekit.load({events:!1,classes:!1,async:!0})}catch(k){}a(d)}},2E3):a([])};t.prototype.load=function(a){var b=this.f.id,c=this.c.o,d=this;b?(c.__webfontfontdeckmodule__||(c.__webfontfontdeckmodule__={}),c.__webfontfontdeckmodule__[b]=function(b,c){for(var e=0,f=c.fonts.length;e<f;++e){var g=c.fonts[e];d.a.push(new q(g.name,
I("font-weight:"+g.weight+";font-style:"+g.style)))}a(d.a)},p(this.c,(this.f.api||"https://f.fontdeck.com/s/css/js/")+h(this.c)+"/"+b+".js",function(b){b&&a([])})):a([])};var Ba=new ia(window);Ba.a.c.custom=function(a,b){return new aa(b,a)};Ba.a.c.fontdeck=function(a,b){return new t(b,a)};Ba.a.c.monotype=function(a,b){return new ka(b,a)};Ba.a.c.typekit=function(a,b){return new ba(b,a)};Ba.a.c.google=function(a,b){return new oa(b,a)};var Ta={load:a(Ba.load,Ba)};"function"===typeof define&&define.amd?
define(function(){return Ta}):"undefined"!==typeof module&&module.exports?module.exports=Ta:(window.WebFont=Ta,window.WebFontConfig&&Ba.load(window.WebFontConfig))})();(function(b){b.fluxPlugin=function(c,a){function d(a,c,d){a=new b.BigVideo({useFlashForFirefox:!1,container:$a,doLoop:a});a.init();a.show(c,{ambient:d});return a}function f(a,d,e,g,h){d.each(function(k,l){if(k==a||E.preloadScenes){var m=b(this).data(),n=E.preloadScenes?N[O]:new TimelineMax({paused:!0});if(!m.sceneVideo&&m.sceneImage||ua&&m.sceneImage)m.trans=m.trans?m.trans:"fade-in-bg";m.alignment||(m.alignment="center-center");m.pursueVideo||(m.pursueVideo="yes");m.pursueImage||(m.pursueImage="no");
ua&&m.mobileAlignment&&(m.alignment=m.mobileAlignment);m.trans||(m.trans="none");ua&&m.mobileTrans&&(m.trans=m.mobileTrans);"undefined"==typeof m.freezeTime&&(m.freezeTime=E.globalFreeze);"undefined"==typeof m.transDur&&(m.transDur="default");var p,q="right-top top-right right-bottom bottom-right right-center center-right".split(" ");p=-1!="left-top top-left left-bottom bottom-left left-center center-left".split(" ").indexOf(m.alignment)?"halign-left":-1!=q.indexOf(m.alignment)?"halign-right":"halign-center";
q=b(this).find(".content-container");q.wrap("<div class='flux-scene "+p+"'><div class='centered "+m.alignment+"'></div></div>");p=q.find("h1");k==e-1&&(m.outDur="none",Ta=b(this).attr("id"));var r=b(this).prev();G(b(this),k,r,m,n);J(b(this),k,m,q,p,n);E.preloadScenes||(TweenMax.delayedCall(E.queueDelay,f,[a+1,d,e]),N[O].add(n.play()));if(0==a&&!E.preloadScenes||E.preloadScenes)if(!qb&&("video-bg"===R&&"youtube"===Qa||La&&0<M.length))ta.on("YTPReady YTPError",function(){b.isFunction(E.onTeaserReady)&&
E.onTeaserReady.call(c);b("body").addClass("set-overflow");!Da&&Ea&&ib&&b(".pl-sound").parent().hide();"video-bg"===R&&"youtube"===Qa&&Za.css({opacity:"0",visibility:"hidden"});g?(va="playing",aa.play(h)):(va="paused",aa.seek(h));b(this).off("YTPReady YTPError")});else!Da&&Ea&&ib&&b(".pl-sound").parent().hide(),b.isFunction(E.onTeaserReady)&&E.onTeaserReady.call(c),b("body").addClass("set-overflow"),"video-bg"===R&&"youtube"===Qa&&Za.css({opacity:"0",visibility:"hidden"}),g?(va="playing",aa.play(h)):
(va="paused",aa.seek(h));k!=e-1||E.preloadScenes||N[O].set({},{immediateRender:!1,onComplete:F})}})}function e(){w="xhr"===E.preloadMethod?new createjs.LoadQueue:new createjs.LoadQueue(!1);w.setMaxConnections(500);w.on("progress",k);w.on("fileload",l);w.on("complete",p);w.on("error",n);w.on("fileerror",h);Da&&!Ab&&(w.installPlugin(createjs.Sound),"tag"==E.preloadMethod&&createjs.Sound.registerPlugins([createjs.HTMLAudioPlugin]),createjs.Sound.alternateExtensions=["ogg"],w.loadFile({id:vb,family:"sound-file",
src:Fb,loadTimeout:E.audioTimeout}));0<u.length&&w.loadManifest(u)}function g(){Fa=!0;fa=createjs.Sound.play(vb);fa.loop=wa;isChrome&&!ua&&(fa.position=100);fa.on("complete",V);oa?N[O].paused()||ba?fa.paused=!0:B():fa.paused=!0}function k(a){a=Math.round(100*a.loaded);E.triggerProgress&&c.trigger("PLProgress",[a]);a>=E.initAfter&&Fa&&!U&&z()}function l(a){var c=a.item;a=a.result;switch(c.family){case "splash-image":Db.css("background-image","url("+c.src+")");break;case "preview-image":Za.css("background-image",
"url("+c.src+")");break;case "sound-file":Fa=!0;fa=createjs.Sound.play(vb);fa.loop=wa;fa.volume=0;isChrome&&!ua&&(fa.position=100);fa.on("complete",V);setTimeout(function(){100<fa.position&&(t=!0,b(".sound-info").hide(),b(".pl-sound").parent().removeClass("highlight"));fa.paused=!0},4);break;case "static-image":Ya=Ya.find("img");Ya.attr({src:c.src,width:a.naturalWidth,height:a.naturalHeight});break;case "scene-image":Ia.find("."+c.id+" img").attr({src:c.src,width:a.naturalWidth,height:a.naturalHeight})}}
function h(a){console.log(a)}function n(a){if("splash-image"==a.data.id){var b=w.getItem("splash-image");Db.css("background-image","url("+b.src+")")}"sound-file"==a.data.family&&(Fa=!0)}function p(a){U||z()}function z(){U+=1;E.autoStart&&t?c.trigger("STUnMuted"):c.trigger("STMuted");if(isFontActive)aa.init();else b(document).on("fontActive",function(){aa.init()})}function B(){fa.play();if("undefined"!==typeof fa){var a=Math.round(fa.duration),b=Math.round(1E3*N[O].totalTime().toFixed(1)/N[O].timeScale()),
d=b;0>wa&&b>a&&(d=b%a);fa.position=d;c.trigger("STUnMuted")}}function V(){xa=!0;fa.paused=!0;c.trigger("STMuted")}function m(){cb&&P.pause();sa&&sa.YTPPause()}function r(){cb&&P.play();sa&&sa.YTPPlay()}function q(a){cb&&P.currentTime(a);sa&&sa.YTPSeekTo(a)}function y(){Ja&&P.pause();eb&&sa.YTPPause()}function X(){Ja&&P.play();eb&&sa.YTPPlay()}function T(a,d,e){d.data().sceneImage&&(d=w.getItem(d[0].id).src,Za.css("background-image","url("+d+")"));Za.css({opacity:"1",visibility:"visible"});if("html5"===
e){Ja=!0;eb=!1;nb.css("visibility","visible");var f=b.grep(A,function(b){return b.sceneIndex==a});-1==P.currentSrc().indexOf(f[0].videoURL)&&cb.show(f[0].videoURL);P.off("timeupdate");P.off("ended");P.muted(f[0].mute);P.currentTime(f[0].startAt);P.muteEnabled=f[0].muteEnabled;if(kb)(1<A.length&&(kb=!1),L(),P.on("timeupdate",function(){if(0!=f[0].stopAt&&P.currentTime()>=f[0].stopAt||0==f[0].stopAt&&P.currentTime()>=P.duration())f[0].loop?(P.loop(!0),P.currentTime(f[0].startAt),P.play()):(Ja=!1,P.pause())}),
P.play(),E.autoStart||P.muteEnabled)?t&&!P.muteEnabled&&(c.trigger("STUnMuted"),P.muted(!1),P.volume(E.videoVolume)):(c.trigger("STUnMuted"),P.muted(!1),P.volume(E.videoVolume));else P.one("loadeddata",function(){L();P.on("timeupdate",function(){if(0!=f[0].stopAt&&P.currentTime()>=f[0].stopAt||0==f[0].stopAt&&P.currentTime()>=P.duration())f[0].loop?(P.loop(!0),P.currentTime(f[0].startAt),P.play()):(Ja=!1,P.pause())});P.play();E.autoStart||P.muteEnabled?t&&!P.muteEnabled&&(c.trigger("STUnMuted"),P.muted(!1),
P.volume(E.videoVolume)):(c.trigger("STUnMuted"),P.muted(!1),P.volume(E.videoVolume))})}else(Ja=!1,eb=!0,f=b.grep(M,function(b){return b.sceneIndex==a}),f[0].videoURL==ta[0].opt.videoURL)?(L(),sa.YTPSeekTo(f[0].startAt),tb.css("visibility","visible"),sa.YTPPlay(),E.autoStart||f[0].muteEnabled)?t&&!f[0].muteEnabled&&(c.trigger("STUnMuted"),sa.YTPUnmute(),ta.isMute=!1):(c.trigger("STUnMuted"),sa.YTPUnmute(),ta.isMute=!1):(f[0].autoPlay=!0,sa.changeMovie(f[0]),ta.one("YTPReady",function(){L();b(this).YTPSeekTo(f[0].startAt);
tb.css("visibility","visible");b(this).YTPPlay();E.autoStart||f[0].muteEnabled?t&&!f[0].muteEnabled&&(c.trigger("STUnMuted"),sa.YTPUnmute(),ta.isMute=!1):(c.trigger("STUnMuted"),sa.YTPUnmute(),ta.isMute=!1)}))}function L(){Za.css({opacity:"0",visibility:"hidden"})}function I(){oa=!0;b.isFunction(E.onTeaserStart)&&E.onTeaserStart.call(c);wb.hide();E.freezeOnBlur&&(ifvisible.on("blur",function(){aa.freezeTeaser()}),ifvisible.on("focus",function(){aa.continueTeaser()}));"undefined"!==typeof fa&&((!ua||
ua&&!E.autoStart)&&xb&&"paused"!=Ha||"playing"===Ha?(B(),t?(fa.volume=E.standaloneAudioVolume,fa.paused=!1,c.trigger("STUnMuted"),Ha="playing"):(fa.volume=E.standaloneAudioVolume,fa.paused=!0,c.trigger("STMuted"),Ha="paused")):(fa.volume=E.standaloneAudioVolume,fa.paused=!0,c.trigger("STMuted"),Ha="paused"));"single-image"===R&&Ma.paused()&&Ma.resume();"video-bg"!==R||(q(rb),"youtube"===Qa&&tb.css("visibility","visible"),r(),Da)||("undefined"==typeof P||Ea?"undefined"==typeof ta||Ea||(E.autoStart?
ta.isMute?c.trigger("STMuted"):c.trigger("STUnMuted"):(c.trigger("STUnMuted"),sa.YTPUnmute(),ta.isMute=!1)):E.autoStart?P.muted()?c.trigger("STMuted"):c.trigger("STUnMuted"):(c.trigger("STUnMuted"),P.muted(!1),P.volume(E.videoVolume)))}function F(){ba=!0;c.trigger("STEnd");"undefined"!==typeof fa&&Va&&V();("video-bg"===R&&Ka||"assorted"===R&&E.stopTeaserOnEnd)&&m();b.isFunction(E.onTeaserEnd)&&E.onTeaserEnd.call(c)}function C(){Ma.pause()}function K(a){"single-image"===R&&a.set(Ya,{autoAlpha:0,onComplete:C,
onCompleteParams:[]});"video-bg"===R&&a.set($a,{visibility:"hidden",onComplete:m,onCompleteParams:[]})}function G(a,c,d,e,f){var g=e.trans,h=e.transDur,k=a.attr("id"),l,m=!1;0==c?(d=b(".extinct"),l="flux-nothing"):l=d.attr("id");if("no"==e.pursueImage){var n=Ia.find("."+k+" img");l=Ia.find("."+l+" img, ."+ya+" img");ja=n;ya=k}else n=ja,l=b(".flux-not-found");La&&(e.sceneVideo||e.sceneImage&&"no"===e.pursueVideo||"no"===e.pursueVideo)&&(m=!0);f.addLabel(k+"-before");var p,q;p=a.find(".bt-container");
if(0<p.length){var r=p.data().xStart?p.data().xStart:"-100%",t=p.data().fontMax?parseInt(p.data().fontMax):728;p.wrapInner("<div class='bt-wrapper'></div>");q=p.find(".bt-wrapper");q.bigtext({childSelector:"h1",maxfontsize:t,resize:!1});f.set(p,{x:r})}h="default"==h?1.4:parseFloat(h);h/=2;p=b.grep(fluxTransitions.vegas,function(a){return a.name==g});0!=c&&b.grep(fluxTransitions.vegas,function(a){return a.name==d.data().trans});"fade-screen"==p[0].template?(f.to(Bb,h,{autoAlpha:1,ease:Linear.easeNone}),
K(f),f.set(d,{display:"none"}),m&&f.addLabel("hideP-"+c),0<n.length&&f.set(n,{autoAlpha:1})):("none"!=g&&K(f),f.set(d,{display:"none"}),m&&f.addLabel("hideP-"+c));f.set(a,{visibility:"visible"});q=p[0].type?p[0].type:"throughout";r=p[0].alphaDuration?parseFloat(p[0].alphaDuration):.95;p[0].in[0].to.ease||(p[0].in[0].to.ease=Linear.easeNone);p[0].out&&!p[0].out[0].to.ease&&(p[0].out[0].to.ease=Linear.easeNone);"prior"==q&&(k+="-prior",f.addLabel(k+"-label"));S[k]=new TimelineMax;S[k+"-alpha"]=new TimelineMax;
"no"==e.pursueImage&&S[k+"-alpha"].to(n,r,{autoAlpha:1},0);"fade-screen"==p[0].template&&S[k+"-alpha"].to(Bb,h,{autoAlpha:0},0);S[k].data={};S[k].data.duration=p[0].in[0].duration?p[0].in[0].duration:"full";S[k].fromTo(n,1.08,p[0].in[0].from,p[0].in[0].to,0);0<l.length&&S[k+"-alpha"].set(l,{autoAlpha:0});"prior"==q&&(h=p[0].in[0].duration?p[0].in[0].duration:1.5,f.add(S[k+"-alpha"],k+"-label"),f.add(S[k].duration(h),k+"-label"));m&&f.set({},{immediateRender:!1,onStart:Q,onStartParams:[]},"hideP-"+
c);La&&e.sceneVideo&&f.set({},{immediateRender:!1,onComplete:T,onCompleteParams:[c,a,e.videoType]})}function Q(){sa&&(eb=!1,tb.css("visibility","hidden"));nb&&(Ja=!1,nb.css("visibility","hidden"));m()}function J(a,c,d,e,f,g){var h=W(a,d,e,f),k=pa(!1),l,m=0,n=d.cinOrder?d.cinOrder:"onebyone",p=d.cinDelay?parseFloat(d.cinDelay):.25,q=d.coutOrder?d.coutOrder:n,r=d.coutDelay?parseFloat(d.coutDelay):p,t=d.cinPattern?d.cinPattern:"sequential",u=d.coutPattern?d.coutPattern:"reverse";f=f.get().slice(0);t=
sortArray(t,f);u=sortArray(u,f);b.each(t,function(a,c){if(0<a)var d="cont-in-"+m;var e=b(c).data("order");m=e;var f="cont-in-"+e;k[f]=new TimelineMax;var g=D(b(c),e,h,"in");ea(b(c),e,h,g,N[O],k,k[f],"in");g.duration&&k[f].duration(g.duration);g.timeScale&&k[f].timeScale(g.timeScale);l="onebyone"==n?"+=0":"sync"==n?0:"delayed"==n?a*p:0==a?"+=0":"-="+(k[d].duration()-k[d].duration()*p);k["in"].add(k[f],l)});"none"!=d.outDur&&b.each(u,function(a,c){if(0<a)var d="cont-out-"+m;var e=b(c).data("order");
m=e;var f="cont-out-"+e;k[f]=new TimelineMax;var g=D(b(c),e,h,"out");ea(b(c),e,h,g,N[O],k,k[f],"out");g.duration&&k[f].duration(g.duration);g.timeScale&&k[f].timeScale(g.timeScale);l="onebyone"==q?"+=0":"sync"==q?0:"delayed"==q?a*r:0==a?"+=0":"-="+(k[d].duration()-k[d].duration()*r);k.out.add(k[f],l)});N[O].set(e,{visibility:"visible"});N[O].addLabel(h.marker);ka(a,k,c,d,h.marker,e,!1,g)}function W(a,c,d,e){var f={};f.marker=a.attr("id");var g=a.find(".centered"),h=g.css("max-width");0<=h.indexOf("%")&&
(h=parseFloat(h)/100,h=Math.ceil(Ba*h)+"px");a=a.children();var k;a.hasClass("halign-left")?(k="place-left",f.slideAlignment="halign-left"):a.hasClass("halign-right")?(k="place-right",f.slideAlignment="halign-right"):(k="place-center",f.slideAlignment="halign-center");a=qa(d);var l=0;e.each(function(a,e){b(this).data("order",a);f["content"+a]=b(this);var g=qa(b(this)),m=b(this).data().align?"place-"+b(this).data().align:k,n=b(this).data().boxType?b(this).data().boxType:"contain",p=b(this).data().delimiter?
b(this).data().delimiter:" ",q,r,t="nowrap"==b(this).css("white-space")?!0:!1;q=b(this).data().sin?readCustomOptions(b(this).data().sin):{animation:"fade-in"};b(this).data().sout?r=readCustomOptions(b(this).data().sout):(c.outDur="none",r={animation:"zero-dur"});var u=q.animation,v=r.animation,u=fluxAnimations[u]?fluxAnimations[u]:fluxAnimations["fade-in"],v=fluxAnimations[v]?fluxAnimations[v]:fluxAnimations["fade-out"];f["inConfig"+a]=u;f["outConfig"+a]=v;u.inherit&&(f["inConfig"+a]=b.extend(!0,
{},fluxAnimations[u.inherit],f["inConfig"+a]));v.inherit&&(f["outConfig"+a]=b.extend(!0,{},fluxAnimations[v.inherit],f["outConfig"+a]));var x;x=E.easeOuterGPU?"":"gpu-hack";b(this).wrap("<div class='content-wrapper "+x+" content-wrapper-"+a+"' style='position:relative;width:100%;'></div>");f["wrapper"+a]=d.find(".content-wrapper-"+a);"contain"===n&&b(this).css("display","inline-block");b(this).css({display:"block",position:"absolute",width:h,height:Math.ceil(b(this).outerHeight())+"px"}).addClass("place-left");
n=[f["inConfig"+a].animateBy,f["outConfig"+a].animateBy];if("whole"==q.animateBy&&"whole"==r.animateBy||"whole"==u.animateBy&&"whole"==v.animateBy||b(this).find("img, a").length||"glitch"==q.animation){var w;t&&(m+=" tof-fix");b(this).removeClass("place-left").addClass(m);(isFirefox||isEdge||isIE)&&TweenMax.set(b(this),{rotationZ:"0.01deg"});f["wrapper"+a].css({height:Math.ceil(b(this).outerHeight())+"px"});w=Math.ceil(b(this).outerWidth());w>l&&(l=w)}else{q=-1<n.indexOf("chars")?"words,chars,lines":
"words,lines";r=E.easeOuterGPU?"":"gpu-hack";f["split"+a]=new SplitText(b(this),{type:q,wordsClass:"s-word "+r+" flux-word-++",charsClass:"s-char flux-char-++",linesClass:"s-line "+r+" flux-line-++",wordDelimiter:p,position:"absolute"});gb&&TweenMax.set(f["split"+a].chars,{force3D:!0,rotationZ:"0.01deg"});b(this).removeClass("place-left").addClass(m);w=0;var y,da,Wa=f["split"+a].lines.length;b.each(f["split"+a].lines,function(a,c){var d=b(c).children().last();y=parseInt(d.css("left"))+parseInt(d.css("width"));
b(c).css({width:y+"px",right:g.padRight+"px"}).addClass(m);y>w&&(w=y);a==Wa-1&&(da=parseInt(b(this).css("top"))+parseInt(b(this).css("height")))});b(this).css({width:w+g.horz+"px",height:da+g.padBottom+"px"});f["wrapper"+a].css({height:da+g.padBottom+g.marTop+g.marBottom+"px"});w>l&&(l=w+g.horz)}});d.css({width:l+a.horz+"px"});g.css({"max-width":l+a.horz+"px"});return f}function D(a,c,d,e){var f={},g,h,k=d["split"+c];"in"==e?(e=readCustomOptions(a.data().sin),g=d["inConfig"+c],h="fade-in"):(e=readCustomOptions(a.data().sout),
g=d["outConfig"+c],h="fade-out");f.animTitle=e.animation?e.animation:h;f.animTemplate=e.template?e.template:g.template;"rotator"==f.animTemplate?(g=b.extend({},fluxDefaults.rotator,g),d["outConfig"+c]=b.extend({},fluxDefaults.rotator,{template:"rotator"})):g=b.extend({},fluxDefaults.basic,g);f.pattern=e.pattern?e.pattern:g.pattern;f.ease=e.ease?parseEase(e.ease):g.ease;f.staggerDelay=e.staggerDelay?parseFloat(e.staggerDelay):g.staggerDelay;f.staggerDur=e.staggerDur?parseFloat(e.staggerDur):g.staggerDur;
f.splitType=e.animateBy?e.animateBy:g.animateBy;f.duration=e.duration?parseFloat(e.duration):g.duration;f.timeScale=e.timeScale?parseFloat(e.timeScale):g.timeScale;f.wrapSplit=e.wrapSplit?parseBool(e.wrapSplit):g.wrapSplit;f.firstIn=e.firstIn?parseBool(e.firstIn):g.firstIn;f.lastOut=e.lastOut?parseBool(e.lastOut):g.lastOut;f.rotFreeze=e.rotFreeze?parseFloat(e.rotFreeze):g.rotFreeze;f.overlapTime=e.overlapTime?parseFloat(e.overlapTime):g.overlapTime;f.perspective=g.perspective?g.perspective:"none";
f.addTweens=g.addTweens?g.addTweens:"none";a.find("img, a").length&&(f.splitType="whole");if(f.wrapSplit&&"whole"!=f.splitType){var l=[],m,n,p;b.each(k[f.splitType],function(a,c){m="mod-sub el-sub-"+(a+1);b(c).find(".mod-sub").length||(b(c).css("overflow","hidden"),n=b(c).outerWidth(),p=b(c).outerHeight(),b(c).wrapInner("<div class='"+m+"' style='width: "+n+"px; height: "+p+"px'></div>"),l.push(b(c).find(".el-sub-"+(a+1))[0]))});k[f.splitType]=l}return f}function ea(a,b,c,d,e,f,g,h){var k=d.animTemplate;
switch(k){case "basic":Z(a,b,c,d,e,g,h);break;case "misc":"in"==h&&ha(a,b,c,d,e,f,g,"in");break;case "rotator":"in"==h&&na(a,b,c,d,e,g,"in");break;default:console.log('Please check your custom animation "'+k+'" have "template" mentioned in flux-animations.js'),Z(a,b,c,d,e,g,h)}}function Z(a,c,d,e,f,g,h){a=ca(c,e,d);h=ia(c,h,d,{},{});var k=h.from,l=h.to,m={},n={};Y(e.addTweens,d["content"+c],f,a);if(is.obj(k.opacity)||is.obj(l.opacity))m.opacity=is.obj(k.opacity)?k.opacity.value:k.opacity,n.opacity=
is.obj(l.opacity)?l.opacity.value:l.opacity,k.opacity.ease&&(m.ease=parseEase(k.opacity.ease)),inToObj.opacity.ease&&(n.ease=parseEase(l.opacity.ease));var p="basic-"+c,q=a.length;b.each(a,function(a,c){var d=la(a,c,q,e.staggerDelay,!0),f=la(a,c,q,e.staggerDur,!1),h=p+"+="+d,r={},t={};b.each(k,function(b,d){x(a,c,q,b,d,r,m,g,h)});b.each(l,function(b,d){x(a,c,q,b,d,t,n,g,h)});b.isEmptyObject(m)||g.fromTo(b(c),f,m,n,h);g.fromTo(b(c),f,r,t,h)})}function na(a,c,d,e,f,g,h){a=d["split"+c].lines;var k=a.length;
h=d["wrapper"+c].outerHeight()/k;1<k&&(f.set([d["wrapper"+c],d["content"+c]],{height:h+"px"}),f.set(a,{top:"0px",perspective:e.perspective}));Y(e.addTweens,d["content"+c],f,a);var l=d["inConfig"+c].rotIn.addTweens,m=d["inConfig"+c].rotOut.addTweens,n=d["inConfig"+c].rotIn.staggerDelay,p=d["inConfig"+c].rotIn.staggerDur,q=d["inConfig"+c].rotOut.staggerDelay,r=d["inConfig"+c].rotOut.staggerDur,t=d["inConfig"+c].rotIn.from,u=d["inConfig"+c].rotIn.to,v=d["inConfig"+c].rotOut.from,w=d["inConfig"+c].rotOut.to,
y={},z={};if(is.obj(t.opacity)||is.obj(u.opacity))y.opacity=is.obj(t.opacity)?t.opacity.value:t.opacity,z.opacity=is.obj(u.opacity)?u.opacity.value:u.opacity,t.opacity.ease&&(y.ease=parseEase(t.opacity.ease)),u.opacity.ease&&(z.ease=parseEase(u.opacity.ease));b.each(a,function(a,c){var d=k;if("words"==e.splitType)var f=b(c).find(".s-word"),d=f.length;else if("chars"==e.splitType)f=b(c).find(".s-char"),d=f.length;else var f=b(c),h=a;var Oa="rotator-"+a,da="rotator-"+(a+1),f=b.map(f,function(a,b){return[a]}),
f=sortArray(e.pattern,f);(0<a||0==a&&e.firstIn)&&b.each(f,function(a,c){h&&(a=h);var e=la(a,c,d,n,!0),f=la(a,c,d,p,!1),e=Oa+"+="+e,k={},m={};b.each(t,function(b,e){x(a,c,d,b,e,k,y)});b.each(u,function(b,e){x(a,c,d,b,e,m,y)});b.isEmptyObject(y)||g.fromTo(b(c),f,y,z,e);g.fromTo(b(c),f,k,m,e);ma(a,c,d,l,g,e)});if(a!=k-1||e.lastOut&&a==k-1){var A=la(a,c,d,e.rotFreeze,!1);g.set({},{},"+="+A);b.each(f,function(a,c){h&&(a=h);var e=la(a,c,d,q,!0),f=la(a,c,d,r,!1),e=da+"+="+e,k={},l={};b.each(v,function(b,
e){x(a,c,d,b,e,k,{})});b.each(w,function(b,e){x(a,c,d,b,e,l,{})});g.fromTo(b(c),f,k,l,e);ma(a,c,d,m,g,e)})}})}function ha(a,c,d,e,f,g,h,k){a=d["content"+c];c=d["wrapper"+c];if(100>a.outerHeight()){d=Math.ceil(a.outerHeight()-1);var l=1}else d=99,l=Math.ceil(a.outerHeight()/100);var m=a.outerWidth();for(e=0;e<d;e++)c.append(a.clone());d=c.find("h1");d.each(function(a,c){f.set(b(c),{position:"absolute",left:0,top:0,x:0,opacity:1,clip:"rect("+l*a+"px, "+m+"px, "+l*(a+1)+"px, 0px)"})});f.set(c,{autoAlpha:0});
g["in"].to(c,.75,{autoAlpha:1},0);d.each(function(a,c){g.repeat.to(b(this),.1,{x:randomInt(-5,5),opacity:randomFloat(.8,1),ease:RoughEase.ease.config({strength:5,points:50,template:SlowMo.ease,clamp:!1,taper:"out"})},0)});g["in"].add(g.repeat,"+=0.2");H(g["in"],g.repeat,d,1,!1,"+=0.1");H(g["in"],g.repeat,d,.5,!1,"+=0.4");H(g["in"],g.repeat,d,.5,!0,"+=3");H(g["in"],g.repeat,d,.5,!1,"+=0.4");H(g["in"],g.repeat,d,.5,!1,"+=2");g["in"].to(d,.25,{x:0,opacity:1,ease:RoughEase.ease.config({strength:5,points:50,
template:SlowMo.ease,clamp:!1,taper:"out"})});g["in"].set(d,{x:0,opacity:1})}function H(a,b,c,d,e,f){a.to(c,.25,{x:0,opacity:1,ease:RoughEase.ease.config({strength:5,points:50,template:SlowMo.ease,clamp:!1,taper:"out"})});a.add(b.tweenFromTo(0,b.duration()).timeScale(d),f)}function x(a,c,d,e,f,g,h,k,l){if("opacity"!=e||b.isEmptyObject(h))"addTweens"==e&&is.fnc(f)?f(a,c,d,k,l):g[e]=is.fnc(f)?f(a,c):f}function la(a,b,c,d,e){return e?is.fnc(d)?d(a,b,c):is.arr(d)?d[a]?d[a]:d[0]:a*d:is.fnc(d)?d(a,b,c):
is.arr(d)?d[a]?d[a]:d[0]:d}function ma(a,b,c,d,e,f){is.fnc(d)&&d(a,b,c,e,f)}function Y(a,b,c,d){is.fnc(a)&&a(b,c,d)}function ca(a,b,c){a="lines"==b.splitType?c["split"+a].lines.slice(0):"words"==b.splitType?c["split"+a].words.slice(0):"chars"==b.splitType?c["split"+a].chars.slice(0):c["content"+a];Array.isArray(a)&&(a=sortArray(b.pattern,a));return a}function ia(a,c,d,e,f){var g={};"in"==c?d["inConfig"+a].rotIn?(g.from=b.extend({},e,d["inConfig"+a].rotIn.from),g.to=b.extend({},f,d["inConfig"+a].rotIn.to)):
(g.from=b.extend({},e,d["inConfig"+a].from),g.to=b.extend({},f,d["inConfig"+a].to)):d["outConfig"+a].rotOut?(g.from=b.extend({},e,d["outConfig"+a].rotOut.from),g.to=b.extend({},f,d["outConfig"+a].rotOut.to)):(g.from=b.extend({},e,d["outConfig"+a].from),g.to=b.extend({},f,d["outConfig"+a].to));return g}function qa(a){var b={};b.padTop=parseInt(a.css("padding-top"));b.padRight=parseInt(a.css("padding-right"));b.padBottom=parseInt(a.css("padding-bottom"));b.padLeft=parseInt(a.css("padding-left"));b.borTop=
parseInt(a.css("border-top-width"));b.borRight=parseInt(a.css("border-right-width"));b.borBottom=parseInt(a.css("border-bottom-width"));b.borLeft=parseInt(a.css("border-left-width"));b.marTop=parseInt(a.css("margin-top"));b.marRight=parseInt(a.css("margin-right"));b.marBottom=parseInt(a.css("margin-bottom"));b.marLeft=parseInt(a.css("margin-left"));b.horz=b.padLeft+b.padRight+b.borLeft+b.borRight;b.vert=b.padTop+b.padBottom+b.borTop+b.borBottom;return b}function pa(a){var b={};b.in=new TimelineMax;
b.out=new TimelineMax;b.full=new TimelineMax;a&&(b.repeat=new TimelineMax);return b}function ka(a,d,e,f,g,h,k,l){var m="default"==f.freezeTime?1.5:parseFloat(f.freezeTime),n=f.sceneDelay?parseFloat(f.sceneDelay):0;d.full.addLabel(g+"-beforeIn");d.full.add(d["in"],"+="+n);d.full.addLabel(g+"-beforeFreeze");d.full.addLabel(g+"-beforeOut","+="+m);"none"!=f.outDur?(d.full.add(d.out,g+"-beforeOut"),d.full.set(h,{visibility:"hidden"})):d.full.set({},{immediateRender:!1},g+"-beforeOut");c.hasClass("animate-colors")&&
(h=e%E.colors.length,d.full.to(Cb,d.full.duration(),{backgroundColor:E.colors[h]},0));k&&d.full.set({},{immediateRender:!1,onComplete:function(){d.repeat.resume()}});f.sceneDur&&d.full.duration(parseFloat(f.sceneDur));var p={};k=d.full.timeScale();p.in=d["in"].duration()/d["in"].timeScale()/k;p.out=d.out.duration()/d.out.timeScale()/k;p.full=d.full.duration()/k;p.freeze=m/k;E.showAnimationSummary&&(m="in: "+p.in.toFixed(1)+"s<br/> out: "+p.out.toFixed(1)+"s<br/> freeze: "+p.freeze.toFixed(1)+"s<br/> scene: "+
p.full.toFixed(1)+"s",d.full.set(Gb,{text:m},.1));m=a.find(".bt-container");if(0<m.length){k=m.data().animate?m.data().animate:"yes";h=m.data().xEnd?m.data().xEnd:"0%";var n=m.data().dur?parseFloat(m.data().dur):d["in"].duration(),q=m.data().ease?parseEase(m.data().ease):Power4.easeOut;"yes"===k?l.to(m,n,{x:h,ease:q,force3D:!0,rotationZ:"0.01deg"},g):l.set(m,{x:"0%"},g)}l.add(d.full,g);Ua="no"==f.pursueImage?p.full:Ua+p.full;S[g]&&(l.add(S[g+"-alpha"],g),"full"==S[g].data.duration?l.add(S[g].duration(Ua),
"-="+Ua):"in"==S[g].data.duration?l.add(S[g].duration(p.in),g):l.add(S[g].duration(S[g].data.duration),g),Ua=0);l.set({},{immediateRender:!1,onComplete:function(){b.isFunction(E.onBeforeScene)&&E.onBeforeScene.call(c,e,a,p,Sa)}},g+"-before");d.full.set({},{immediateRender:!1,onComplete:function(){b.isFunction(E.onBeforeIn)&&E.onBeforeIn.call(c,e,a,p,Sa)}},g+"-beforeIn");d.full.set({},{immediateRender:!1,onComplete:function(){b.isFunction(E.onBeforeFreeze)&&E.onBeforeFreeze.call(c,e,a,p,Sa)}},g+"-beforeFreeze");
"none"!=f.outDur&&d.full.set({},{immediateRender:!1,onComplete:function(){b.isFunction(E.onBeforeOut)&&E.onBeforeOut.call(c,e,a,p,Sa)}},g+"-beforeOut");l.set({},{immediateRender:!1,onComplete:function(){b.isFunction(E.onAfterScene)&&E.onAfterScene.call(c,e,a,p,Sa)}},g+"-after")}var aa=this,E=b.extend({},{autoStart:!0,fullDuration:"default",globalFreeze:0,letterBoxing:!0,triggerProgress:!1,queueDelay:.05,force3DOnDevices:!1,easeOuterGPU:!1,preloadScenes:!1,waitForLoad:!1,forceLoadOnClick:!1,forceFallback:!0,
...
a),va="playing",Ca=!0,Fa=!1,xa=!1,oa=!1,ba=!1,t=E.autoStart?!1:!0,w,u=[],A=[],M=[],R,N={},S={},O=c.attr("id"),Ga,ua=isMobile.any,La=ua&&!E.videoOnMobiles?!1:!0,Ba=b(window).width(),Ta,v=0,U=0,Sa,ja,ya="flux-default",Ua=0,gb=!0,za="",Da=c.attr("data-enable-sound")?parseBool(c.attr("data-enable-sound")):!1,ra=c.attr("data-sound-loop")?parseBool(c.attr("data-sound-loop")):!1,xb=c.attr("data-auto-play-sound")?parseBool(c.attr("data-auto-play-sound")):!0,Va=c.attr("data-auto-stop-sound")?parseBool(c.attr("data-auto-stop-sound")):
!1,Ha,wa,mb,Ma,Aa=c.attr("data-static-image")?parseBool(c.attr("data-static-image")):!1,hb=c.attr("data-mobile-image")?parseBool(c.attr("data-mobile-image")):!1,ab=c.data().staticImagePos?c.data().staticImagePos:"center center",jb=c.data().zoomOrigin?c.data().zoomOrigin:"center center",bb=c.data().zoomType?c.data().zoomType:"in",sb=c.data().zoomDur?parseFloat(c.data().zoomDur):"auto",db=c.data().zoomScale?parseFloat(c.data().zoomScale):!1,ob=c.attr("data-splash-image")?parseBool(c.attr("data-splash-image")):
!1,pb=c.attr("data-placeholder-image")?parseBool(c.attr("data-placeholder-image")):"images/1x1.png",kb=!1,Na=!1,Ja=!1,eb=!1,qb=!1,Qa=c.data().videoType?c.data().videoType:"html5",Ea=c.attr("data-video-mute")?parseBool(c.attr("data-video-mute")):!0,ib=!0,zb=c.data().videoQuality?c.data().videoQuality:"highres",rb=c.data().videoStart?parseInt(c.data().videoStart):0,fb=c.data().videoStop?parseInt(c.data().videoStop):0,Xa=c.attr("data-video-loop")?parseBool(c.attr("data-video-loop")):!0,Ka=c.attr("data-auto-stop-video")?
parseBool(c.attr("data-auto-stop-video")):!1,Ab=isMobile.apple.device&&E.forceLoadOnClick||ua&&E.autoStart,ub="click";isMobile.apple.device&&(ub="touchstart");isMobile.any&&E.forceFallback&&(za="vid-fallback");R=c.data().staticVideo&&La?"video-bg":Aa||hb?"single-image":"assorted";wa=ra?-1:0;ua&&c.data().mobileSound&&(Da=c.data().mobileSound);Ea=Da?!0:Ea;ua&&!E.force3DOnDevices&&(gb=!1);ua&&hb&&(Aa=hb);var Ra="<div class='slideshow-wrapper abs-fs'><div class='slideshow-overlay abs-fs'></div></div>";
"single-image"===R?(ua&&(ab=c.data().mobileImagePos?c.data().mobileImagePos:"center center"),ab=ab.split(" "),u.push({id:"static-image",family:"static-image",alignX:ab[0],alignY:ab[1],src:Aa,loadTimeout:E.fileTimeout}),Ra=Ra+"<div class='single-wrapper abs-fs'><div class='single-overlay abs-fs'></div><div class='single-image abs-fs'><img src='"+pb+"' width='1' height='1' data-object-fit='cover' data-object-position='"+ab[0]+" "+ab[1]+"' alt=''/></div></div><div class='black-bg abs-fs'></div>"):("video-bg"===
R&&Aa&&u.push({id:"preview-image",family:"preview-image",src:Aa,loadTimeout:E.fileTimeout}),Ra+="<div class='black-bg gpu-hack abs-fs'></div>");E.letterBoxing&&(Ra+="<div class='lbox-top'></div><div class='lbox-bottom'></div>");Ra=Ra+"<div class='video-wrapper "+za+" abs-fs'><div class='preview-image abs-fs bg-cover'></div></div><div class='splash-wrapper abs-fs'><div class='splash-overlay abs-fs'></div><div class='splash-image abs-fs bg-cover'></div></div><div class='color-wrapper gpu-hack abs-fs'></div>";
E.showAnimationSummary&&(Ra+="<div id='summary-handle'><i class='fa fa-info'></i></div><div id='summary-container'><div class='details'><h3 class='animation-name'></h3><p class='scene-info'></p><h3 class='total-duration'></h3></div></div>");c.wrap("<div class='flux-wrapper'></div>").after(Ra);var Pa=c.parent(),Ia=Pa.find(".slideshow-wrapper"),Ya=Pa.find(".single-image"),Bb=Pa.find(".black-bg"),Za=Pa.find(".preview-image"),$a=Pa.find(".video-wrapper"),Cb=Pa.find(".color-wrapper"),wb=Pa.find(".splash-wrapper"),
Db=wb.find(".splash-image");E.autoStart&&(ob=!1,wb.hide());c.hasClass("animate-colors")&&Cb.css({"background-color":E.colors[0]});var Eb=Pa.find("#summary-handle");Pa.find("#summary-container .animation-name");var Gb=Pa.find("#summary-container .scene-info"),Hb=Pa.find("#summary-container .total-duration");ob&&u.push({id:"splash-image",family:"splash-image",src:ob,loadTimeout:E.fileTimeout});0<E.preloadFiles.length&&b.each(E.preloadFiles,function(a,b){u.push({src:b,family:"user-files",loadTimeout:E.fileTimeout})});
c.find(".flux-slide").each(function(a,c){var d;if(b(this).data().sceneImage||b(this).data().mobileImage){b(this).data().sceneImage&&(d=b(this).data().sceneImage);ua&&b(this).data().mobileImage&&(d=b(this).data().mobileImage);if(d){var e;e=ua?b(this).data().mobileImagePos?b(this).data().mobileImagePos:"center center":b(this).data().sceneImagePos?b(this).data().sceneImagePos:"center center";e=e.split(" ");u.push({id:b(this)[0].id,family:"scene-image",src:d,alignX:e[0],alignY:e[1],loadTimeout:E.fileTimeout})}La&&
...
0;f=b(this).data().videoStop?parseInt(b(this).data().videoStop):0;g=b(this).attr("data-video-loop")?parseBool(b(this).attr("data-video-loop")):!1;e={autoPlay:!1,showYTLogo:!1,stopMovieOnBlur:!1,showControls:!1,opacity:1,videoURL:b(this).data().sceneVideo,containment:"."+$a[0].className.split(" ")[0],quality:h,mute:!0,muteEnabled:d,startAt:e,stopAt:f,loop:g,sceneIndex:a};M.push(e);ib&&!d&&(ib=!1)}});if(La&&(0<A.length||0<M.length||"video-bg"===R)){if("video-bg"===R&&"html5"===Qa||0<A.length){var cb,
P,nb;"video-bg"===R&&"html5"===Qa?(Za.css({opacity:"1",visibility:"visible"}),cb=d(Xa,c.data().staticVideo,!0),P=cb.getPlayer(),P.off("ended"),P.currentTime(rb),P.on("loadeddata",function(){!t||Ea||oa||(P.muted(!1),P.volume(E.videoVolume));nb.css("visibility","visible");TweenMax.to(Za,.5,{autoAlpha:0});P.on("timeupdate",function(){if(0!=fb&&P.currentTime()>=fb||0==fb&&P.currentTime()>=P.duration())Xa?(P.loop(!0),P.currentTime(rb),P.play()):(Na=!0,P.pause())})})):(cb=d(A[0].loop,A[0].videoURL,A[0].mute),
P=cb.getPlayer(),P.off("ended"),P.currentTime(A[0].startAt),P.one("loadeddata",function(){kb=!0;!t||A[0].muteEnabled||oa||(P.muted(!1),P.volume(E.videoVolume))}));nb=$a.find("#big-video-wrap");nb.append("<div class='bv-overlay abs-fs'></div>")}if("video-bg"===R&&"youtube"===Qa||0<M.length){"video-bg"===R&&"youtube"===Qa?(Za.css({opacity:"1",visibility:"visible"}),$a.append("<div id='bgndVideo' class='player' data-property='{showYTLogo: false, loop: "+Xa+', stopMovieOnBlur: false, quality: "'+zb+'",showControls: false, videoURL: "'+
c.data().staticVideo+'", containment:".'+$a[0].className.split(" ")[0]+'", autoPlay: false, mute: true, startAt: '+rb+", stopAt: "+fb+", opacity: 1}'>My video</div>")):$a.append("<div id='bgndVideo' class='player' data-property="+JSON.stringify(M[0])+">My video</div>");var sa=$a.find("#bgndVideo"),tb,ta=sa.YTPlayer({onError:function(a,b){ta.trigger("YTPError");qb=!0}});ta.isMute=!0;var yb=0;ta.on("YTPTime",function(){0==yb&&(yb+=1,setTimeout(function(){qb=!0;ta.trigger("YTPError")},E.videoTimeout))});
ta.on("YTPReady",function(){tb=$a.find(".mbYTP_wrapper");qb=!0;t&&!oa&&("video-bg"==R&&!Ea||0<M.length&&!M[0].muteEnabled)&&(sa.YTPUnmute(),ta.isMute=!1)});ta.on("YTPEnd",function(){"video-bg"===R?Na=!0:eb=!1})}}var Fb=Da,vb="sound-"+O,fa;Da&&Ab&&(b(".sound-info").show(),window.addEventListener(ub,function Oa(){"tag"==E.preloadMethod&&createjs.Sound.registerPlugins([createjs.HTMLAudioPlugin]);createjs.Sound.alternateExtensions=["ogg"];createjs.Sound.addEventListener("fileload",g);createjs.Sound.registerSound({id:vb,
src:Fb});window.removeEventListener(ub,Oa,!1);b(".sound-info").remove()},!1));E.autoStart?(b(".sound-info").show(),window.addEventListener(ub,function(){t||(t=!0,oa?(Da&&(fa.volume=E.standaloneAudioVolume),b(c).fluxPlugin.toggleSound()):"video-bg"!=R||Ea||("html5"===Qa?(P.muted(!1),P.volume(E.videoVolume)):(sa.YTPUnmute(),ta.isMute=!1)),b(".sound-info").hide(),b(".pl-sound").parent().removeClass("highlight"))},{once:!0})):b(".pl-sound").parent().removeClass("highlight");aa.init=function(){aa.start(c,
"start",E.autoStart);if(E.showAnimationSummary)Eb.on("click",function(a){Eb.toggleClass("active")});return aa};aa.start=function(a,c,d){Ga=a.clone(!0);v+=1;b(".scene-image img").css({opacity:"0",visibility:"hidden"});N[O]=new TimelineMax({paused:!0,delay:.5,repeat:0,onStart:I});if("single-image"===R){var e=N[O];Ma=new TimelineMax({delay:0});var g=e.totalDuration();mb=g+.75;db&&(Ma.addLabel("imageZoomer"),e.add(Ma,g));e.to(Ya,.75,{opacity:1})}a=a.find(".flux-slide");f(0,a,a.length,d,c);d=c=N[O].totalDuration();
"default"!=E.fullDuration&&0<E.fullDuration&&(d=E.fullDuration,N[O].totalDuration(d));E.showAnimationSummary&&(a="Teaser Duration: "+d.toFixed(1)+"s",Hb.html(a));Sa=N[O].timeScale();"single-image"===R&&db&&(a=new TimelineMax({delay:0}),c="auto"===sb||isNaN(sb)?((c-mb)/c*d).toFixed(1):sb,"in"===bb?a.fromTo(Ya,c,{scale:1},{scale:db,rotation:.01,transformOrigin:jb}):"out"===bb?a.fromTo(Ya,c,{scale:db},{scale:1,rotation:.01,transformOrigin:jb}):(a.fromTo(Ya,c/2,{scale:1},{scale:db,rotation:.01,transformOrigin:jb}),
a.to(Ya,c/2,{scale:1,rotation:.01,transformOrigin:jb})),Ma.add(a,"imageZoomer"));E.preloadScenes&&N[O].set({},{immediateRender:!1,onComplete:F})};aa.play=function(a){"start"===a?N[O].play():(N[O].play(a),"undefined"!==typeof fa&&("paused"==Ha||xa||B()));c.trigger("STPlay")};aa.seek=function(a){N[O].seek(a);c.trigger("STPause")};aa.restart=function(){N[O].restart()};aa.pause=function(){N[O].pause();c.trigger("STPause")};aa.continueTeaser=function(){N[O].paused()&&"playing"==va?(N[O].resume(),c.trigger("STPlay"),
"video-bg"!==R||Na||r(),X(),"undefined"==typeof fa||"paused"===Ha||xa||B()):1<=N[O].progress()&&Ca&&!E.stopTeaserOnEnd&&(Ca=!1,"video-bg"!==R||Na||r(),X(),"paused"===Ha||xa||"undefined"===typeof fa||(fa.paused=!1,c.trigger("STUnMuted")))};aa.freezeTeaser=function(){N[O].paused()||"playing"!=va||1<=N[O].progress()?1<=N[O].progress()&&(Ca=!0,"video-bg"!==R||Na||m(),y(),"undefined"===typeof fa||xa||(fa.paused=!0,c.trigger("STMuted"))):(N[O].pause(),"video-bg"!==R||Na||m(),y(),c.trigger("STPause"),"undefined"===
typeof fa||xa||(fa.paused=!0,c.trigger("STMuted")))};aa.pauseTeaser=function(){N[O].pause();"video-bg"!==R||Na||m();y();c.trigger("STPause");"undefined"!==typeof fa&&(fa.paused=!0,c.trigger("STMuted"));va="paused"};aa.playTeaser=function(){N[O].resume();c.trigger("STPlay");"video-bg"!==R||Na||r();X();"undefined"!=typeof fa&&"paused"!==Ha&&B();va="playing"};b.fn.fluxPlugin.skipToLast=function(){return N[O].currentLabel()!=Ta?(N[O].seek(Ta,!1).play(),"undefined"!==typeof fa&&("paused"==Ha||xa||B()),
!0):!1};b.fn.fluxPlugin.togglePlay=function(){N[O].paused()?aa.playTeaser():1<=N[O].progress()?("video-bg"!=R&&Q(),xa=eb=Ja=ba=Na=!1,N[O].restart(),c.trigger("STPlay"),va="playing"):aa.pauseTeaser()};b.fn.fluxPlugin.playTeaser=function(){aa.playTeaser()};b.fn.fluxPlugin.pauseTeaser=function(){aa.pauseTeaser()};b.fn.fluxPlugin.toggleSound=function(){Da?fa.paused?(B(),Ha="playing"):"playFinished"!=fa.playState&&(fa.paused=!0,c.trigger("STMuted"),Ha="paused"):"video-bg"===R?Ea||("html5"===Qa?P.muted()?
(c.trigger("STUnMuted"),P.muted(!1),P.volume(E.videoVolume)):(c.trigger("STMuted"),P.muted(!0)):ta.isMute?(c.trigger("STUnMuted"),sa.YTPUnmute(),ta.isMute=!1):(c.trigger("STMuted"),sa.YTPMute(),ta.isMute=!0)):"undefined"==typeof P||P.muteEnabled?"undefined"==typeof ta||ta[0].opt.muteEnabled||(ta.isMute?(c.trigger("STUnMuted"),sa.YTPUnmute(),ta.isMute=!1):(c.trigger("STMuted"),sa.YTPMute(),ta.isMute=!0)):P.muted()?(c.trigger("STUnMuted"),P.muted(!1),P.volume(E.videoVolume)):(c.trigger("STMuted"),P.muted(!0))};
b.fn.fluxPlugin.changeSpeed=function(a){E.videoPlaybackChange&&(cb&&P.playbackRate(a),sa&&sa.YTPGetPlayer().setPlaybackRate(a));a*=Sa;N[O].timeScale(a)};Aa||Da||0<u.length?E.waitForLoad?b(window).load(function(){e()}):e():E.waitForLoad?b(window).load(function(){z()}):z();b(window).on("debouncedresize",function(a){if(0<v&&!ba){if(!ua||b(window).width()!=Ba){Ba=b(window).width();a=N[O].paused()?!1:!0;var d=N[O].time();N[O].kill();TweenMax.killDelayedCallsTo(f);c.remove();c=Ga;Pa.prepend(c);E.preloadScenes||
(b("html").addClass("landingresize"),d="start",c.trigger("reinitialize"));aa.start(c,d,a)}}else console.log("TEASER NOT YET INITIALIZED (or) ENDED")})};b.fn.fluxPlugin=function(c){var a=this;return this.each(function(){if(void 0==b(this).data("fluxPlugin")){var d=new b.fluxPlugin(a,c);b(this).data("fluxPlugin",d)}})}})(jQuery);
